...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 8AD6B8E402
	for <lists+linux-erofs@lfdr.de>; Thu, 15 Aug 2019 06:44:25 +0200 (CEST)
Received: from bilbo.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by lists.ozlabs.org (Postfix) with ESMTP id 468DPf1v8QzDqyZ
	for <lists+linux-erofs@lfdr.de>; Thu, 15 Aug 2019 14:44:22 +1000 (AEST)
...
Received: from huawei.com (szxga06-in.huawei.com [45.249.212.32])
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 468DN174cVzDqwT
 for <linux-erofs@lists.ozlabs.org>; Thu, 15 Aug 2019 14:42:57 +1000 (AEST)
Received: from DGGEMS410-HUB.china.huawei.com (unknown [172.30.72.59])
 by Forcepoint Email with ESMTP id 47DD63AFD51F2B143710;
...
Subject: [PATCH v8 11/24] erofs: introduce xattr & posixacl support
Date: Thu, 15 Aug 2019 12:41:42 +0800
Message-ID: <20190815044155.88483-12-gaoxiang25@huawei.com>
...
@@ -307,15 +307,27 @@ int erofs_getattr(const struct path *path, struct kstat *stat,
...
index 98b9e8cebca5..b0abbd783af7 100644
--- a/fs/erofs/namei.c
+++ b/fs/erofs/namei.c
@@ -6,7 +6,7 @@
  *             http://www.huawei.com/
...
index 000000000000..c4253e7f00d1
--- /dev/null
+++ b/fs/erofs/xattr.c
@@ -0,0 +1,705 @@
...
new file mode 100644
index 000000000000..f4595501da85
--- /dev/null
+++ b/fs/erofs/xattr.h
@@ -0,0 +1,94 @@
+/* SPDX-License-Identifier: GPL-2.0-only */
