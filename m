Return-Path: <linux-erofs+bounces-2634-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-erofs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id AEANAzA1sGnRhAIAu9opvQ
	(envelope-from <linux-erofs+bounces-2634-lists+linux-erofs=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-erofs@lfdr.de>; Tue, 10 Mar 2026 16:13:52 +0100
X-Original-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B1B42530BE
	for <lists+linux-erofs@lfdr.de>; Tue, 10 Mar 2026 16:13:51 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4fVcpg3v8Rz3bjb;
	Wed, 11 Mar 2026 02:13:47 +1100 (AEDT)
X-Original-To: linux-erofs@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; arc=pass smtp.remote-ip=67.231.148.174 arc.chain=microsoft.com
ARC-Seal: i=2; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1773155627;
	cv=pass; b=
ARC-Message-Signature: i=2; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1773155627; c=relaxed/relaxed;
	bh=/dx0jFElRQCzuElB3xkafsU3B0B1oyWjkQOIQutQeyI=;
	h=From:To:CC:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=
ARC-Authentication-Results: i=2; lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=marvell.com; dkim=pass (1024-bit key; unprotected) header.d=marvell.com header.i=@marvell.com header.a=rsa-sha256 header.s=selector1 header.b=KELOA0oT; dkim-atps=neutral; spf=pass (client-ip=67.231.148.174; helo=mx0a-0016f401.pphosted.com; envelope-from=enachman@marvell.com; receiver=lists.ozlabs.org) smtp.mailfrom=marvell.com
Authentication-Results: lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=marvell.com
Authentication-Results: lists.ozlabs.org;
	dkim=pass (1024-bit key; unprotected) header.d=marvell.com header.i=@marvell.com header.a=rsa-sha256 header.s=selector1 header.b=KELOA0oT;
	dkim-atps=neutral
Authentication-Results: lists.ozlabs.org; spf=pass (sender SPF authorized) smtp.mailfrom=marvell.com (client-ip=67.231.148.174; helo=mx0a-0016f401.pphosted.com; envelope-from=enachman@marvell.com; receiver=lists.ozlabs.org)
X-Greylist: delayed 324 seconds by postgrey-1.37 at boromir; Wed, 11 Mar 2026 02:13:46 AEDT
Received: from mx0a-0016f401.pphosted.com (mx0a-0016f401.pphosted.com [67.231.148.174])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange x25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lists.ozlabs.org (Postfix) with ESMTPS id 4fVcpf07crz30Lw
	for <linux-erofs@lists.ozlabs.org>; Wed, 11 Mar 2026 02:13:45 +1100 (AEDT)
...
X-Spamd-Result: default: False [0.40 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-2634-lists,linux-erofs=lfdr.de];
	FROM_HAS_DN(0.00)[];
 ...
 ecomputing.com,m:keyur@os.amperecomputing.com,m:quan@os.amperecomputing.com,m:hkallweit1@gmail.com,m:linux@armlinux.org.uk,s:lists@lfdr.de];
	MIME_TRACE(0.00)[0:+];
	FORGED_SENDER(0.00)[enachman@marvell.com,linux-erofs@lists.ozlabs.org];
	...
	FROM_NEQ_ENVFROM(0.00)[enachman@marvell.com,linux-erofs@lists.ozlabs.org];
