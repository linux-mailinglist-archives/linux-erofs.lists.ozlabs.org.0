...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id 419387921C4
	for <lists+linux-erofs@lfdr.de>; Tue,  5 Sep 2023 12:02:56 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4Rg1KB0vf9z3c4w
	for <lists+linux-erofs@lfdr.de>; Tue,  5 Sep 2023 20:02:54 +1000 (AEST)
...
Received: from out30-112.freemail.mail.aliyun.com (out30-112.freemail.mail.aliyun.com [115.124.30.112])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4Rg1Js5RG4z301V
	for <linux-erofs@lists.ozlabs.org>; Tue,  5 Sep 2023 20:02:37 +1000 (AEST)
X-Alimail-AntiSpam: AC=PASS;BC=-1|-1;BR=01201311R921e4;CH=green;DM=||false|;DS=||;FP=0|-1|-1|-1|0|-1|-1|-1;HT=ay29a033018045176;MF=jefflexu@linux.alibaba.com;NM=1;PH=DS;RN=2;SR=0;TI=SMTPD_---0VrPV9bV_1693908151;
Received: from localhost(mailfrom:jefflexu@linux.alibaba.com fp:SMTPD_---0VrPV9bV_1693908151)
          by smtp.aliyun-inc.com;
          Tue, 05 Sep 2023 18:02:32 +0800
From: Jingbo Xu <jefflexu@linux.alibaba.com>
To: hsiangkao@linux.alibaba.com,
	linux-erofs@lists.ozlabs.org
Subject: [PATCH v6 04/11] erofs-utils: lib: add erofs_read_xattrs_from_disk() helper
Date: Tue,  5 Sep 2023 18:02:20 +0800
Message-Id: <20230905100227.1072-5-jefflexu@linux.alibaba.com>
...
+
 ...
 struct xattr_item {
@@ -441,6 +484,11 @@ int erofs_setxattr(struct erofs_inode *inode, char *key,
...
+
 ...
 {
@@ -497,6 +545,70 @@ int erofs_scan_file_xattrs(struct erofs_inode *inode)
