Return-Path: <linux-erofs+bounces-3843-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-erofs@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id yBv5NXHLS2qSaQEAu9opvQ
	(envelope-from <linux-erofs+bounces-3843-lists+linux-erofs=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-erofs@lfdr.de>; Mon, 06 Jul 2026 17:36:17 +0200
X-Original-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:21b9:f100::1])
	by mail.lfdr.de (Postfix) with ESMTPS id BAE37712AD2
	for <lists+linux-erofs@lfdr.de>; Mon, 06 Jul 2026 17:36:16 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=redhat.com header.s=mimecast20190719 header.b=gebAI4E8;
	dkim=pass header.d=redhat.com header.s=mimecast20190719 header.b=IMI2WifV;
	dmarc=pass (policy=quarantine) header.from=redhat.com;
	spf=pass (mail.lfdr.de: domain of "linux-erofs+bounces-3843-lists+linux-erofs=lfdr.de@lists.ozlabs.org" designates 2404:9400:21b9:f100::1 as permitted sender) smtp.mailfrom="linux-erofs+bounces-3843-lists+linux-erofs=lfdr.de@lists.ozlabs.org";
	arc=pass ("lists.ozlabs.org:s=201707:i=1")
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4gv7k64pycz3bp7;
	Tue, 07 Jul 2026 01:36:14 +1000 (AEST)
X-Original-To: linux-erofs@lists.ozlabs.org
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1783352174;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1783352174; c=relaxed/relaxed;
	bh=E6TR9Q/1cij/gI+8gdivHSLo1wUdqMkXBlkoIL8Gdm0=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:content-type; b=
ARC-Authentication-Results: i=1; lists.ozlabs.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=gebAI4E8; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=IMI2WifV; dkim-atps=neutral; spf=pass (client-ip=170.10.133.124; helo=us-smtp-delivery-124.mimecast.com; envelope-from=dhowells@redhat.com; receiver=lists.ozlabs.org) smtp.mailfrom=redhat.com
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange x25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lists.ozlabs.org (Postfix) with ESMTPS id 4gv7k36yNkz2yVZ
	for <linux-erofs@lists.ozlabs.org>; Tue, 07 Jul 2026 01:36:11 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1783352168;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=E6TR9Q/1cij/gI+8gdivHSLo1wUdqMkXBlkoIL8Gdm0=;
	b=gebAI4E8Sj3iQdacj2oJkiBCZcXOSOoALJtXOfv3irPEmj5NR78TTmTzj7ZhDfl6jzZA4V
	VENfFFIisyn59MnajTu2vqg9yZlLgM7kl0pEvrZ0B/nNKoPRqc3D6tJxMZU4hqxQa08sC9
	u9KBTfjsxM1XP6AjsWJLVfHGTHnnU8Y=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1783352169;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=E6TR9Q/1cij/gI+8gdivHSLo1wUdqMkXBlkoIL8Gdm0=;
	b=IMI2WifVw39CogbWchxd+twMzYi5IUtJdIBFqeX0JyZbZ1ioZ2EQjLQST5+QPqM5GtWJrr
	GjW1tIXI6O0ekXlI4n9+cPas6foNhG3LVTiNzmlbGnvHK+tTTpkplHmVAxk/Su/zlCQZy7
	D0Z7oAJM3W99qXAKfO9Aj+YxMWjdgQU=
Received: from mx-prod-mc-05.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-54-186-198-63.us-west-2.compute.amazonaws.com [54.186.198.63]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-590-57culHTvN4a5-cOToQchbQ-1; Mon,
 06 Jul 2026 11:36:04 -0400
X-MC-Unique: 57culHTvN4a5-cOToQchbQ-1
X-Mimecast-MFC-AGG-ID: 57culHTvN4a5-cOToQchbQ_1783352161
Received: from mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.4])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-05.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 386331956096;
	Mon,  6 Jul 2026 15:36:01 +0000 (UTC)
Received: from warthog.procyon.org.com (unknown [10.44.33.159])
	by mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id 9CA883000B52;
	Mon,  6 Jul 2026 15:35:53 +0000 (UTC)
...
Subject: [PATCH v5 13/21] netfs: Switch to using bvecq rather than folio_queue and rolling_buffer
Date: Mon,  6 Jul 2026 16:33:59 +0100
Message-ID: <20260706153408.1231650-14-dhowells@redhat.com>
...
X-Mimecast-MFC-PROC-ID: kstJpAM_9wud13fn7Zd3wn8X4PLwDnRqSdB9AYvWoZg_1783352161
...
X-Spamd-Result: default: False [-1.20 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-3843-lists,linux-erofs=lfdr.de];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[infradead.org:email,samba.org:email,lists.ozlabs.org:from_smtp,lists.ozlabs.org:helo,lists.ozlabs.org:rdns]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: BAE37712AD2
...
index 70ccc92d03ae..6a3734056104 100644
...
index c16fbad286a1..56abcdd73d46 100644
...
+	bvecq_pos_unset(&wreq->load_cursor);
 	...
 	_leave(" = %d", ret);
 	return ret;
@@ -213,12 +230,12 @@ static void netfs_unbuffered_write_async(struct work_struct *work)
...
index 0349634fe205..e57492b262bd 100644
...
index ce61f4d8d301..2582b83cc0ec 100644
...
+			subreq->len = part;
 			...
 			len -= part;
 			start += part;
@@ -246,6 +260,8 @@ static void netfs_retry_read_subrequests(struct netfs_io_request *rreq)
...
+	goto out;
 ...
 /*
@@ -292,23 +309,24 @@ void netfs_retry_reads(struct netfs_io_request *rreq)
  */
...
index 5a8ce6cd9372..2d54c01884e3 100644
...
index 3936e056a95e..5ba0940af6e4 100644
...
@@ -352,8 +399,11 @@ static int netfs_write_folio(struct netfs_io_request *wreq,
...
@@ -453,8 +503,32 @@ static int netfs_write_folio(struct netfs_io_request *wreq,
...
@@ -463,9 +537,11 @@ static int netfs_write_folio(struct netfs_io_request *wreq,
...
@@ -500,15 +576,11 @@ static int netfs_write_folio(struct netfs_io_request *wreq,
 			break;
...
@@ -519,9 +591,9 @@ static int netfs_write_folio(struct netfs_io_request *wreq,
 			debug = true;
 	}
...
@@ -583,6 +655,11 @@ int netfs_writepages(struct address_space *mapping,
 		goto couldnt_start;
 	}
...
@@ -607,12 +684,17 @@ int netfs_writepages(struct address_space *mapping,
...
@@ -646,6 +728,15 @@ struct netfs_io_request *netfs_begin_writethrough(struct kiocb *iocb, size_t len
 		return wreq;
 	}
...
@@ -664,8 +755,8 @@ int netfs_advance_writethrough(struct netfs_io_request *wreq, struct writeback_c
 {
 	int ret;
...
@@ -717,6 +808,8 @@ ssize_t netfs_end_writethrough(struct netfs_io_request *wreq, struct writeback_c
 	}
...
+	bvecq_pos_unset(&wreq->dispatch_cursor);
 	...
 	if (wreq->iocb)
 		ret = -EIOCBQUEUED;
@@ -733,10 +826,11 @@ ssize_t netfs_end_writethrough(struct netfs_io_request *wreq, struct writeback_c
  * @iter: Data to write.
  *
...
@@ -757,10 +851,18 @@ int netfs_writeback_single(struct address_space *mapping,
 		ret = PTR_ERR(wreq);
 		goto couldnt_start;
 	}
-
...
+
 	...
 	netfs_stat(&netfs_n_wh_writepages);
@@ -780,11 +882,11 @@ int netfs_writeback_single(struct address_space *mapping,
 		subreq = stream->construct;
 		subreq->len = wreq->len;
...
@@ -799,6 +901,8 @@ int netfs_writeback_single(struct address_space *mapping,
 	_leave(" = %d", ret);
 	return ret;
...
index 508dbcbb3b19..4df48e8b177b 100644
...
@@ -79,7 +77,8 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
 				break;
...
+			    subreq->transferred > 0 ||
 			    ...
 			    !test_bit(NETFS_SREQ_NEED_RETRY, &subreq->flags))
 				break;
@@ -90,11 +89,13 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
 		/* Determine the set of buffers we're going to use.  Each
 		 * subreq gets a subset of a single overall contiguous buffer.
 		 */
-		netfs_reset_iter(from);
...
+		 */
 		...
 		list_for_each_entry_from(subreq, &stream->subrequests, rreq_link) {
 			if (!len)
@@ -104,16 +105,23 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
 			subreq->len	= len;
 			__clear_bit(NETFS_SREQ_NEED_RETRY, &subreq->flags);
 			trace_netfs_sreq(subreq, netfs_sreq_trace_retry);
+			subreq->transferred = 0;
...
@@ -182,8 +190,13 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
...
+
 			...
 			start += part;
 			if (!len && boundary) {
@@ -191,13 +204,16 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
 				boundary = false;
 			}
