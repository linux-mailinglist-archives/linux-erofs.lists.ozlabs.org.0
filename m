...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 5459C78FB63
	for <lists+linux-erofs@lfdr.de>; Fri,  1 Sep 2023 11:47:46 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4RcY9X1yzMz3c01
	for <lists+linux-erofs@lfdr.de>; Fri,  1 Sep 2023 19:47:44 +1000 (AEST)
...
Received: from out30-132.freemail.mail.aliyun.com (out30-132.freemail.mail.aliyun.com [115.124.30.132])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4RcY935r9jz3bTt
	for <linux-erofs@lists.ozlabs.org>; Fri,  1 Sep 2023 19:47:19 +1000 (AEST)
X-Alimail-AntiSpam: AC=PASS;BC=-1|-1;BR=01201311R181e4;CH=green;DM=||false|;DS=||;FP=0|-1|-1|-1|0|-1|-1|-1;HT=ay29a033018046056;MF=jefflexu@linux.alibaba.com;NM=1;PH=DS;RN=2;SR=0;TI=SMTPD_---0Vr5QuBi_1693561633;
Received: from localhost(mailfrom:jefflexu@linux.alibaba.com fp:SMTPD_---0Vr5QuBi_1693561633)
          by smtp.aliyun-inc.com;
          Fri, 01 Sep 2023 17:47:14 +0800
From: Jingbo Xu <jefflexu@linux.alibaba.com>
To: hsiangkao@linux.alibaba.com,
	linux-erofs@lists.ozlabs.org
Subject: [PATCH v5 7/8] erofs-utils: mkfs: introduce rebuild mode
Date: Fri,  1 Sep 2023 17:47:05 +0800
Message-Id: <20230901094706.27539-8-jefflexu@linux.alibaba.com>
...
@@ -558,11 +583,51 @@ static int mkfs_parse_options_cfg(int argc, char *argv[])
 			return -ENOENT;
 		}
...
@@ -748,6 +813,61 @@ void erofs_show_progs(int argc, char *argv[])
...
+}
 ...
 {
@@ -755,7 +875,6 @@ int main(int argc, char **argv)
...
-	struct stat st;
 	...
 	struct timeval t;
 	char uuid_str[37];
@@ -778,26 +897,6 @@ int main(int argc, char **argv)
 		return 1;
 	}
...
@@ -864,6 +963,20 @@ int main(int argc, char **argv)
 		}
 	}
...
+
 	...
 	if (IS_ERR(sb_bh)) {
 		err = PTR_ERR(sb_bh);
@@ -931,7 +1044,35 @@ int main(int argc, char **argv)
...
@@ -947,27 +1088,6 @@ int main(int argc, char **argv)
 			err = PTR_ERR(root_inode);
 			goto exit;
 		}
-	} else {
