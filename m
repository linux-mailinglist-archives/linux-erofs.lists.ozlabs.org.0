...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id A6392927C23
	for <lists+linux-erofs@lfdr.de>; Thu,  4 Jul 2024 19:29:09 +0200 (CEST)
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.a=rsa-sha256 header.s=Intel header.b=kA6dGmzg;
	dkim-atps=neutral
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4WFNtC1Gl4z3fRR
	for <lists+linux-erofs@lfdr.de>; Fri,  5 Jul 2024 03:29:07 +1000 (AEST)
...
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.19])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4WFNt340wMz3d3Z
	for <linux-erofs@lists.ozlabs.org>; Fri,  5 Jul 2024 03:28:57 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1720114140; x=1751650140;
  h=date:from:to:cc:subject:message-id;
  bh=qBPGkzNHaBBx/pT84gMhnD5OzJshDnLI89iQikObCk8=;
  b=kA6dGmzgaah6HNPmLLpJRV6gNs8eSLjPnZq/GI/M40OJV/HtgmnRX5Jp
   +NUKvUArzZ0rEF9YN6vFDOuoQ/yor96pNCF/3ZR3+jrBmCccsajE6FS9g
   FpHbuQYJbUTIzPbW3PbKWMjb4RsdzE0CP4iUS9LJh8zWdQ/FdrEHTValK
   ckcMg+8Um3oJKeT8mRh0CU19Jt+Bg2fbISDs5Lq9HQUiBXV0KeO6z1vTR
   jRqe3eF4qP9pHXtEzOQp0tPANLjTwrIMZqRpbFj1Y76fXS+p4gIblpiUz
   SqLO5IdxSf0V3U+U3nB9o9yMfsoZ7kiF3/Kq5Uu8x73E4TCab9RzIiyI8
   A==;
X-CSE-ConnectionGUID: 805OQfLGRaON8a7hK2Dqwg==
X-CSE-MsgGUID: mFLnhoiYRUO2A/sxGtM0kw==
X-IronPort-AV: E=McAfee;i="6700,10204,11123"; a="17128884"
X-IronPort-AV: E=Sophos;i="6.09,183,1716274800"; 
   d="scan'208";a="17128884"
Received: from orviesa008.jf.intel.com ([10.64.159.148])
  by fmvoesa113.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 04 Jul 2024 10:28:54 -0700
X-CSE-ConnectionGUID: eiZMurifRWSXFdo+Xse/zA==
X-CSE-MsgGUID: 6dca63kuQpOOILszJEiN6w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.09,183,1716274800"; 
   d="scan'208";a="47399029"
Received: from lkp-server01.sh.intel.com (HELO 68891e0c336b) ([10.239.97.150])
  by orviesa008.jf.intel.com with ESMTP; 04 Jul 2024 10:28:53 -0700
Received: from kbuild by 68891e0c336b with local (Exim 4.96)
	(envelope-from <lkp@intel.com>)
	id 1sPQGI-000RGb-2l;
	Thu, 04 Jul 2024 17:28:50 +0000
Date: Fri, 05 Jul 2024 01:27:50 +0800
From: kernel test robot <lkp@intel.com>
To: Gao Xiang <xiang@kernel.org>
Subject: [xiang-erofs:dev-test] BUILD SUCCESS
 c71c20f0ed2defd69271a8853b5320f2d6f85221
Message-ID: <202407050148.B7f8nn0T-lkp@intel.com>
...
branch HEAD: c71c20f0ed2defd69271a8853b5320f2d6f85221  erofs: tidy up `struct z_erofs_bvec`
