...
Received: from lists.ozlabs.org (lists.ozlabs.org [203.11.71.2])
	by mail.lfdr.de (Postfix) with ESMTPS id 14FB77A20C
	for <lists+linux-erofs@lfdr.de>; Tue, 30 Jul 2019 09:17:35 +0200 (CEST)
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by lists.ozlabs.org (Postfix) with ESMTP id 45ySYm3CvxzDqMV
	for <lists+linux-erofs@lfdr.de>; Tue, 30 Jul 2019 17:17:32 +1000 (AEST)
...
Received: from huawei.com (szxga06-in.huawei.com [45.249.212.32])
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 45ySW81XCmzDqN1
 for <linux-erofs@lists.ozlabs.org>; Tue, 30 Jul 2019 17:15:16 +1000 (AEST)
Received: from DGGEMS410-HUB.china.huawei.com (unknown [172.30.72.59])
 by Forcepoint Email with ESMTP id E528EA70901958434303;
...
Subject: [PATCH v5 22/24] erofs: introduce the decompression frontend
Date: Tue, 30 Jul 2019 15:14:11 +0800
Message-ID: <20190730071413.11871-23-gaoxiang25@huawei.com>
...
index d43ecc09ec8e..ecfada8a7f9f 100644
...
+
 	...
 	u32 blocks;
@@ -326,6 +329,9 @@ static inline bool is_inode_flat_inline(struct inode *inode)
...
@@ -486,7 +492,7 @@ int erofs_namei(struct inode *dir, struct qstr *name,
 /* dir.c */
...
@@ -510,16 +516,20 @@ struct erofs_workgroup *erofs_find_workgroup(struct super_block *sb,
