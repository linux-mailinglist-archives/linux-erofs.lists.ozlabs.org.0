Return-Path: <linux-erofs+bounces-171-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
X-Original-To: lists+linux-erofs@lfdr.de
Delivered-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 04792A82C74
	for <lists+linux-erofs@lfdr.de>; Wed,  9 Apr 2025 18:33:24 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4ZXpR062zMz30Vn;
	Thu, 10 Apr 2025 02:33:16 +1000 (AEST)
X-Original-To: linux-erofs@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; arc=none smtp.remote-ip=115.124.30.118
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1744216396;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1744216396; c=relaxed/relaxed;
	bh=ffnFtJ02tLOrCUMy18FghxHDWHc/VuuX7jYIBMajGIA=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=
ARC-Authentication-Results: i=1; lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=linux.alibaba.com; dkim=pass (1024-bit key; unprotected) header.d=linux.alibaba.com header.i=@linux.alibaba.com header.a=rsa-sha256 header.s=default header.b=wwK6rRY1; dkim-atps=neutral; spf=pass (client-ip=115.124.30.118; helo=out30-118.freemail.mail.aliyun.com; envelope-from=hsiangkao@linux.alibaba.com; receiver=lists.ozlabs.org) smtp.mailfrom=linux.alibaba.com
Authentication-Results: lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=linux.alibaba.com
Authentication-Results: lists.ozlabs.org;
	dkim=pass (1024-bit key; unprotected) header.d=linux.alibaba.com header.i=@linux.alibaba.com header.a=rsa-sha256 header.s=default header.b=wwK6rRY1;
	dkim-atps=neutral
...
Received: from out30-118.freemail.mail.aliyun.com (out30-118.freemail.mail.aliyun.com [115.124.30.118])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4ZXpQx3KKWz30VZ
	for <linux-erofs@lists.ozlabs.org>; Thu, 10 Apr 2025 02:33:13 +1000 (AEST)
DKIM-Signature:v=1; a=rsa-sha256; c=relaxed/relaxed;
	d=linux.alibaba.com; s=default;
	t=1744216389; h=From:To:Subject:Date:Message-ID:MIME-Version;
	bh=ffnFtJ02tLOrCUMy18FghxHDWHc/VuuX7jYIBMajGIA=;
	b=wwK6rRY1rmtDEKW8HABn32BepkOP7qjUxZFOZq3wRwednq65Ti+NKpm8mO7ufqbTBsMLM8Qy2FCae1xNkUAxI34UdMYSg2nmTIwNdQnLrEaZGYNjnCNspf4IisTvsjBOGbeVrGwcMB+Jl9ARpsXqJ9UexUKK/BmfhOOdXPfY9d4=
Received: from x31i01179.sqa.na131.tbsite.net(mailfrom:hsiangkao@linux.alibaba.com fp:SMTPD_---0WWKsZUF_1744216388 cluster:ay36)
          by smtp.aliyun-inc.com;
          Thu, 10 Apr 2025 00:33:09 +0800
From: Gao Xiang <hsiangkao@linux.alibaba.com>
To: linux-erofs@lists.ozlabs.org
Cc: Gao Xiang <hsiangkao@linux.alibaba.com>
Subject: [PATCH v2 05/10] erofs-utils: lib: sync up with the 48-bit kernel erofs_fs.h
Date: Thu, 10 Apr 2025 00:32:54 +0800
Message-ID: <20250409163259.2077865-5-hsiangkao@linux.alibaba.com>
...
index de9150f..0b7d8a9 100644
--- a/lib/blobchunk.c
+++ b/lib/blobchunk.c
@@ -159,32 +159,32 @@ int erofs_blob_write_chunk_indexes(struct erofs_inode *inode,
...
@@ -502,8 +502,8 @@ int erofs_mkfs_dump_blobs(struct erofs_sb_info *sbi)
 		i = 0;
 		do {
