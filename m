...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id C79CE761C6F
	for <lists+linux-erofs@lfdr.de>; Tue, 25 Jul 2023 16:59:09 +0200 (CEST)
Authentication-Results: lists.ozlabs.org;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=kernel.org header.i=@kernel.org header.a=rsa-sha256 header.s=k20201202 header.b=GqO7d5tP;
	dkim-atps=neutral
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4R9KtM4zdjz3bnP
	for <lists+linux-erofs@lfdr.de>; Wed, 26 Jul 2023 00:59:07 +1000 (AEST)
X-Original-To: linux-erofs@lists.ozlabs.org
Delivered-To: linux-erofs@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=kernel.org header.i=@kernel.org header.a=rsa-sha256 header.s=k20201202 header.b=GqO7d5tP;
	dkim-atps=neutral
...
Received: from dfw.source.kernel.org (dfw.source.kernel.org [IPv6:2604:1380:4641:c500::1])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4R9KtG0vDZz2yD6
	for <linux-erofs@lists.ozlabs.org>; Wed, 26 Jul 2023 00:59:02 +1000 (AEST)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits))
	(No client certificate requested)
	by dfw.source.kernel.org (Postfix) with ESMTPS id D31CB617A2;
	Tue, 25 Jul 2023 14:58:57 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 21E2AC433B8;
	Tue, 25 Jul 2023 14:58:51 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1690297137;
	bh=Y79V8fW1dayS/ZW42NSnZx7OZABNpnqUWyYbPZtv6GQ=;
	h=From:Date:Subject:References:In-Reply-To:To:Cc:From;
	b=
From: Jeff Layton <jlayton@kernel.org>
Date: Tue, 25 Jul 2023 10:58:14 -0400
Subject: [PATCH v6 1/7] fs: pass the request_mask to generic_fillattr
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20230725-mgctime-v6-1-a794c2b7abca@kernel.org>
...
X-Developer-Signature: v=1; a=openpgp-sha256; l=28167; i=jlayton@kernel.org;
 h=from:subject:message-id; bh=Y79V8fW1dayS/ZW42NSnZx7OZABNpnqUWyYbPZtv6GQ=;
 b=
