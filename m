Return-Path: <linux-erofs+bounces-3850-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-erofs@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id a/RkIbLLS2qvaQEAu9opvQ
	(envelope-from <linux-erofs+bounces-3850-lists+linux-erofs=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-erofs@lfdr.de>; Mon, 06 Jul 2026 17:37:22 +0200
X-Original-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:21b9:f100::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 708E6712B15
	for <lists+linux-erofs@lfdr.de>; Mon, 06 Jul 2026 17:37:20 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=redhat.com header.s=mimecast20190719 header.b=gMeL0GNn;
	dkim=pass header.d=redhat.com header.s=mimecast20190719 header.b=KHhY76LA;
	dmarc=pass (policy=quarantine) header.from=redhat.com;
	spf=pass (mail.lfdr.de: domain of "linux-erofs+bounces-3850-lists+linux-erofs=lfdr.de@lists.ozlabs.org" designates 2404:9400:21b9:f100::1 as permitted sender) smtp.mailfrom="linux-erofs+bounces-3850-lists+linux-erofs=lfdr.de@lists.ozlabs.org";
	arc=pass ("lists.ozlabs.org:s=201707:i=1")
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4gv7lL1dmHz3bqV;
	Tue, 07 Jul 2026 01:37:18 +1000 (AEST)
X-Original-To: linux-erofs@lists.ozlabs.org
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1783352238;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1783352238; c=relaxed/relaxed;
	bh=KdjrZNkCzX5H0bqUAMxPShr7sF4RxDdWDFaztz4D8yU=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:content-type; b=
ARC-Authentication-Results: i=1; lists.ozlabs.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=gMeL0GNn; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=KHhY76LA; dkim-atps=neutral; spf=pass (client-ip=170.10.129.124; helo=us-smtp-delivery-124.mimecast.com; envelope-from=dhowells@redhat.com; receiver=lists.ozlabs.org) smtp.mailfrom=redhat.com
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange x25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lists.ozlabs.org (Postfix) with ESMTPS id 4gv7lG56cQz2yVZ
	for <linux-erofs@lists.ozlabs.org>; Tue, 07 Jul 2026 01:37:14 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1783352231;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=KdjrZNkCzX5H0bqUAMxPShr7sF4RxDdWDFaztz4D8yU=;
	b=gMeL0GNneLgMXqI3K/xZrik5a0EyhlKa5FuSlK5XJCJHozxu/87HFIgz5xKeyq+EVj4V/Q
	JP01SObp/RSy69CoF4/tO/PNLAp9Eh+kvmey/QttgoFg10CJAyzXlXICdK1WwQmhaz5QFW
	4smQkElqkmkB/ULgLR8djV6ep2UQ7nw=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1783352232;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=KdjrZNkCzX5H0bqUAMxPShr7sF4RxDdWDFaztz4D8yU=;
	b=KHhY76LAS8iNgTFQe9WGhoJWfAVxog+LSRf6RdSce+9VgggCiZ0zZgxPbJZKDetja4shXQ
	C+zsO764b/dQIwErc9302SoetS6hud8859W3yIKLe4dpV3sYnDCCunrSsov/yBVZtGXaR/
	iJdFnbSrtVGLxb1tdaiAji02VLtFojs=
Received: from mx-prod-mc-06.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-35-165-154-97.us-west-2.compute.amazonaws.com [35.165.154.97]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-657-r2rM8tECOImkVZQpbNRo8Q-1; Mon,
 06 Jul 2026 11:37:06 -0400
X-MC-Unique: r2rM8tECOImkVZQpbNRo8Q-1
X-Mimecast-MFC-AGG-ID: r2rM8tECOImkVZQpbNRo8Q_1783352223
Received: from mx-prod-int-05.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-05.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.17])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-06.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id BCC101800A3E;
	Mon,  6 Jul 2026 15:37:03 +0000 (UTC)
Received: from warthog.procyon.org.com (unknown [10.44.33.159])
	by mx-prod-int-05.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id 91A4C195604B;
	Mon,  6 Jul 2026 15:36:56 +0000 (UTC)
...
Subject: [PATCH v5 21/21] netfs: Combine prepare and issue ops and grab the buffers on request
Date: Mon,  6 Jul 2026 16:34:07 +0100
Message-ID: <20260706153408.1231650-22-dhowells@redhat.com>
...
X-Mimecast-MFC-PROC-ID: CKFet4jSEr4THq22oy9Q8ylovAhDnnC4ngbJUl089OM_1783352223
...
X-Spamd-Result: default: False [-1.20 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-3850-lists,linux-erofs=lfdr.de];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[infradead.org:email,manguebit.org:email,lists.ozlabs.org:from_smtp,lists.ozlabs.org:helo,lists.ozlabs.org:rdns,linux.dev:email]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: 708E6712B15
...
---
 ...
 fs/cachefiles/io.c           | 238 +++++++---
 fs/ceph/Kconfig              |   1 +
 fs/ceph/addr.c               | 125 ++---
 fs/netfs/Kconfig             |   3 +
 fs/netfs/Makefile            |   2 +-
 fs/netfs/buffered_read.c     | 237 +++++-----
 fs/netfs/buffered_write.c    |  28 +-
 fs/netfs/direct_read.c       |  80 ++--
 fs/netfs/direct_write.c      | 130 ++---
 ...
 fs/netfs/read_pgpriv2.c      | 111 +++--
 fs/netfs/read_retry.c        | 202 ++++----
 fs/netfs/read_single.c       | 150 +++---
 fs/netfs/write_collect.c     |  62 ++-
 fs/netfs/write_issue.c       | 886 +++++++++++++++++++++--------------
 fs/netfs/write_retry.c       | 139 +++---
 fs/nfs/Kconfig               |   1 +
 fs/nfs/fscache.c             |  17 +-
 ...
 net/9p/client.c              |   8 +-
 39 files changed, 1864 insertions(+), 1249 deletions(-)

diff --git a/fs/9p/vfs_addr.c b/fs/9p/vfs_addr.c
index 1ac0b3dcc077..63199b8fb25c 100644
--- a/fs/9p/vfs_addr.c
+++ b/fs/9p/vfs_addr.c
@@ -48,31 +48,69 @@ static void v9fs_begin_writeback(struct netfs_io_request *wreq)
...
@@ -89,12 +127,13 @@ static void v9fs_issue_read(struct netfs_io_subrequest *subreq)
...
+		total = p9_client_read(fid, pos, &iter, &err);
 ...
 fill_subreq:
@@ -110,8 +149,9 @@ static void v9fs_issue_read(struct netfs_io_subrequest *subreq)
 		__set_bit(NETFS_SREQ_MADE_PROGRESS, &subreq->flags);
 	}
...
index 547faa06c80b..174114c39639 100644
--- a/fs/afs/dir.c
+++ b/fs/afs/dir.c
@@ -250,8 +250,8 @@ static ssize_t afs_do_read_single(struct afs_vnode *dvnode, struct file *file)
...
+					  round_up(i_size, PAGE_SIZE), GFP_KERNEL);
 		...
 		if (ret < 0)
 			return ret;
@@ -2227,11 +2227,10 @@ static int afs_dir_writepages(struct address_space *mapping,
 	}
...
index e6b52c0039bf..165388be7886 100644
--- a/fs/afs/internal.h
+++ b/fs/afs/internal.h
...
index a59dab27a080..e25107ee5948 100644
--- a/fs/afs/symlink.c
+++ b/fs/afs/symlink.c
...
index eebebda46a09..0f7c88a3f38f 100644
...
-	return 0;
 ...
 /*
@@ -610,9 +733,9 @@ int __cachefiles_prepare_write(struct cachefiles_object *object,
...
@@ -634,23 +757,13 @@ static int cachefiles_prepare_write(struct netfs_cache_resources *cres,
 	return ret;
 }
...
@@ -659,55 +772,55 @@ static void cachefiles_issue_write(struct netfs_io_subrequest *subreq)
 	struct netfs_cache_resources *cres = &wreq->cache_resources;
 	struct cachefiles_object *object = cachefiles_cres_object(cres);
 	struct cachefiles_cache *cache = object->volume->cache;
+	struct iov_iter iter;
...
+	return netfs_write_subrequest_terminated(subreq, ret);
 ...
 /*
@@ -881,9 +994,10 @@ static const struct netfs_cache_ops cachefiles_netfs_cache_ops = {
...
index 61bd6d92ff25..89db9988cccd 100644
--- a/fs/ceph/addr.c
+++ b/fs/ceph/addr.c
...
@@ -333,22 +345,6 @@ static bool ceph_netfs_issue_op_inline(struct netfs_io_subrequest *subreq)
 	subreq->error = err;
...
@@ -361,19 +357,21 @@ static void ceph_netfs_issue_read(struct netfs_io_subrequest *subreq)
...
@@ -383,26 +381,47 @@ static void ceph_netfs_issue_read(struct netfs_io_subrequest *subreq)
 	len = subreq->len;
...
@@ -421,13 +440,11 @@ static void ceph_netfs_issue_read(struct netfs_io_subrequest *subreq)
...
@@ -438,12 +455,10 @@ static void ceph_netfs_issue_read(struct netfs_io_subrequest *subreq)
...
+		goto eio;
 	...
 	req->r_priv = subreq;
 	req->r_inode = inode;
@@ -451,19 +466,21 @@ static void ceph_netfs_issue_read(struct netfs_io_subrequest *subreq)
...
@@ -515,7 +532,6 @@ static int ceph_init_request(struct netfs_io_request *rreq, struct file *file)
...
-	rreq->io_streams[0].sreq_max_len = fsc->mount_options->rsize;
 ...
 out:
 	if (ret < 0) {
@@ -543,7 +559,6 @@ static void ceph_netfs_free_request(struct netfs_io_request *rreq)
...
index 6a3734056104..51e5aa98bc8c 100644
...
@@ -550,6 +562,8 @@ static int netfs_read_gaps(struct file *file, struct folio *folio)
...
@@ -628,6 +642,7 @@ int netfs_read_folio(struct file *file, struct folio *folio)
 		goto discard;
...
index 350eb43ecc00..2cff747ab910 100644
...
+		ret2 = netfs_end_writethrough(writethrough, &wbc);
 		...
 		if (ret2 == -EIOCBQUEUED)
 			return ret2;
@@ -434,6 +433,7 @@ ssize_t netfs_perform_write(struct kiocb *iocb, struct iov_iter *iter,
 	ret = -EFAULT;
 error_folio_unlock:
 	folio_unlock(folio);
+error_folio_put:
...
index 1c1f622bbbe8..ea4cdee1a33b 100644
...
@@ -43,37 +66,10 @@ static void netfs_dispatch_unbuffered_reads(struct netfs_io_request *rreq)
 		}
...
@@ -82,15 +78,14 @@ static void netfs_dispatch_unbuffered_reads(struct netfs_io_request *rreq)
 		if (test_bit(NETFS_RREQ_FAILED, &rreq->flags))
 			break;
 		cond_resched();
-	} while (size > 0);
...
+	bvecq_pos_unset(&stream->dispatch_cursor);
 ...
 /*
@@ -141,6 +136,7 @@ static ssize_t netfs_unbuffered_read(struct netfs_io_request *rreq, bool sync)
...
@@ -165,6 +161,8 @@ ssize_t netfs_unbuffered_read_iter_locked(struct kiocb *iocb, struct iov_iter *i
...
+
 	 ...
 	 * we return.
@@ -180,6 +178,8 @@ ssize_t netfs_unbuffered_read_iter_locked(struct kiocb *iocb, struct iov_iter *i
 		goto error_put;
...
index 56abcdd73d46..39eaee830a0a 100644
...
+	/* TODO: Progressively clean up wreq->direct_bq */
 ...
 /*
@@ -103,60 +132,39 @@ static int netfs_unbuffered_write(struct netfs_io_request *wreq)
...
@@ -171,20 +179,21 @@ static int netfs_unbuffered_write(struct netfs_io_request *wreq)
 			continue;
 		}
...
@@ -193,25 +202,21 @@ static int netfs_unbuffered_write(struct netfs_io_request *wreq)
...
+	bvecq_pos_unset(&stream->dispatch_cursor);
 	...
 	_leave(" = %d", ret);
 	return ret;
@@ -255,6 +260,7 @@ ssize_t netfs_unbuffered_write_iter_locked(struct kiocb *iocb, struct iov_iter *
 	if (IS_ERR(wreq))
 		return PTR_ERR(wreq);
...
@@ -265,9 +271,7 @@ ssize_t netfs_unbuffered_write_iter_locked(struct kiocb *iocb, struct iov_iter *
...
@@ -282,8 +286,6 @@ ssize_t netfs_unbuffered_write_iter_locked(struct kiocb *iocb, struct iov_iter *
...
index fafa8c6bec57..a04cd96cd09a 100644
...
index 1fcb89e2ad86..5e8e816eeff3 100644
--- a/fs/netfs/iterator.c
+++ b/fs/netfs/iterator.c
@@ -106,14 +106,14 @@ ssize_t netfs_extract_iter(struct iov_iter *orig, size_t max_len, size_t max_pag
 			}
...
index fdb6aebc0a7b..096fcae9e573 100644
...
@@ -259,8 +260,7 @@ static void netfs_collect_read_results(struct netfs_io_request *rreq)
...
@@ -379,31 +379,6 @@ static void netfs_rreq_assess_dio(struct netfs_io_request *rreq)
...
-
  ...
  *
@@ -419,9 +394,8 @@ bool netfs_read_collection(struct netfs_io_request *rreq)
...
-	smp_rmb(); /* Read ALL_QUEUED before subreq lists. */
 	...
 	if (!list_empty(&stream->subrequests))
 		return false;
@@ -439,7 +413,7 @@ bool netfs_read_collection(struct netfs_io_request *rreq)
...
+		WARN_ON_ONCE(1);
 	...
 	default:
 		break;
@@ -564,6 +538,11 @@ void netfs_read_subreq_terminated(struct netfs_io_subrequest *subreq)
...
+			trace_netfs_sreq(subreq, netfs_sreq_trace_short);
 			...
 			subreq->error = -ENODATA;
@@ -582,6 +561,8 @@ void netfs_read_subreq_terminated(struct netfs_io_subrequest *subreq)
...
index 6f6a7278510d..d7e085fa5446 100644
...
@@ -178,19 +178,42 @@ void netfs_pgpriv2_copy_to_cache(struct netfs_io_request *rreq, struct folio *fo
...
index 2582b83cc0ec..0f8ff53fe703 100644
...
@@ -135,51 +143,25 @@ static void netfs_retry_read_subrequests(struct netfs_io_request *rreq)
 		 */
 		subreq = from;
...
+				goto abandon_after;
 			if (subreq == to) {
 				...
 				break;
@@ -189,7 +171,7 @@ static void netfs_retry_read_subrequests(struct netfs_io_request *rreq)
...
@@ -207,7 +189,8 @@ static void netfs_retry_read_subrequests(struct netfs_io_request *rreq)
 		}
...
+		 * for retry to switch to the retry cursor.
 		...
 		do {
 			subreq = netfs_alloc_subrequest(rreq);
@@ -216,8 +199,8 @@ static void netfs_retry_read_subrequests(struct netfs_io_request *rreq)
 				goto abandon_after;
 			}
 			subreq->source		= NETFS_DOWNLOAD_FROM_SERVER;
-			subreq->start		= start;
...
@@ -225,43 +208,27 @@ static void netfs_retry_read_subrequests(struct netfs_io_request *rreq)
...
@@ -327,6 +294,7 @@ void netfs_unlock_abandoned_read_pages(struct netfs_io_request *rreq)
 			}
...
index 2d54c01884e3..f1892b80f411 100644
...
@@ -151,6 +152,12 @@ static void netfs_writeback_unlock_folios(struct netfs_io_request *wreq,
...
@@ -175,6 +182,7 @@ static void netfs_writeback_unlock_folios(struct netfs_io_request *wreq,
 		*notes |= MADE_PROGRESS;
...
+	skip:
 		...
 		if (fpos + fsize >= collected_to)
 			break;
@@ -225,9 +233,7 @@ static void netfs_collect_write_results(struct netfs_io_request *wreq)
...
@@ -242,17 +248,34 @@ static void netfs_collect_write_results(struct netfs_io_request *wreq)
...
@@ -420,9 +443,8 @@ bool netfs_write_collection(struct netfs_io_request *wreq)
...
-	smp_rmb(); /* Read ALL_QUEUED before lists. */
 	...
 	for (s = 0; s < NR_IO_STREAMS; s++) {
@@ -543,6 +565,8 @@ void netfs_write_subrequest_terminated(void *_op, ssize_t transferred_or_error)
...
index 5ba0940af6e4..7059157d05d2 100644
...
-
 	...
 	/* We add to the end of the list whilst the collector may be walking
@@ -195,100 +208,46 @@ void netfs_prepare_write(struct netfs_io_request *wreq,
 	spin_lock(&wreq->lock);
 	/* Write IN_PROGRESS before pointer to new subreq */
...
@@ -316,88 +275,291 @@ void netfs_issue_write(struct netfs_io_request *wreq,
 		while (bq->next)
 			bq = bq->next;
...
@@ -430,23 +592,36 @@ static int netfs_write_folio(struct netfs_io_request *wreq,
 	if (finfo) {
...
@@ -466,168 +641,82 @@ static int netfs_write_folio(struct netfs_io_request *wreq,
 	 *     write-back group.
 	 */
...
+	goto out;
 ...
 /*
@@ -638,6 +727,7 @@ int netfs_writepages(struct address_space *mapping,
 {
...
@@ -657,35 +747,48 @@ int netfs_writepages(struct address_space *mapping,
...
@@ -714,33 +817,61 @@ EXPORT_SYMBOL(netfs_writepages);
 /*
...
+	return ERR_PTR(-ENOMEM);
 ...
 /*
@@ -749,10 +880,11 @@ struct netfs_io_request *netfs_begin_writethrough(struct kiocb *iocb, size_t len
...
@@ -760,18 +892,18 @@ int netfs_advance_writethrough(struct netfs_io_request *wreq, struct writeback_c
...
@@ -783,47 +915,104 @@ int netfs_advance_writethrough(struct netfs_io_request *wreq, struct writeback_c
 		return 0;
 	}
...
@@ -834,12 +1023,15 @@ ssize_t netfs_end_writethrough(struct netfs_io_request *wreq, struct writeback_c
  */
...
@@ -851,23 +1043,24 @@ int netfs_writeback_single(struct address_space *mapping,
 		ret = PTR_ERR(wreq);
 		goto couldnt_start;
 	}
-	wreq->len = iov_iter_count(iter);
...
+	if (test_bit(NETFS_RREQ_UPLOAD_TO_SERVER, &wreq->flags))
 	...
 	for (int s = 0; s < NR_IO_STREAMS; s++) {
@@ -877,20 +1070,27 @@ int netfs_writeback_single(struct address_space *mapping,
 		if (!stream->avail)
 			continue;
...
index 4df48e8b177b..d9cc49f21346 100644
...
@@ -32,30 +62,14 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
...
@@ -79,7 +93,6 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
 			subreq = list_entry(next, struct netfs_io_subrequest, rreq_link);
 			if (subreq->start != start + len ||
 			    subreq->transferred > 0 ||
-			    test_bit(NETFS_SREQ_BOUNDARY, &subreq->flags) ||
 				...
 				break;
 			to = subreq;
@@ -89,8 +102,10 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
 		/* Determine the set of buffers we're going to use.  Each
 		 * subreq gets a subset of a single overall contiguous buffer.
 		 */
-		bvecq_pos_transfer(&dispatch_cursor, &from->dispatch_pos);
...
@@ -98,38 +113,26 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
 		 */
 		subreq = from;
 		list_for_each_entry_from(subreq, &stream->subrequests, rreq_link) {
-			if (!len)
...
@@ -137,7 +140,7 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
 		/* If we managed to use fewer subreqs, we can discard the
 		 * excess; if we used the same number, then we're done.
 		 */
-		if (!len) {
+		if (!wreq->retry_buffered) {
 			if (subreq == to)
 				continue;
 			list_for_each_entry_safe_from(subreq, tmp,
@@ -160,6 +163,7 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
 			subreq = netfs_alloc_subrequest(wreq);
...
@@ -168,18 +172,17 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
 					     netfs_sreq_trace_new);
...
-				stream->sreq_max_len = umin(len, wreq->wsize);
 			...
 			case NETFS_WRITE_TO_CACHE:
 				netfs_stat(&netfs_n_wh_write);
@@ -188,32 +191,14 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
 				WARN_ON_ONCE(1);
 			}
...
index 9b7fdad4a920..418b07c2e7ca 100644
--- a/fs/nfs/fscache.c
+++ b/fs/nfs/fscache.c
@@ -23,6 +23,7 @@
 #include "iostat.h"
...
@@ -319,9 +328,11 @@ static void nfs_netfs_issue_read(struct netfs_io_subrequest *sreq)
 		return netfs_read_subreq_terminated(sreq);
 	}
...
index d39175cdf1b1..5f0a4868197f 100644
...
index 5a25635bc62a..de4240de1e36 100644
...
+	rdata->credits.in_flight_check = 1;
 	trace_smb3_rw_credits(rdata->rreq->debug_id,
 			      ...
 			      rdata->credits.value,
@@ -194,40 +205,24 @@ static int cifs_prepare_read(struct netfs_io_subrequest *subreq)
 		const struct smbdirect_socket_parameters *sp =
 			smbd_get_parameters(server->smbd_conn);
...
+	return netfs_read_subreq_terminated(subreq);
 ...
 /*
@@ -353,11 +355,10 @@ const struct netfs_request_ops cifs_req_ops = {
...
index 3f2fcbcde651..aab75968cb05 100644
--- a/fs/smb/client/smb2ops.c
+++ b/fs/smb/client/smb2ops.c
@@ -4745,6 +4745,7 @@ handle_read_data(struct TCP_Server_Info *server, struct mid_q_entry *mid,
...
@@ -4817,6 +4818,10 @@ handle_read_data(struct TCP_Server_Info *server, struct mid_q_entry *mid,
...
@@ -4846,7 +4851,7 @@ handle_read_data(struct TCP_Server_Info *server, struct mid_q_entry *mid,
...
@@ -4860,7 +4865,7 @@ handle_read_data(struct TCP_Server_Info *server, struct mid_q_entry *mid,
 		   buf_len >= end_off) {
...
index 95c0efe9d43b..a5f4c504e7c8 100644
--- a/fs/smb/client/smb2pdu.c
+++ b/fs/smb/client/smb2pdu.c
@@ -4590,9 +4590,13 @@ smb2_new_read_req(void **buf, unsigned int *total_len,
 	 */
...
+		rdata->mr = smbd_register_mr(server->smbd_conn, &iter,
 		...
 		if (!rdata->mr)
 			return -EAGAIN;
@@ -4656,9 +4660,10 @@ smb2_readv_callback(struct TCP_Server_Info *server, struct mid_q_entry *mid)
...
@@ -5146,7 +5151,9 @@ smb2_async_writev(struct cifs_io_subrequest *wdata)
 		goto out;
...
@@ -5185,9 +5192,14 @@ smb2_async_writev(struct cifs_io_subrequest *wdata)
 	 */
...
+		wdata->mr = smbd_register_mr(server->smbd_conn, &iter,
 		...
 		if (!wdata->mr) {
 			rc = -EAGAIN;
@@ -5224,8 +5236,8 @@ smb2_async_writev(struct cifs_io_subrequest *wdata)
...
index 1be16f490d5f..afeca87455d7 100644
...
@@ -128,25 +128,39 @@ static inline struct netfs_group *netfs_folio_group(struct folio *folio)
 	return priv;
 }
...
@@ -184,14 +198,13 @@ struct netfs_io_subrequest {
...
@@ -200,7 +213,6 @@ struct netfs_io_subrequest {
...
@@ -248,23 +260,26 @@ struct netfs_io_request {
...
@@ -282,6 +297,7 @@ struct netfs_io_request {
...
@@ -290,8 +306,10 @@ struct netfs_io_request {
...
@@ -307,7 +325,6 @@ struct netfs_request_ops {
...
@@ -320,7 +337,9 @@ struct netfs_request_ops {
...
@@ -362,6 +381,14 @@ struct netfs_cache_ops {
 		     netfs_io_terminated_t term_func,
 		     void *term_func_priv);
...
@@ -371,24 +398,12 @@ struct netfs_cache_ops {
...
+				 loff_t i_size, bool no_space_allocated_yet);
 	 ...
 	 * boundary as appropriate.
@@ -401,8 +416,8 @@ struct netfs_cache_ops {
...
@@ -436,10 +451,9 @@ void netfs_single_mark_inode_dirty(struct inode *inode);
...
@@ -466,7 +480,8 @@ void netfs_put_subrequest(struct netfs_io_subrequest *subreq,
