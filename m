...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 034D18879C8
	for <lists+linux-erofs@lfdr.de>; Sat, 23 Mar 2024 18:39:43 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4V25zw5ZgYz3cRc
	for <lists+linux-erofs@lfdr.de>; Sun, 24 Mar 2024 04:39:40 +1100 (AEDT)
...
Received: from smtp232.sjtu.edu.cn (smtp232.sjtu.edu.cn [202.120.2.232])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4V25zt06Hlz3cBN
	for <linux-erofs@lists.ozlabs.org>; Sun, 24 Mar 2024 04:39:38 +1100 (AEDT)
Received: from proxy188.sjtu.edu.cn (smtp188.sjtu.edu.cn [202.120.2.188])
	by smtp232.sjtu.edu.cn (Postfix) with ESMTPS id B9CDE100BC57C
	for <linux-erofs@lists.ozlabs.org>; Sun, 24 Mar 2024 01:39:06 +0800 (CST)
Received: from zhaoyf.ipads-lab.se.sjtu.edu.cn (unknown [202.120.40.82])
	by proxy188.sjtu.edu.cn (Postfix) with ESMTPSA id EAFA7380DCF
	for <linux-erofs@lists.ozlabs.org>; Sun, 24 Mar 2024 01:39:05 +0800 (CST)
From: Yifan Zhao <zhaoyifan@sjtu.edu.cn>
To: linux-erofs@lists.ozlabs.org
Subject: [PATCH v4 2/2] erofs-utils: mkfs: introduce inter-file multi-threaded compression
Date: Sun, 24 Mar 2024 01:39:02 +0800
Message-ID: <20240323173902.3882401-3-zhaoyifan@sjtu.edu.cn>
X-Mailer: git-send-email 2.44.0
In-Reply-To: <20240323173902.3882401-1-zhaoyifan@sjtu.edu.cn>
References: <20240323173902.3882401-1-zhaoyifan@sjtu.edu.cn>
MIME-Version: 1.0
...
-
 ...
 {
 	int ret = 0;
@@ -1144,6 +1150,21 @@ static int erofs_mkfs_handle_file(struct erofs_inode *inode)
 	return 0;
 }
...
+
 ...
 {
@@ -1153,6 +1174,14 @@ static int erofs_mkfs_handle_dir(struct erofs_inode *dir,
...
@@ -1160,7 +1189,6 @@ static int erofs_mkfs_handle_dir(struct erofs_inode *dir,
 		return -errno;
 	}
...
@@ -1196,13 +1224,15 @@ static int erofs_mkfs_handle_dir(struct erofs_inode *dir,
 	if (ret)
 		return ret;
...
@@ -1302,11 +1332,13 @@ static int erofs_mkfs_build_tree(struct erofs_inode *dir,
...
@@ -1327,7 +1359,8 @@ struct erofs_inode *erofs_mkfs_build_tree_from_path(const char *path)
...
+			erofs_mkfs_print_progressinfo(inode);
 		...
 		if (err) {
@@ -1335,15 +1368,212 @@ struct erofs_inode *erofs_mkfs_build_tree_from_path(const char *path)
 			break;
 		}
