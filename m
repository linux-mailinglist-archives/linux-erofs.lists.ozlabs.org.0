Return-Path: <linux-erofs+bounces-2978-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-erofs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id UNttAjAtw2l6owQAu9opvQ
	(envelope-from <linux-erofs+bounces-2978-lists+linux-erofs=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-erofs@lfdr.de>; Wed, 25 Mar 2026 01:32:48 +0100
X-Original-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:21b9:f100::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 6FA1F31E038
	for <lists+linux-erofs@lfdr.de>; Wed, 25 Mar 2026 01:32:46 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4fgSY75DbKz2ypW;
	Wed, 25 Mar 2026 11:32:43 +1100 (AEDT)
X-Original-To: linux-erofs@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; arc=none smtp.remote-ip=198.175.65.17
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1774398763;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1774398763; c=relaxed/relaxed;
	bh=MaoqGSOgn31pghaxyiQ3pRExkLUar3qxQFQIZQzzStI=;
	h=Date:From:To:Cc:Subject:Message-ID; b=
ARC-Authentication-Results: i=1; lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=intel.com; dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.a=rsa-sha256 header.s=Intel header.b=JRT0jCEv; dkim-atps=neutral; spf=pass (client-ip=198.175.65.17; helo=mgamail.intel.com; envelope-from=lkp@intel.com; receiver=lists.ozlabs.org) smtp.mailfrom=intel.com
Authentication-Results: lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.a=rsa-sha256 header.s=Intel header.b=JRT0jCEv;
	dkim-atps=neutral
...
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.17])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4fgSY45DMZz2ynn
	for <linux-erofs@lists.ozlabs.org>; Wed, 25 Mar 2026 11:32:38 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1774398761; x=1805934761;
  h=date:from:to:cc:subject:message-id;
  bh=HxNlHfaPTomVLSbWTR/PYHkWt8WvA5aLZ7R2Ygo4T0Y=;
  b=JRT0jCEvNoax9ZeGZg3urqH+b1f9KVUZ8LpoDPzV7j3dHkFW8HrzQLvN
   Fyee4tRlRqI0osdgRlPmStBdOcmZSmMZeFtklLd8um2LOii5y9Mf6IUp0
   xmG5oxDzwRnLVBXMxlLBiXPsSHj+D+i7H0YNUhzECnhCwL1SWIkpjn/Ks
   MPE3nQZm6NLLiI+/+gI2NJlyHAe3mv3dIbcsQT3MaxRUZnLpgqmRjkFPe
   18qO3+4pmzY8ziLRbskVZHxCOYLwaV87p+2XqrOe7SjEW9DcbcHcZTaJ8
   8QUeZlOZdul5EQA5srDyoEQt4zzNH73o+2vdsIjZHue70DjHxP9aRJH9C
   A==;
X-CSE-ConnectionGUID: fmuDbaF0To60vDw1fsLL9g==
X-CSE-MsgGUID: WvHAgjEZRq+UtnS5VlO7lw==
X-IronPort-AV: E=McAfee;i="6800,10657,11739"; a="75396912"
X-IronPort-AV: E=Sophos;i="6.23,139,1770624000"; 
   d="scan'208";a="75396912"
Received: from orviesa004.jf.intel.com ([10.64.159.144])
  by orvoesa109.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Mar 2026 17:32:35 -0700
X-CSE-ConnectionGUID: TT4qMqOCRw2K+FfkrSl4mw==
X-CSE-MsgGUID: DOlwWV3+SRGJT5EiqSeLyQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.23,139,1770624000"; 
   d="scan'208";a="228993872"
Received: from lkp-server01.sh.intel.com (HELO 3905d212be1b) ([10.239.97.150])
  by orviesa004.jf.intel.com with ESMTP; 24 Mar 2026 17:32:33 -0700
Received: from kbuild by 3905d212be1b with local (Exim 4.98.2)
	(envelope-from <lkp@intel.com>)
	id 1w5CAh-000000005dz-0Swf;
	Wed, 25 Mar 2026 00:32:31 +0000
Date: Wed, 25 Mar 2026 08:31:44 +0800
From: kernel test robot <lkp@intel.com>
To: Gao Xiang <hsiangkao@linux.alibaba.com>
Cc: Xiang Gao <xiang@kernel.org>, linux-erofs@lists.ozlabs.org
Subject: [xiang-erofs:dev] BUILD SUCCESS
 6b956a871865193a194dbd028334c8e1b20c8d5f
Message-ID: <202603250835.hjndhYU6-lkp@intel.com>
...
X-Spamd-Result: default: False [-0.70 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	TAGGED_FROM(0.00)[bounces-2978-lists,linux-erofs=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
...
X-Rspamd-Queue-Id: 6FA1F31E038
X-Rspamd-Action: no action
X-Rspamd-Server: lfdr

tree/branch: https://git.kernel.org/pub/scm/linux/kernel/git/xiang/erofs.git dev
branch HEAD: 6b956a871865193a194dbd028334c8e1b20c8d5f  erofs: harden h_shared_count in erofs_init_inode_xattrs()
