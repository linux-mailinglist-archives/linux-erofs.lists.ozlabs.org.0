...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id B4ABB5B66F9
	for <lists+linux-erofs@lfdr.de>; Tue, 13 Sep 2022 06:32:01 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4MRVt66Xkgz308w
	for <lists+linux-erofs@lfdr.de>; Tue, 13 Sep 2022 14:31:58 +1000 (AEST)
Authentication-Results: lists.ozlabs.org;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=bytedance-com.20210112.gappssmtp.com header.i=@bytedance-com.20210112.gappssmtp.com header.a=rsa-sha256 header.s=20210112 header.b=pYir8x4n;
	dkim-atps=neutral
...
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=bytedance-com.20210112.gappssmtp.com header.i=@bytedance-com.20210112.gappssmtp.com header.a=rsa-sha256 header.s=20210112 header.b=pYir8x4n;
	dkim-atps=neutral
Received: from mail-pf1-x436.google.com (mail-pf1-x436.google.com [IPv6:2607:f8b0:4864:20::436])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lists.ozlabs.org (Postfix) with ESMTPS id 4MRVsy6hXtz2xfs
	for <linux-erofs@lists.ozlabs.org>; Tue, 13 Sep 2022 14:31:48 +1000 (AEST)
Received: by mail-pf1-x436.google.com with SMTP id y127so10602439pfy.5
        for <linux-erofs@lists.ozlabs.org>; Mon, 12 Sep 2022 21:31:48 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:from:references:cc:to:subject
         ...
         :cc:subject:date;
        bh=+nxBZprjDfeQSRH0ATA3UKT3yTg4cCfDFL/tf8PL9b8=;
        b=
X-Gm-Message-State: ACgBeo2TnT63XX9mHQr+RdKmtZCcgfwbYJuvwPwSJepATunCtEdAETLq
	mFch0C9sPwwmAhbyyFtW4YHU/Q==
