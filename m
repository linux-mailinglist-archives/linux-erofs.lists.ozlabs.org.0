Return-Path: <linux-erofs+bounces-3841-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-erofs@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id mDfHOGLLS2qKaQEAu9opvQ
	(envelope-from <linux-erofs+bounces-3841-lists+linux-erofs=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-erofs@lfdr.de>; Mon, 06 Jul 2026 17:36:02 +0200
X-Original-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:21b9:f100::1])
	by mail.lfdr.de (Postfix) with ESMTPS id BBFC9712AC1
	for <lists+linux-erofs@lfdr.de>; Mon, 06 Jul 2026 17:36:01 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=redhat.com header.s=mimecast20190719 header.b=IhFSgjIc;
	dkim=pass header.d=redhat.com header.s=mimecast20190719 header.b=IhFSgjIc;
	dmarc=pass (policy=quarantine) header.from=redhat.com;
	spf=pass (mail.lfdr.de: domain of "linux-erofs+bounces-3841-lists+linux-erofs=lfdr.de@lists.ozlabs.org" designates 2404:9400:21b9:f100::1 as permitted sender) smtp.mailfrom="linux-erofs+bounces-3841-lists+linux-erofs=lfdr.de@lists.ozlabs.org";
	arc=pass ("lists.ozlabs.org:s=201707:i=1")
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4gv7jq4W02z3bqs;
	Tue, 07 Jul 2026 01:35:59 +1000 (AEST)
X-Original-To: linux-erofs@lists.ozlabs.org
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1783352159;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1783352159; c=relaxed/relaxed;
	bh=lXEh8WMC5CV6aTMaCnXZfTNpLChKWPG3vcXHQV5wrtI=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:content-type; b=
ARC-Authentication-Results: i=1; lists.ozlabs.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=IhFSgjIc; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=IhFSgjIc; dkim-atps=neutral; spf=pass (client-ip=170.10.129.124; helo=us-smtp-delivery-124.mimecast.com; envelope-from=dhowells@redhat.com; receiver=lists.ozlabs.org) smtp.mailfrom=redhat.com
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange x25519)
	(No client certificate requested)
	by lists.ozlabs.org (Postfix) with ESMTPS id 4gv7jm6d4Qz3bp7
	for <linux-erofs@lists.ozlabs.org>; Tue, 07 Jul 2026 01:35:56 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1783352154;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=lXEh8WMC5CV6aTMaCnXZfTNpLChKWPG3vcXHQV5wrtI=;
	b=IhFSgjIcHG4Kx+qV+MMkK1jWUSEEiUXH/SsvPbQEllwtOygoB/DWuH6lnwrDpKP79yvcfY
	LTDtjkyrSGbwnA4Oc0yVghkR2HPtj/BZiMIBFq2bMigsIc350WALzPl5UMBXDz6mEscxnV
	PEddGwmxQZXN1Csln+sjw9stqBW3kOY=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1783352154;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
...
Received: from mx-prod-mc-01.mail-002.prod.us-west-2.aws.redhat.com
 ...
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-633-s41-gch2P_iUR3qsudm7NQ-1; Mon,
 06 Jul 2026 11:35:48 -0400
X-MC-Unique: s41-gch2P_iUR3qsudm7NQ-1
X-Mimecast-MFC-AGG-ID: s41-gch2P_iUR3qsudm7NQ_1783352144
Received: from mx-prod-int-10.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-10.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.95])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-01.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 77BD11955DA3;
	Mon,  6 Jul 2026 15:35:44 +0000 (UTC)
Received: from warthog.procyon.org.com (unknown [10.44.33.159])
	by mx-prod-int-10.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id 1F2C436924;
...
Subject: [PATCH v5 11/21] cachefiles: Don't rely on backing fs storage map for most use cases
Date: Mon,  6 Jul 2026 16:33:57 +0100
Message-ID: <20260706153408.1231650-12-dhowells@redhat.com>
...
X-Mimecast-MFC-PROC-ID: nuqDWSQjuv68wHZIXc8ZZeflFjEwrsPLTeHybGvC_-s_1783352144
...
X-Spamd-Result: default: False [-1.20 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-3841-lists,linux-erofs=lfdr.de];
...
---
 ...
 18 files changed, 613 insertions(+), 284 deletions(-)
...
index 8a9f6be15828..b52b8f5e7d72 100644
...
@@ -446,23 +445,6 @@ struct file *cachefiles_create_tmpfile(struct cachefiles_object *object)
 	if (ret < 0)
 		goto err_unuse;
...
@@ -471,6 +453,7 @@ struct file *cachefiles_create_tmpfile(struct cachefiles_object *object)
 	}
 out:
 	cachefiles_end_secure(cache, saved_cred);
+	object->content_info = CACHEFILES_CONTENT_ALL;
...
index 19e026ce5d47..70ccc92d03ae 100644
...
+
 void netfs_queue_read(struct netfs_io_request *rreq,
 		      struct netfs_io_subrequest *subreq)
 {
@@ -218,15 +216,54 @@ static void netfs_issue_read(struct netfs_io_request *rreq,
  */
...
-	issue:
 		...
 		if (slice < 0) {
 			ret = slice;
@@ -308,6 +357,7 @@ static void netfs_read_to_pagecache(struct netfs_io_request *rreq)
...
index 8cb74cb8242a..f5cf80d567f3 100644
...
index 2b42758e01ec..ce61f4d8d301 100644
...
index 210eb8f3958d..5a8ce6cd9372 100644
...
@@ -263,15 +285,44 @@ static void netfs_collect_write_results(struct netfs_io_request *wreq)
...
+			if (test_bit(NETFS_SREQ_NEED_RETRY, &front->flags)) {
 				...
 				break;
@@ -360,6 +411,7 @@ static void netfs_collect_write_results(struct netfs_io_request *wreq)
  */
...
@@ -395,13 +447,22 @@ bool netfs_write_collection(struct netfs_io_request *wreq)
...
+		}
 	...
 	_debug("finished");
@@ -486,24 +547,51 @@ void netfs_write_subrequest_terminated(void *_op, ssize_t transferred_or_error)
...
index 33cc7a8c8394..3936e056a95e 100644
...
index 058bc7a166a5..508dbcbb3b19 100644
...
index 787670c2e134..bdf9358ed8f7 100644
...
+struct fscache_occupancy;
 ...
 /**
@@ -153,6 +154,7 @@ struct netfs_io_stream {
...
+	bool			cancelled;	/* T if stream is cancelled */
 ...
 /*
@@ -162,8 +164,10 @@ struct netfs_cache_resources {
...
+	unsigned int			dio_size;	/* DIO block size */
 ...
 /*
@@ -198,6 +202,7 @@ struct netfs_io_subrequest {
...
@@ -253,6 +258,7 @@ struct netfs_io_request {
...
@@ -274,11 +280,13 @@ struct netfs_io_request {
...
@@ -324,6 +332,12 @@ enum netfs_read_from_hole {
...
+
  ...
  */
@@ -358,8 +372,7 @@ struct netfs_cache_ops {
 	/* Prepare a read operation, shortening it to a cached/uncached
 	 * boundary as appropriate.
 	 */
...
@@ -387,8 +400,17 @@ struct netfs_cache_ops {
...
index 5354a0439324..a857a79ea87f 100644
