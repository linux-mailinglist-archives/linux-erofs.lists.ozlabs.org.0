...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id B4CFB583E5A
	for <lists+linux-erofs@lfdr.de>; Thu, 28 Jul 2022 14:09:38 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4LtqFq24rxz2xJW
	for <lists+linux-erofs@lfdr.de>; Thu, 28 Jul 2022 22:09:35 +1000 (AEST)
...
Received: from out30-132.freemail.mail.aliyun.com (out30-132.freemail.mail.aliyun.com [115.124.30.132])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4LtqFk1XV0z2xHg
	for <linux-erofs@lists.ozlabs.org>; Thu, 28 Jul 2022 22:09:28 +1000 (AEST)
X-Alimail-AntiSpam: AC=PASS;BC=-1|-1;BR=01201311R141e4;CH=green;DM=||false|;DS=||;FP=0|-1|-1|-1|0|-1|-1|-1;HT=ay29a033018045168;MF=jnhuang@linux.alibaba.com;NM=1;PH=DS;RN=2;SR=0;TI=SMTPD_---0VKfZY13_1659010161;
Received: from localhost.localdomain(mailfrom:jnhuang@linux.alibaba.com fp:SMTPD_---0VKfZY13_1659010161)
          by smtp.aliyun-inc.com;
          Thu, 28 Jul 2022 20:09:22 +0800
From: Huang Jianan <jnhuang@linux.alibaba.com>
To: linux-erofs@lists.ozlabs.org
Subject: [PATCH v2 1/2] erofs-utils: fuse: introduce xattr support
Date: Thu, 28 Jul 2022 20:09:09 +0800
Message-Id: <20220728120910.61636-1-jnhuang@linux.alibaba.com>
...
index 95f939e..dd1508e 100644
--- a/fuse/main.c
+++ b/fuse/main.c
@@ -139,7 +139,38 @@ static int erofsfuse_readlink(const char *path, char *buffer, size_t size)
 	return 0;
 }
...
index c8ce278..8979dcc 100644
--- a/lib/xattr.c
+++ b/lib/xattr.c
@@ -714,3 +714,511 @@ char *erofs_export_xattr_ibody(struct list_head *ixattrs, unsigned int size)
 	DBG_BUGON(p > size);
 	return buf;
 }
+
