...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id 5083E6C7C6F
	for <lists+linux-erofs@lfdr.de>; Fri, 24 Mar 2023 11:20:11 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4PjdWD4S7vz3fQp
	for <lists+linux-erofs@lfdr.de>; Fri, 24 Mar 2023 21:20:08 +1100 (AEDT)
...
Received: from out30-118.freemail.mail.aliyun.com (out30-118.freemail.mail.aliyun.com [115.124.30.118])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4PjdW502Tmz3c41
	for <linux-erofs@lists.ozlabs.org>; Fri, 24 Mar 2023 21:19:59 +1100 (AEDT)
X-Alimail-AntiSpam: AC=PASS;BC=-1|-1;BR=01201311R101e4;CH=green;DM=||false|;DS=||;FP=0|-1|-1|-1|0|-1|-1|-1;HT=ay29a033018046051;MF=hsiangkao@linux.alibaba.com;NM=1;PH=DS;RN=4;SR=0;TI=SMTPD_---0VeXYKAH_1679653189;
Received: from e18g06460.et15sqa.tbsite.net(mailfrom:hsiangkao@linux.alibaba.com fp:SMTPD_---0VeXYKAH_1679653189)
          by smtp.aliyun-inc.com;
          Fri, 24 Mar 2023 18:19:53 +0800
From: Gao Xiang <hsiangkao@linux.alibaba.com>
To: linux-erofs@lists.ozlabs.org
Subject: [RFC PATCH] erofs-utils: introduce tarerofs
Date: Fri, 24 Mar 2023 18:19:48 +0800
Message-Id: <20230324101948.18799-1-hsiangkao@linux.alibaba.com>
...
+	unsigned int i;
 	...
 	d = erofs_d_alloc(dir, ".");
@@ -215,22 +235,7 @@ int erofs_prepare_dir_file(struct erofs_inode *dir, unsigned int nr_subdirs)
...
+int erofs_write_file_from_buffer(struct erofs_inode *inode, char *buf)
 {
 	...
 	int ret;
@@ -424,9 +429,9 @@ static int write_uncompressed_file_from_fd(struct erofs_inode *inode, int fd)
 	return 0;
 }
...
@@ -950,7 +944,7 @@ static int erofs_fill_inode(struct erofs_inode *inode, struct stat *st,
 	return 0;
 }
...
@@ -1048,7 +1042,12 @@ static int erofs_mkfs_build_tree(struct erofs_inode *dir, struct list_head *dirs
...
+			close(fd);
 		...
 		if (ret)
 			return ret;
@@ -1271,3 +1270,69 @@ struct erofs_inode *erofs_mkfs_build_special_from_fd(int fd, const char *name)
