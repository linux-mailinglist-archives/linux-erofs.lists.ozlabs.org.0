...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id A430F6E8D77
	for <lists+linux-erofs@lfdr.de>; Thu, 20 Apr 2023 11:04:33 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4Q2BYQ40tVz3f88
	for <lists+linux-erofs@lfdr.de>; Thu, 20 Apr 2023 19:04:26 +1000 (AEST)
...
Received: from out30-119.freemail.mail.aliyun.com (out30-119.freemail.mail.aliyun.com [115.124.30.119])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4Q2BYK46T2z3cDG
	for <linux-erofs@lists.ozlabs.org>; Thu, 20 Apr 2023 19:04:20 +1000 (AEST)
X-Alimail-AntiSpam: AC=PASS;BC=-1|-1;BR=01201311R171e4;CH=green;DM=||false|;DS=||;FP=0|-1|-1|-1|0|-1|-1|-1;HT=ay29a033018046059;MF=hsiangkao@linux.alibaba.com;NM=1;PH=DS;RN=2;SR=0;TI=SMTPD_---0VgYOYx-_1681981450;
Received: from e18g06460.et15sqa.tbsite.net(mailfrom:hsiangkao@linux.alibaba.com fp:SMTPD_---0VgYOYx-_1681981450)
          by smtp.aliyun-inc.com;
          Thu, 20 Apr 2023 17:04:14 +0800
From: Gao Xiang <hsiangkao@linux.alibaba.com>
To: linux-erofs@lists.ozlabs.org
Subject: [PATCH v5] erofs-utils: introduce tarerofs
Date: Thu, 20 Apr 2023 17:04:09 +0800
Message-Id: <20230420090409.118864-1-hsiangkao@linux.alibaba.com>
...
---
Changes since v4:
 - Fix one byte dirent hierarchy messy reported by Xin Yin;
 - Fix tmpfile() failure with no space.

still TODO:
 - overlayfs opaque handling, etc.
 ...
 lib/tar.c                 | 743 ++++++++++++++++++++++++++++++++++++++
 mkfs/main.c               | 129 +++++--
 10 files changed, 1042 insertions(+), 101 deletions(-)
...
+	init_list_head(&inode->i_hash);
 	...
 	return inode;
@@ -1061,8 +1070,13 @@ static int erofs_mkfs_build_tree(struct erofs_inode *dir, struct list_head *dirs
 			}
...
+static bool tar_mode;
 ...
 {
@@ -482,6 +487,11 @@ static int mkfs_parse_options_cfg(int argc, char *argv[])
 			}
...
+			break;
 		case 1:
 			usage();
 			exit(0);
@@ -513,20 +523,24 @@ static int mkfs_parse_options_cfg(int argc, char *argv[])
 		return -ENOMEM;
...
@@ -745,14 +759,24 @@ int main(int argc, char **argv)
 		return 1;
 	}
...
@@ -803,11 +827,14 @@ int main(int argc, char **argv)
 	}
 	if (cfg.c_dedupe)
...
+		sbi.blkszbits = 9;
 	...
 	if (IS_ERR(sb_bh)) {
 		err = PTR_ERR(sb_bh);
@@ -863,7 +890,10 @@ int main(int argc, char **argv)
 			return 1;
 	}
...
+		err = erofs_generate_devtable();
 	if (err) {
 		erofs_err("failed to generate device table: %s",
 			  erofs_strerror(err));
@@ -876,25 +906,52 @@ int main(int argc, char **argv)
