...
index 0f6fbe2..9785fee 100644
--- a/lib/xattr.c
+++ b/lib/xattr.c
@@ -925,7 +925,7 @@ int erofs_build_shared_xattrs_from_path(struct erofs_sb_info *sbi, const char *p
...
+	ret = erofs_dev_write(sbi, buf, erofs_btell(bh, false), shared_xattrs_size);
 ...
 out:
@@ -1048,7 +1048,7 @@ static int init_inode_xattrs(struct erofs_inode *vi)
...
@@ -1068,7 +1068,7 @@ static int init_inode_xattrs(struct erofs_inode *vi)
 			/* cannot be unaligned */
...
@@ -1114,7 +1114,7 @@ static inline int xattr_iter_fixup(struct xattr_iter *it)
...
@@ -1141,7 +1141,7 @@ static int inline_xattr_iter_pre(struct xattr_iter *it,
...
@@ -1368,7 +1368,7 @@ static int shared_getxattr(struct erofs_inode *vi, struct getxattr_iter *it)
...
@@ -1524,7 +1524,7 @@ static int shared_listxattr(struct erofs_inode *vi, struct listxattr_iter *it)
