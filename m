...
Received: from lists.ozlabs.org (lists.ozlabs.org [203.11.71.2])
	by mail.lfdr.de (Postfix) with ESMTPS id ED3619EC97
	for <lists+linux-erofs@lfdr.de>; Tue, 27 Aug 2019 17:27:28 +0200 (CEST)
Received: from bilbo.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by lists.ozlabs.org (Postfix) with ESMTP id 46Ht635CNFzDqQG
	for <lists+linux-erofs@lfdr.de>; Wed, 28 Aug 2019 01:27:23 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=lists.ozlabs.org;
	s=201707; t=1566919643;
	bh=pzUzMtvxtJzR4N3UGkflJCxsHyrqyKZ3TYiTH8wqXFo=;
	h=To:Subject:Date:List-Id:List-Unsubscribe:List-Archive:List-Post:
	 List-Help:List-Subscribe:From:Reply-To:Cc:From;
	b=
...
Authentication-Results: lists.ozlabs.org; dkim=pass (2048-bit key;
 unprotected) header.d=android.com header.i=@android.com header.b="k39iw3Yp"; 
 dkim-atps=neutral
Received: from mail-pf1-x442.google.com (mail-pf1-x442.google.com
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 46HsdR42dzzDqbX
 for <linux-erofs@lists.ozlabs.org>; Wed, 28 Aug 2019 01:06:00 +1000 (AEST)
Received: by mail-pf1-x442.google.com with SMTP id v12so14298311pfn.10
 for <linux-erofs@lists.ozlabs.org>; Tue, 27 Aug 2019 08:06:00 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :content-transfer-encoding;
 bh=A8KS5pSV9irzaZExk8u0rpHGhacXdI/QBURyXY3X/2I=;
 b=
X-Gm-Message-State: APjAAAXeu+2JLiF56O15x8iT9rL/Gx6v37MMEEcqsKRCwRUebb88533I
 0MCDgiN5QM6iOHSUZdJraf0CyA==
...
Subject: [PATCH v8] Add flags option to get xattr method paired to
 __vfs_getxattr
...
X-Mailman-Approved-At: Wed, 28 Aug 2019 01:22:12 +1000
