Return-Path: <linux-erofs+bounces-1261-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
X-Original-To: lists+linux-erofs@lfdr.de
Delivered-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id 471DBBEDB38
	for <lists+linux-erofs@lfdr.de>; Sat, 18 Oct 2025 22:07:57 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4cpt625vzNz2xQ4;
	Sun, 19 Oct 2025 07:07:54 +1100 (AEDT)
X-Original-To: linux-erofs@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; arc=pass smtp.remote-ip=34.193.58.168 arc.chain=microsoft.com
ARC-Seal: i=2; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1760818074;
	cv=pass; b=
ARC-Message-Signature: i=2; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1760818074; c=relaxed/relaxed;
	bh=faTSuBMol+S8aiOV6ICfD5+EPjrZok0AzHQwNcEXMP8=;
	h=From:To:CC:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=
ARC-Authentication-Results: i=2; lists.ozlabs.org; dmarc=pass (p=quarantine dis=none) header.from=amazon.com; dkim=pass (2048-bit key; unprotected) header.d=amazon.com header.i=@amazon.com header.a=rsa-sha256 header.s=amazoncorp2 header.b=tMw3eXu+; dkim-atps=neutral; spf=pass (client-ip=34.193.58.168; helo=iad-out-008.esa.us-east-1.outbound.mail-perimeter.amazon.com; envelope-from=prvs=379a668e4=farbere@amazon.com; receiver=lists.ozlabs.org) smtp.mailfrom=amazon.com
Authentication-Results: lists.ozlabs.org; dmarc=pass (p=quarantine dis=none) header.from=amazon.com
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=amazon.com header.i=@amazon.com header.a=rsa-sha256 header.s=amazoncorp2 header.b=tMw3eXu+;
	dkim-atps=neutral
Authentication-Results: lists.ozlabs.org; spf=pass (sender SPF authorized) smtp.mailfrom=amazon.com (client-ip=34.193.58.168; helo=iad-out-008.esa.us-east-1.outbound.mail-perimeter.amazon.com; envelope-from=prvs=379a668e4=farbere@amazon.com; receiver=lists.ozlabs.org)
Received: from iad-out-008.esa.us-east-1.outbound.mail-perimeter.amazon.com (iad-out-008.esa.us-east-1.outbound.mail-perimeter.amazon.com [34.193.58.168])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4cpt6146TFz2xPy
	for <linux-erofs@lists.ozlabs.org>; Sun, 19 Oct 2025 07:07:53 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  ...
  b=tMw3eXu+iaXXZHRs71ZJbxxNHmVIBE18gjFY0AllXIwpBiAsg9QaXk1H
   ...
   g==;
X-CSE-ConnectionGUID: r4eQj44dTwyTlQReC7jGUQ==
X-CSE-MsgGUID: kAenPE54RQKqqSD7z4g1bg==
X-IronPort-AV: E=Sophos;i="6.19,239,1754956800"; 
   d="scan'208";a="4613932"
Received: from ip-10-4-10-75.ec2.internal (HELO smtpout.naws.us-east-1.prod.farcaster.email.amazon.dev) ([10.4.10.75])
  by internal-iad-out-008.esa.us-east-1.outbound.mail-perimeter.amazon.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 18 Oct 2025 20:07:48 +0000
Received: from EX19MTAUEA002.ant.amazon.com [72.21.196.65:25918]
 ...
 id 70f83bf0-57b2-40cd-9716-37ac76bac56a; Sat, 18 Oct 2025 20:07:47 +0000 (UTC)
X-Farcaster-Flow-ID: 70f83bf0-57b2-40cd-9716-37ac76bac56a
