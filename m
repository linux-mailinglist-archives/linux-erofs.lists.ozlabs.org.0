...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id 2B5359AE79B
	for <lists+linux-erofs@lfdr.de>; Thu, 24 Oct 2024 16:08:55 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4XZ77T18Szz3bfS
	for <lists+linux-erofs@lfdr.de>; Fri, 25 Oct 2024 01:08:53 +1100 (AEDT)
X-Original-To: linux-erofs@lists.ozlabs.org
Delivered-To: linux-erofs@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; arc=none smtp.remote-ip=170.10.133.124
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1729778931;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1729778931; c=relaxed/relaxed;
	bh=1AG10NA33GVxS71HwzD8ac28VGGELibPIdtZwMweGe8=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=
ARC-Authentication-Results: i=1; lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=redhat.com; dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=FiMB1LZk; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=f0BnQm8F; dkim-atps=neutral; spf=pass (client-ip=170.10.133.124; helo=us-smtp-delivery-124.mimecast.com; envelope-from=dhowells@redhat.com; receiver=lists.ozlabs.org) smtp.mailfrom=redhat.com
Authentication-Results: lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: lists.ozlabs.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=FiMB1LZk;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=f0BnQm8F;
	dkim-atps=neutral
...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4XZ77P3t4nz305n
	for <linux-erofs@lists.ozlabs.org>; Fri, 25 Oct 2024 01:08:49 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1729778926;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=1AG10NA33GVxS71HwzD8ac28VGGELibPIdtZwMweGe8=;
	b=FiMB1LZkXtBCrBewIglXN5QrCPkUEb7HRiXYgeU3/GZ1HaHcdkdn4AYDAHGSlHSJSExaJv
	INDOgEYerwNLPNvvcYZCFWqgcf7rqmL12E4sbwDP2rcCfEcvZME7KQZIjdzpiDBS+P7fNA
	+JMegeH1doz7wJBnB4nsiGUzxZ1Qr+0=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1729778927;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=1AG10NA33GVxS71HwzD8ac28VGGELibPIdtZwMweGe8=;
	b=f0BnQm8FLZOHV8X2G2+fDtjTxfIC5uzYDVOyiaOSRLY1GVphaFfjg9sQDZYc3zRN9HPnnr
	SQ19yu5GjLuDYiRk2geHN4halm7ivAbs6O9xSjPOqV8gq8p+fMjUlTRXs88h4fc7fK2r0w
	+h/ZWLnAajhbt7zreehhFxIMAAtg0fw=
Received: from mx-prod-mc-04.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-54-186-198-63.us-west-2.compute.amazonaws.com [54.186.198.63]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-552-gq0xedpvOgWlLwgMUqHWZg-1; Thu,
 24 Oct 2024 10:08:43 -0400
X-MC-Unique: gq0xedpvOgWlLwgMUqHWZg-1
Received: from mx-prod-int-05.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-05.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.17])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-04.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 080BB19560B0;
	Thu, 24 Oct 2024 14:08:40 +0000 (UTC)
Received: from warthog.procyon.org.uk.com (unknown [10.42.28.231])
	by mx-prod-int-05.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id 012F61955F43;
	Thu, 24 Oct 2024 14:08:33 +0000 (UTC)
From: David Howells <dhowells@redhat.com>
To: Christian Brauner <christian@brauner.io>,
	Steve French <smfrench@gmail.com>,
	Matthew Wilcox <willy@infradead.org>
Subject: [PATCH 22/27] afs: Use netfslib for directories
Date: Thu, 24 Oct 2024 15:05:20 +0100
Message-ID: <20241024140539.3828093-23-dhowells@redhat.com>
...
---
 ...
 8 files changed, 518 insertions(+), 440 deletions(-)

diff --git a/fs/afs/dir.c b/fs/afs/dir.c
index f36a28a8f27b..88a1e17d7d86 100644
--- a/fs/afs/dir.c
+++ b/fs/afs/dir.c
@@ -13,6 +13,7 @@
...
+#include <linux/iov_iter.h>
 ...
 #include "internal.h"
 #include "afs_fs.h"
@@ -78,6 +79,7 @@ const struct address_space_operations afs_dir_aops = {
...
@@ -105,146 +107,120 @@ struct afs_lookup_cookie {
...
+		printk("kAFS: %s(%lx): [%zx] bad magic %04hx\n",
...
+	return 0;
 ...
 /*
@@ -264,115 +240,117 @@ static int afs_dir_open(struct inode *inode, struct file *file)
 }
...
+		ret = netfs_alloc_folioq_buffer(dvnode->netfs.inode.i_mapping,
...
@@ -382,15 +360,14 @@ static struct afs_read *afs_read_dir(struct afs_vnode *dvnode, struct key *key)
 	}
...
+	return ret;
 ...
 /*
@@ -398,79 +375,69 @@ static struct afs_read *afs_read_dir(struct afs_vnode *dvnode, struct key *key)
  */
...
@@ -484,7 +451,7 @@ static int afs_dir_iterate_block(struct afs_vnode *dvnode,
 			return 0;
 		}
...
+		ctx->pos = (base + next) * sizeof(union afs_xdr_dirent);
 	...
 	_leave(" = 1 [more]");
@@ -492,67 +459,97 @@ static int afs_dir_iterate_block(struct afs_vnode *dvnode,
 }
...
@@ -564,8 +561,7 @@ static int afs_readdir(struct file *file, struct dir_context *ctx)
 {
...
+	return afs_dir_iterate(file_inode(file), ctx, file, &dir_version);
 ...
 /*
@@ -606,7 +602,7 @@ static bool afs_lookup_one_filldir(struct dir_context *ctx, const char *name,
...
@@ -620,7 +616,7 @@ static int afs_do_lookup_one(struct inode *dir, struct dentry *dentry,
...
+	ret = afs_dir_iterate(dir, &cookie.ctx, NULL, _dir_version);
 	if (ret < 0) {
 		_leave(" = %d [iter]", ret);
 		return ret;
@@ -787,8 +783,7 @@ static bool afs_server_supports_ibulk(struct afs_vnode *dvnode)
...
@@ -816,7 +811,7 @@ static struct inode *afs_do_lookup(struct inode *dir, struct dentry *dentry,
...
@@ -925,8 +920,7 @@ static struct inode *afs_do_lookup(struct inode *dir, struct dentry *dentry,
 /*
...
@@ -974,7 +968,6 @@ static struct dentry *afs_lookup_atsys(struct inode *dir, struct dentry *dentry,
...
@@ -988,7 +981,6 @@ static struct dentry *afs_lookup(struct inode *dir, struct dentry *dentry,
 	struct afs_fid fid = {};
 	struct inode *inode;
 	struct dentry *d;
-	struct key *key;
 	...
 	_enter("{%llx:%llu},%p{%pd},",
@@ -1006,15 +998,9 @@ static struct dentry *afs_lookup(struct inode *dir, struct dentry *dentry,
...
@@ -1024,11 +1010,10 @@ static struct dentry *afs_lookup(struct inode *dir, struct dentry *dentry,
...
@@ -1154,7 +1139,7 @@ static int afs_d_revalidate(struct dentry *dentry, unsigned int flags)
...
@@ -1316,18 +1301,21 @@ static void afs_create_success(struct afs_operation *op)
...
@@ -1355,6 +1343,7 @@ static int afs_mkdir(struct mnt_idmap *idmap, struct inode *dir,
 {
...
@@ -1365,6 +1354,8 @@ static int afs_mkdir(struct mnt_idmap *idmap, struct inode *dir,
 		return PTR_ERR(op);
 	}
...
@@ -1374,7 +1365,9 @@ static int afs_mkdir(struct mnt_idmap *idmap, struct inode *dir,
...
+	return ret;
 ...
 /*
@@ -1402,18 +1395,21 @@ static void afs_rmdir_success(struct afs_operation *op)
...
@@ -1448,6 +1444,8 @@ static int afs_rmdir(struct inode *dir, struct dentry *dentry)
 	if (IS_ERR(op))
 		return PTR_ERR(op);
...
+
 	...
 	op->file[0].dv_delta = 1;
 	op->file[0].modification = true;
@@ -1476,10 +1474,13 @@ static int afs_rmdir(struct inode *dir, struct dentry *dentry)
...
+	goto out;
 ...
 /*
@@ -1542,16 +1543,19 @@ static void afs_unlink_success(struct afs_operation *op)
...
@@ -1590,6 +1594,8 @@ static int afs_unlink(struct inode *dir, struct dentry *dentry)
 	if (IS_ERR(op))
 		return PTR_ERR(op);
...
+
 	...
 	op->file[0].dv_delta = 1;
 	op->file[0].modification = true;
@@ -1636,10 +1642,10 @@ static int afs_unlink(struct inode *dir, struct dentry *dentry)
...
@@ -1673,6 +1679,8 @@ static int afs_create(struct mnt_idmap *idmap, struct inode *dir,
 		goto error;
 	}
...
+
 	...
 	op->file[0].dv_delta = 1;
 	op->file[0].modification = true;
@@ -1683,7 +1691,9 @@ static int afs_create(struct mnt_idmap *idmap, struct inode *dir,
...
+	return ret;
 ...
 error:
 	d_drop(dentry);
@@ -1748,6 +1758,8 @@ static int afs_link(struct dentry *from, struct inode *dir,
 		goto error;
 	}
...
+
 	...
 	if (ret < 0)
 		goto error_op;
@@ -1763,10 +1775,13 @@ static int afs_link(struct dentry *from, struct inode *dir,
 	op->dentry_2		= from;
...
+	afs_dir_unuse_cookie(dvnode, ret);
 error:
 	d_drop(dentry);
 	_leave(" = %d", ret);
@@ -1810,6 +1825,8 @@ static int afs_symlink(struct mnt_idmap *idmap, struct inode *dir,
 		goto error;
 	}
...
@@ -1818,7 +1835,9 @@ static int afs_symlink(struct mnt_idmap *idmap, struct inode *dir,
...
+	return ret;
 ...
 error:
 	d_drop(dentry);
@@ -1860,6 +1879,7 @@ static void afs_rename_success(struct afs_operation *op)
...
@@ -1876,6 +1896,10 @@ static void afs_rename_edit_dir(struct afs_operation *op)
...
@@ -1925,6 +1949,9 @@ static void afs_rename_edit_dir(struct afs_operation *op)
...
@@ -1977,6 +2004,10 @@ static int afs_rename(struct mnt_idmap *idmap, struct inode *old_dir,
 	if (IS_ERR(op))
 		return PTR_ERR(op);
...
+
 	...
 	if (ret < 0)
@@ -2044,10 +2075,16 @@ static int afs_rename(struct mnt_idmap *idmap, struct inode *old_dir,
 	 */
 	d_drop(old_dentry);
...
+	goto out;
 ...
 /*
@@ -2058,31 +2095,49 @@ static bool afs_dir_release_folio(struct folio *folio, gfp_t gfp_flags)
 {
...
-	return true;
+	return netfs_release_folio(folio, gfp_flags);
 }
...
index 5d092c8c0157..28a966d2612d 100644
--- a/fs/afs/dir_edit.c
+++ b/fs/afs/dir_edit.c
@@ -10,6 +10,7 @@
