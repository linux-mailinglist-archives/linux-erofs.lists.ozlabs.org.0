Return-Path: <linux-erofs+bounces-3606-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-erofs@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id eJHmBv0gMWqEcAUAu9opvQ
	(envelope-from <linux-erofs+bounces-3606-lists+linux-erofs=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-erofs@lfdr.de>; Tue, 16 Jun 2026 12:10:05 +0200
X-Original-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:21b9:f100::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 1061768DF1A
	for <lists+linux-erofs@lfdr.de>; Tue, 16 Jun 2026 12:10:04 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=redhat.com header.s=mimecast20190719 header.b=A7lBUrV7;
	dkim=pass header.d=redhat.com header.s=mimecast20190719 header.b=A7lBUrV7;
	spf=pass (mail.lfdr.de: domain of "linux-erofs+bounces-3606-lists+linux-erofs=lfdr.de@lists.ozlabs.org" designates 2404:9400:21b9:f100::1 as permitted sender) smtp.mailfrom="linux-erofs+bounces-3606-lists+linux-erofs=lfdr.de@lists.ozlabs.org";
	dmarc=pass (policy=quarantine) header.from=redhat.com;
	arc=pass ("lists.ozlabs.org:s=201707:i=1")
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4gfjQx75YRz3bt2;
	Tue, 16 Jun 2026 20:10:01 +1000 (AEST)
X-Original-To: linux-erofs@lists.ozlabs.org
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1781604601;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1781604601; c=relaxed/relaxed;
	bh=1bq37TYGPcR6Z5A8yLdHVuoWVjWHB2L9/nI4613SJPQ=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:content-type; b=
ARC-Authentication-Results: i=1; lists.ozlabs.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=A7lBUrV7; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=A7lBUrV7; dkim-atps=neutral; spf=pass (client-ip=170.10.129.124; helo=us-smtp-delivery-124.mimecast.com; envelope-from=dhowells@redhat.com; receiver=lists.ozlabs.org) smtp.mailfrom=redhat.com
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange x25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lists.ozlabs.org (Postfix) with ESMTPS id 4gfjQv160lz3bqh
	for <linux-erofs@lists.ozlabs.org>; Tue, 16 Jun 2026 20:09:58 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1781604596;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=1bq37TYGPcR6Z5A8yLdHVuoWVjWHB2L9/nI4613SJPQ=;
	b=A7lBUrV7q3yXkUKJ0WnDXvpHRUNOkyro4cA5YCeDK8M+Shm724qh/35zNpuQeVk5SAa6ED
	/IHJlvM2FqmumBmRiDvIR3TtCbBKpTmIoCs/S/3+jZ85jIiNoXx9kX3kT7VIeQOrvVl+wp
	WmGbDtMaNLP3HZgOAeTsTc6aeQ6L4Kg=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1781604596;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
...
Received: from mx-prod-mc-01.mail-002.prod.us-west-2.aws.redhat.com
 ...
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-671-UKMkLyFJOS6HQZf6XGbhPA-1; Tue,
 16 Jun 2026 06:09:53 -0400
X-MC-Unique: UKMkLyFJOS6HQZf6XGbhPA-1
X-Mimecast-MFC-AGG-ID: UKMkLyFJOS6HQZf6XGbhPA_1781604590
Received: from mx-prod-int-08.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-08.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.111])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-01.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 32FC71955F40;
	Tue, 16 Jun 2026 10:09:50 +0000 (UTC)
Received: from warthog.procyon.org.com (unknown [10.44.50.44])
	by mx-prod-int-08.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id D0DE4180028B;
	Tue, 16 Jun 2026 10:09:43 +0000 (UTC)
...
Subject: [PATCH v4 09/30] cachefiles: Don't rely on backing fs storage map for most use cases
Date: Tue, 16 Jun 2026 11:07:58 +0100
Message-ID: <20260616100821.2062304-10-dhowells@redhat.com>
...
X-Mimecast-MFC-PROC-ID: 9Nn7Ecpku52omUc0wRjuXWrjIQGW0SGiSXrX-uSh5t4_1781604590
...
X-Spamd-Result: default: False [-1.20 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-3606-lists,linux-erofs=lfdr.de];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[infradead.org:email,lists.ozlabs.org:helo,lists.ozlabs.org:rdns,lists.ozlabs.org:from_smtp,linux.dev:email,manguebit.org:email]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: 1061768DF1A
...
index a464c4646c04..702d11b074f4 100644
...
@@ -472,6 +454,7 @@ struct file *cachefiles_create_tmpfile(struct cachefiles_object *object)
 	}
 out:
 	cachefiles_end_secure(cache, saved_cred);
+	object->content_info = CACHEFILES_CONTENT_ALL;
...
index 61e2d1e8891e..23713e3209ce 100644
...
+		}
 	...
 	_debug("finished");
@@ -478,24 +539,51 @@ void netfs_write_subrequest_terminated(void *_op, ssize_t transferred_or_error)
...
index 3454e8b0c248..d22e539a9c86 100644
...
index 1bc120d61c5b..96293f94ce64 100644
...
+struct fscache_occupancy;
 ...
 /**
@@ -152,6 +153,7 @@ struct netfs_io_stream {
...
+	bool			cancelled;	/* T if stream is cancelled */
 ...
 /*
@@ -161,8 +163,10 @@ struct netfs_cache_resources {
...
+	unsigned int			dio_size;	/* DIO block size */
 ...
 /*
@@ -197,6 +201,7 @@ struct netfs_io_subrequest {
...
@@ -252,6 +257,7 @@ struct netfs_io_request {
...
@@ -273,11 +279,13 @@ struct netfs_io_request {
...
@@ -322,6 +330,12 @@ enum netfs_read_from_hole {
...
+
  ...
  */
@@ -356,8 +370,7 @@ struct netfs_cache_ops {
 	/* Prepare a read operation, shortening it to a cached/uncached
 	 * boundary as appropriate.
 	 */
...
@@ -385,8 +398,17 @@ struct netfs_cache_ops {
