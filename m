Return-Path: <linux-erofs+bounces-783-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
X-Original-To: lists+linux-erofs@lfdr.de
Delivered-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id D588AB1D12A
	for <lists+linux-erofs@lfdr.de>; Thu,  7 Aug 2025 05:08:59 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4byBvS1F5Hz3bmc;
	Thu,  7 Aug 2025 13:08:52 +1000 (AEST)
X-Original-To: linux-erofs@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; arc=none smtp.remote-ip=115.124.30.119
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1754536132;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1754536132; c=relaxed/relaxed;
	bh=C9wBc+iBoibCzjkfMhJ5JOdFkrfXuggunNKvF553qcY=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=
ARC-Authentication-Results: i=1; lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=linux.alibaba.com; dkim=pass (1024-bit key; unprotected) header.d=linux.alibaba.com header.i=@linux.alibaba.com header.a=rsa-sha256 header.s=default header.b=CLSh40gU; dkim-atps=neutral; spf=pass (client-ip=115.124.30.119; helo=out30-119.freemail.mail.aliyun.com; envelope-from=hsiangkao@linux.alibaba.com; receiver=lists.ozlabs.org) smtp.mailfrom=linux.alibaba.com
Authentication-Results: lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=linux.alibaba.com
Authentication-Results: lists.ozlabs.org;
	dkim=pass (1024-bit key; unprotected) header.d=linux.alibaba.com header.i=@linux.alibaba.com header.a=rsa-sha256 header.s=default header.b=CLSh40gU;
	dkim-atps=neutral
...
Received: from out30-119.freemail.mail.aliyun.com (out30-119.freemail.mail.aliyun.com [115.124.30.119])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4byBvP1RHzz3bmC
	for <linux-erofs@lists.ozlabs.org>; Thu,  7 Aug 2025 13:08:48 +1000 (AEST)
DKIM-Signature:v=1; a=rsa-sha256; c=relaxed/relaxed;
	d=linux.alibaba.com; s=default;
	t=1754536125; h=From:To:Subject:Date:Message-ID:MIME-Version;
	bh=C9wBc+iBoibCzjkfMhJ5JOdFkrfXuggunNKvF553qcY=;
	b=CLSh40gUxwKuC5W/DSNmGpqCibG/PcollTIl+wsgSMdWqoRQfzrztmF3OroR8wjb+h556F2WfjPkQGqznHr0g7zaY4qhXaKkk85UNiwGHKuhXaJiERxlaoAoufYMyl8TeHWn0AGDExa+fXlceyZv/8RoLLktRSgpR6lTtwbeOi4=
Received: from x31i01179.sqa.na131.tbsite.net(mailfrom:hsiangkao@linux.alibaba.com fp:SMTPD_---0WlCf8-n_1754536123 cluster:ay36)
          by smtp.aliyun-inc.com;
          Thu, 07 Aug 2025 11:08:43 +0800
...
Date: Thu,  7 Aug 2025 11:08:34 +0800
Message-ID: <20250807030835.2671337-4-hsiangkao@linux.alibaba.com>
...
+		erofs_err("request failed with HTTP status code %ld", http_code);
+		ret = -EIO;
+	}
+
+err_header:
