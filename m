...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id 52FE09C234A
	for <lists+linux-erofs@lfdr.de>; Fri,  8 Nov 2024 18:36:28 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4XlR222p5Rz3c2F
	for <lists+linux-erofs@lfdr.de>; Sat,  9 Nov 2024 04:36:26 +1100 (AEDT)
X-Original-To: linux-erofs@lists.ozlabs.org
Delivered-To: linux-erofs@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; arc=none smtp.remote-ip=170.10.133.124
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1731087383;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1731087383; c=relaxed/relaxed;
	bh=0pxaLJUSCtKSncckc/jDUY2DSkQUPZU0ohB47Xxl2xk=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=
ARC-Authentication-Results: i=1; lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=redhat.com; dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=FOxyrkEj; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=GO3zR6eq; dkim-atps=neutral; spf=pass (client-ip=170.10.133.124; helo=us-smtp-delivery-124.mimecast.com; envelope-from=dhowells@redhat.com; receiver=lists.ozlabs.org) smtp.mailfrom=redhat.com
Authentication-Results: lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: lists.ozlabs.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=FOxyrkEj;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=GO3zR6eq;
	dkim-atps=neutral
...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4XlR1x3tXFz3bkY
	for <linux-erofs@lists.ozlabs.org>; Sat,  9 Nov 2024 04:36:21 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1731087378;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=0pxaLJUSCtKSncckc/jDUY2DSkQUPZU0ohB47Xxl2xk=;
	b=FOxyrkEjnVQxyYdBAO2LcgHnGQirSj8m9HsjY9Hs9S9ii/6p8sZX2dPxZ7wY4Mdn2Sy9zS
	1p9LIy7QsrOvpQYWUCqI5vij0egNV1jXhnoHJQnwJOeqJ3UDpYvFhuHrNTM7PdaRnqxiRU
	o6h1DcEOSOPDIasMrnGox08iElKRHes=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1731087379;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=0pxaLJUSCtKSncckc/jDUY2DSkQUPZU0ohB47Xxl2xk=;
	b=GO3zR6eqGRjw7hmdYJmC46gzvDNvEe6/r8Ml5damgV5otzzInsIdau1xQ2z4MBr4cAb2Ih
	u2bxvwegaVkcqqg42ZOOnRZhrm+g+/1skMLONQApeLkTnEeZDgnmR2XI7gevPvgC1WVS+D
	4c+d97dEl5KESw2NZ2eaFKA2cu6PiFw=
Received: from mx-prod-mc-04.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-54-186-198-63.us-west-2.compute.amazonaws.com [54.186.198.63]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-290-VlmEWM-kOsmpd9dsiY2Geg-1; Fri,
 08 Nov 2024 12:36:15 -0500
X-MC-Unique: VlmEWM-kOsmpd9dsiY2Geg-1
X-Mimecast-MFC-AGG-ID: VlmEWM-kOsmpd9dsiY2Geg
Received: from mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.4])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-04.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 8D7FE1955F34;
	Fri,  8 Nov 2024 17:36:08 +0000 (UTC)
Received: from warthog.procyon.org.uk.com (unknown [10.42.28.231])
	by mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id A7C09300019F;
	Fri,  8 Nov 2024 17:36:02 +0000 (UTC)
From: David Howells <dhowells@redhat.com>
To: Christian Brauner <christian@brauner.io>,
	Steve French <smfrench@gmail.com>,
	Matthew Wilcox <willy@infradead.org>
Subject: [PATCH v4 28/33] netfs: Change the read result collector to only use one work item
Date: Fri,  8 Nov 2024 17:32:29 +0000
Message-ID: <20241108173236.1382366-29-dhowells@redhat.com>
...
---
 ...
 include/trace/events/netfs.h |  76 +---
 16 files changed, 670 insertions(+), 618 deletions(-)
...
index 86d3955a78cd..36b80449ef0e 100644
--- a/fs/afs/dir.c
+++ b/fs/afs/dir.c
...
index 9124c8c36f9d..7f3a3c056c6e 100644
...
@@ -82,237 +95,243 @@ static void netfs_unlock_read_folio(struct netfs_io_subrequest *subreq,
 }
...
+	goto out;
 ...
 /*
@@ -321,12 +340,13 @@ static bool netfs_consume_read_data(struct netfs_io_subrequest *subreq)
...
+	list_for_each_entry(subreq, &stream->subrequests, rreq_link) {
 		...
 		if (subreq->transferred < subreq->len ||
@@ -363,22 +383,12 @@ static void netfs_rreq_assess_dio(struct netfs_io_request *rreq)
  */
...
+		netfs_single_mark_inode_dirty(rreq->inode);
 	...
 	if (rreq->iocb) {
@@ -392,21 +402,32 @@ static void netfs_rreq_assess_single(struct netfs_io_request *rreq)
 }
...
+	//netfs_rreq_is_still_valid(rreq);
 	...
 	switch (rreq->origin) {
 	case NETFS_DIO_READ:
@@ -432,6 +453,33 @@ void netfs_rreq_terminated(struct netfs_io_request *rreq)
...
@@ -445,17 +493,22 @@ void netfs_rreq_terminated(struct netfs_io_request *rreq)
...
@@ -479,8 +532,7 @@ EXPORT_SYMBOL(netfs_read_subreq_progress);
...
+	struct netfs_io_stream *stream = &rreq->io_streams[0];
 	...
 	switch (subreq->source) {
 	case NETFS_READ_FROM_CACHE:
@@ -493,83 +545,114 @@ void netfs_read_subreq_terminated(struct netfs_io_subrequest *subreq)
 		break;
 	}
...
index 5e21c6939c88..4af7208e1360 100644
...
@@ -267,15 +260,18 @@ struct netfs_io_request {
...
index e8075c29ecf5..22eb77b1f5e6 100644
...
@@ -352,7 +359,7 @@ TRACE_EVENT(netfs_sreq,
...
@@ -701,71 +708,6 @@ TRACE_EVENT(netfs_collect_stream,
