...
Received: from lists.ozlabs.org (lists.ozlabs.org [203.11.71.2])
	by mail.lfdr.de (Postfix) with ESMTPS id B9E417C80E
	for <lists+linux-erofs@lfdr.de>; Wed, 31 Jul 2019 18:01:50 +0200 (CEST)
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by lists.ozlabs.org (Postfix) with ESMTP id 45zJ8C23RYzDqkw
	for <lists+linux-erofs@lfdr.de>; Thu,  1 Aug 2019 02:01:47 +1000 (AEST)
...
Received: from huawei.com (szxga04-in.huawei.com [45.249.212.190])
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 45zJ4b28n8zDql2
 for <linux-erofs@lists.ozlabs.org>; Thu,  1 Aug 2019 01:58:38 +1000 (AEST)
Received: from DGGEMS410-HUB.china.huawei.com (unknown [172.30.72.58])
 by Forcepoint Email with ESMTP id 0F108A3065556FEE1AF9;
...
Subject: [PATCH v2 17/22] staging: erofs: tidy up decompression frontend
Date: Wed, 31 Jul 2019 23:57:47 +0800
Message-ID: <20190731155752.210602-18-gaoxiang25@huawei.com>
...
@@ -787,15 +662,14 @@ static int z_erofs_do_read_page(struct z_erofs_vle_frontend *fe,
 	if (unlikely(err))
 		goto err_out;
...
@@ -805,7 +679,6 @@ static int z_erofs_do_read_page(struct z_erofs_vle_frontend *fe,
 		goto repeat;
...
@@ -821,7 +694,7 @@ static int z_erofs_do_read_page(struct z_erofs_vle_frontend *fe,
...
+	page = READ_ONCE(pcl->compressed_pages[nr]);
 	...
 	if (!page)
@@ -1186,7 +1043,7 @@ pickup_page_for_submission(struct z_erofs_vle_workgroup *grp,
...
+		WRITE_ONCE(pcl->compressed_pages[nr], page);
 		...
 		ClearPageError(page);
 		if (!PagePrivate(page)) {
@@ -1198,7 +1055,7 @@ pickup_page_for_submission(struct z_erofs_vle_workgroup *grp,
 			DBG_BUGON(!justfound);
...
@@ -1222,7 +1079,7 @@ pickup_page_for_submission(struct z_erofs_vle_workgroup *grp,
 	put_page(page);
 out_allocpage:
...
+	if (oldpage != cmpxchg(&pcl->compressed_pages[nr], oldpage, page)) {
 		...
 		cpu_relax();
 		goto repeat;
@@ -1234,18 +1091,17 @@ pickup_page_for_submission(struct z_erofs_vle_workgroup *grp,
 		goto out;
 	}
...
+	/* decompress no I/O pclusters immediately */
 ...
 #endif
 	if (!force_fg)
@@ -1480,7 +1336,7 @@ static int z_erofs_vle_normalaccess_readpage(struct file *file,
 					     struct page *page)
 {
