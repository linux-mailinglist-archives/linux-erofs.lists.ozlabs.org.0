...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id 137607685F1
	for <lists+linux-erofs@lfdr.de>; Sun, 30 Jul 2023 16:13:02 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4RDNcr04dTz2yF1
	for <lists+linux-erofs@lfdr.de>; Mon, 31 Jul 2023 00:13:00 +1000 (AEST)
...
Received: from out30-99.freemail.mail.aliyun.com (out30-99.freemail.mail.aliyun.com [115.124.30.99])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4RDNcn06P5z2yDg
	for <linux-erofs@lists.ozlabs.org>; Mon, 31 Jul 2023 00:12:55 +1000 (AEST)
X-Alimail-AntiSpam: AC=PASS;BC=-1|-1;BR=01201311R141e4;CH=green;DM=||false|;DS=||;FP=0|-1|-1|-1|0|-1|-1|-1;HT=ay29a033018045176;MF=hsiangkao@linux.alibaba.com;NM=1;PH=DS;RN=4;SR=0;TI=SMTPD_---0VoVzyaP_1690726365;
Received: from e18g06460.et15sqa.tbsite.net(mailfrom:hsiangkao@linux.alibaba.com fp:SMTPD_---0VoVzyaP_1690726365)
          by smtp.aliyun-inc.com;
          Sun, 30 Jul 2023 22:12:51 +0800
From: Gao Xiang <hsiangkao@linux.alibaba.com>
To: linux-erofs@lists.ozlabs.org,
	Chao Yu <chao@kernel.org>
Subject: [PATCH v5] erofs: DEFLATE compression support
Date: Sun, 30 Jul 2023 22:12:45 +0800
Message-Id: <20230730141245.6691-1-hsiangkao@linux.alibaba.com>
...
---
changes since v4:
 - add a missing kfree(strm) in z_erofs_deflate_init() pointed out by Chao;

 fs/erofs/Kconfig                |  15 ++
 fs/erofs/Makefile               |   1 +
 fs/erofs/compress.h             |   2 +
 fs/erofs/decompressor.c         |   6 +
 fs/erofs/decompressor_deflate.c | 252 ++++++++++++++++++++++++++++++++
...
index 000000000000..3f2495821df0
--- /dev/null
