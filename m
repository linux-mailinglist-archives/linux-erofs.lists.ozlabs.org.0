Return-Path: <linux-erofs+bounces-3622-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-erofs@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id PJd7M4whMWrwcAUAu9opvQ
	(envelope-from <linux-erofs+bounces-3622-lists+linux-erofs=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-erofs@lfdr.de>; Tue, 16 Jun 2026 12:12:28 +0200
X-Original-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id D8DAB68E08E
	for <lists+linux-erofs@lfdr.de>; Tue, 16 Jun 2026 12:12:27 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=redhat.com header.s=mimecast20190719 header.b=A3Txpx2P;
	dkim=pass header.d=redhat.com header.s=mimecast20190719 header.b=A3Txpx2P;
	spf=pass (mail.lfdr.de: domain of "linux-erofs+bounces-3622-lists+linux-erofs=lfdr.de@lists.ozlabs.org" designates 112.213.38.117 as permitted sender) smtp.mailfrom="linux-erofs+bounces-3622-lists+linux-erofs=lfdr.de@lists.ozlabs.org";
	dmarc=pass (policy=quarantine) header.from=redhat.com;
	arc=pass ("lists.ozlabs.org:s=201707:i=1")
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4gfjTj4zRFz3brR;
	Tue, 16 Jun 2026 20:12:25 +1000 (AEST)
X-Original-To: linux-erofs@lists.ozlabs.org
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1781604745;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1781604745; c=relaxed/relaxed;
	bh=yI/3ezSOr/2dVtK2oZ4XT8lm6M5QSfPUKF/7Bp0Gtj8=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:content-type; b=
ARC-Authentication-Results: i=1; lists.ozlabs.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=A3Txpx2P; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=A3Txpx2P; dkim-atps=neutral; spf=pass (client-ip=170.10.129.124; helo=us-smtp-delivery-124.mimecast.com; envelope-from=dhowells@redhat.com; receiver=lists.ozlabs.org) smtp.mailfrom=redhat.com
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange x25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lists.ozlabs.org (Postfix) with ESMTPS id 4gfjTg6wgzz3bqh
	for <linux-erofs@lists.ozlabs.org>; Tue, 16 Jun 2026 20:12:23 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1781604740;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=yI/3ezSOr/2dVtK2oZ4XT8lm6M5QSfPUKF/7Bp0Gtj8=;
	b=A3Txpx2PzwajWtBeF5WGrYdHNM7l1vDyxAKtTKf3R7Ct4HdSczXN8ev3pj75MuDmBNMMQH
	dW4+KdFPE9g2A9gru0S5i2RkcH1IlhqLkoKGKBBF5TsGwXvozJNb/e5ce+k7Je83tQxnuh
	pjufc3dmFCyCOja65M4n+9ty08ZC4mY=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1781604740;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
...
Received: from mx-prod-mc-01.mail-002.prod.us-west-2.aws.redhat.com
 ...
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-639-aZKOMCxoPhSqosS8-9yk3w-1; Tue,
 16 Jun 2026 06:12:15 -0400
X-MC-Unique: aZKOMCxoPhSqosS8-9yk3w-1
X-Mimecast-MFC-AGG-ID: aZKOMCxoPhSqosS8-9yk3w_1781604732
Received: from mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.4])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-01.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id DAECA196C404;
	Tue, 16 Jun 2026 10:11:57 +0000 (UTC)
Received: from warthog.procyon.org.com (unknown [10.44.50.44])
	by mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id 6E5463008B3D;
	Tue, 16 Jun 2026 10:11:51 +0000 (UTC)
...
Subject: [PATCH v4 25/30] iov_iter: Remove ITER_FOLIOQ
Date: Tue, 16 Jun 2026 11:08:14 +0100
Message-ID: <20260616100821.2062304-26-dhowells@redhat.com>
...
X-Mimecast-MFC-PROC-ID: 5ADks4QrL71LegjZ1FeOsU_AQxb4--mLqhq84lKcpt4_1781604732
...
X-Spamd-Result: default: False [-1.20 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-3622-lists,linux-erofs=lfdr.de];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[linux.dev:email,manguebit.org:email,infradead.org:email,samba.org:email,lists.ozlabs.org:helo,lists.ozlabs.org:rdns,lists.ozlabs.org:from_smtp]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: D8DAB68E08E
...
index 205d0da47b12..17db9798ac8d 100644
--- a/lib/iov_iter.c
+++ b/lib/iov_iter.c
...
@@ -1993,8 +1828,8 @@ static ssize_t iov_iter_extract_user_pages(struct iov_iter *i,
...
+ *      merely listed; no extra refs or pins are obtained.
  ...
  *
  * Note also:
@@ -2033,10 +1868,6 @@ ssize_t iov_iter_extract_pages(struct iov_iter *i,
...
index df3e78e7c7aa..4fb43d07452e 100644
...
@@ -375,176 +374,6 @@ static void __init iov_kunit_copy_from_bvec(struct kunit *test)
 	KUNIT_SUCCEED(test);
 }
...
@@ -1118,85 +947,6 @@ static void __init iov_kunit_extract_pages_bvecq(struct kunit *test)
 	KUNIT_SUCCEED(test);
 }
...
-
  ...
  */
@@ -1424,23 +1174,6 @@ static void __init iov_kunit_iter_to_sg_bvec(struct kunit *test)
...
-
 ...
 {
 	struct iov_kunit_iter_to_sg_data data;
@@ -1479,18 +1212,14 @@ static struct kunit_case __refdata iov_kunit_cases[] = {
