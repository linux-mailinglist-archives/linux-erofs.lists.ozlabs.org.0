...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C4B5EEC21
	for <lists+linux-erofs@lfdr.de>; Mon,  4 Nov 2019 22:54:18 +0100 (CET)
Received: from bilbo.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by lists.ozlabs.org (Postfix) with ESMTP id 476RQZ1CCrzF4LX
	for <lists+linux-erofs@lfdr.de>; Tue,  5 Nov 2019 08:54:14 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=lists.ozlabs.org;
	s=201707; t=1572904454;
	bh=T/O0cEor0tTcXvR95ZvziznUbhRbkW6G43ZGUmjvRdc=;
	h=To:Subject:Date:In-Reply-To:References:List-Id:List-Unsubscribe:
	 List-Archive:List-Post:List-Help:List-Subscribe:From:Reply-To:Cc:
	 From;
	b=
X-Original-To: linux-erofs@lists.ozlabs.org
Delivered-To: linux-erofs@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; spf=pass (sender SPF authorized)
 smtp.mailfrom=android.com (client-ip=2607:f8b0:4864:20::443;
 helo=mail-pf1-x443.google.com; envelope-from=salyzyn@android.com;
 receiver=<UNKNOWN>)
Authentication-Results: lists.ozlabs.org;
 dmarc=pass (p=reject dis=none) header.from=android.com
Authentication-Results: lists.ozlabs.org; dkim=pass (2048-bit key;
 unprotected) header.d=android.com header.i=@android.com header.b="lKPhf5qk"; 
 dkim-atps=neutral
Received: from mail-pf1-x443.google.com (mail-pf1-x443.google.com
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 476RQS1vPczF4LP
 for <linux-erofs@lists.ozlabs.org>; Tue,  5 Nov 2019 08:54:05 +1100 (AEDT)
Received: by mail-pf1-x443.google.com with SMTP id p26so13422491pfq.8
 for <linux-erofs@lists.ozlabs.org>; Mon, 04 Nov 2019 13:54:05 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=fVe6jHlYQhLX8bRvD2NO1N9P5/RoJrzl3x6s3iEtt1U=;
 b=
X-Gm-Message-State: APjAAAVo3/PPM+8t7PMdJCUOZFsulJSknM/TFZ+kFasxE+YeUI8jA2O7
 JZ478C85gbvmBrRwQ7qfAIM08g==
...
Subject: [PATCH v15 1/4] Add flags option to get xattr method paired to
 __vfs_getxattr
...
Cc: Latchesar Ionkov <lucho@ionkov.net>, Dave Kleikamp <shaggy@kernel.org>,
 ...
 Adrian Hunter <adrian.hunter@intel.com>, Mark Salyzyn <salyzyn@android.com>,
