...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E7F9424D62
	for <lists+linux-erofs@lfdr.de>; Thu,  7 Oct 2021 08:42:46 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4HQ1wN12ZCz2ynG
	for <lists+linux-erofs@lfdr.de>; Thu,  7 Oct 2021 17:42:44 +1100 (AEDT)
...
Received: from out30-131.freemail.mail.aliyun.com
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 4HQ1wH336Hz2yWH
 for <linux-erofs@lists.ozlabs.org>; Thu,  7 Oct 2021 17:42:37 +1100 (AEDT)
X-Alimail-AntiSpam: AC=PASS; BC=-1|-1; BR=01201311R101e4; CH=green; DM=||false|;
 DS=||; FP=0|-1|-1|-1|0|-1|-1|-1; HT=e01e04423; MF=bo.liu@linux.alibaba.com;
 NM=1; PH=DS; RN=9; SR=0; TI=SMTPD_---0UqoPMLU_1633588941; 
Received: from rsjd01523.et2sqa(mailfrom:bo.liu@linux.alibaba.com
 fp:SMTPD_---0UqoPMLU_1633588941) by smtp.aliyun-inc.com(127.0.0.1);
 Thu, 07 Oct 2021 14:42:21 +0800
Date: Thu, 7 Oct 2021 14:42:21 +0800
From: Liu Bo <bo.liu@linux.alibaba.com>
To: Gao Xiang <hsiangkao@linux.alibaba.com>
Subject: Re: [PATCH v3 2/2] erofs: add multiple device support
Message-ID: <20211007064220.GB84859@rsjd01523.et2sqa>
References: <20211006194453.130447-1-hsiangkao@linux.alibaba.com>
 <20211006194453.130447-2-hsiangkao@linux.alibaba.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20211006194453.130447-2-hsiangkao@linux.alibaba.com>
...
On Thu, Oct 07, 2021 at 03:44:53AM +0800, Gao Xiang wrote:
...
> index 25f6b8b37f28..f4dd20f76862 100644
> --- a/fs/erofs/super.c
> +++ b/fs/erofs/super.c
...
>  	if (err)
>  		return err;
> @@ -617,9 +720,32 @@ static int erofs_fc_reconfigure(struct fs_context *fc)
>  	return 0;
>  }
>  
...
> @@ -631,13 +757,20 @@ static const struct fs_context_operations erofs_context_ops = {
>  
...
>  	return 0;
>  }
> @@ -657,6 +790,8 @@ static void erofs_kill_sb(struct super_block *sb)
>  	sbi = EROFS_SB(sb);
>  	if (!sbi)
>  		return;
> +
...
>  	kfree(sbi);
>  	sb->s_fs_info = NULL;
> @@ -746,7 +881,7 @@ static int erofs_statfs(struct dentry *dentry, struct kstatfs *buf)
>  
