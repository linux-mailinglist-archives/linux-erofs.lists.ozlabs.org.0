...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A3678876EE
	for <lists+linux-erofs@lfdr.de>; Sat, 23 Mar 2024 04:46:36 +0100 (CET)
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.a=rsa-sha256 header.s=20230601 header.b=gnoT6q2L;
	dkim-atps=neutral
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4V1lVd4WWxz3cCx
	for <lists+linux-erofs@lfdr.de>; Sat, 23 Mar 2024 14:46:33 +1100 (AEDT)
X-Original-To: linux-erofs@lists.ozlabs.org
Delivered-To: linux-erofs@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.a=rsa-sha256 header.s=20230601 header.b=gnoT6q2L;
	dkim-atps=neutral
Authentication-Results: lists.ozlabs.org; spf=pass (sender SPF authorized) smtp.mailfrom=gmail.com (client-ip=2607:f8b0:4864:20::b33; helo=mail-yb1-xb33.google.com; envelope-from=jnhuang95@gmail.com; receiver=lists.ozlabs.org)
Received: from mail-yb1-xb33.google.com (mail-yb1-xb33.google.com [IPv6:2607:f8b0:4864:20::b33])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lists.ozlabs.org (Postfix) with ESMTPS id 4V1lVV6J3dz30hQ
	for <linux-erofs@lists.ozlabs.org>; Sat, 23 Mar 2024 14:46:25 +1100 (AEDT)
Received: by mail-yb1-xb33.google.com with SMTP id 3f1490d57ef6-dd161eb03afso2429797276.0
        for <linux-erofs@lists.ozlabs.org>; Fri, 22 Mar 2024 20:46:25 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1711165581; x=1711770381; darn=lists.ozlabs.org;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=/njZ0r2S6OHgRohCzVQxdrzBYDhnlpXh3jl+JE4hfpY=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1711165581; x=1711770381;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=/njZ0r2S6OHgRohCzVQxdrzBYDhnlpXh3jl+JE4hfpY=;
        b=
X-Gm-Message-State: AOJu0YxPrWr3n8jXbqsiE2YrNzIBZIsFelAcmrsCaqb/V8fezN9i7832
	+3X5spJ97hu1nlwb0piaR+Pala9SeICYYinpyWFNxkb60MVZuZ7D6JEQO7y0mKow/R8wvJoK3sv
	0BpE0eUKN5UYN4/rcC0GYeXisGWpavyS7ueq3Zw==
X-Google-Smtp-Source: AGHT+IHyippvDlrO6+fiIsmKy+QqARBXNZtHgRxKdKY7gm/87J2VeUNP0rG1SfDw1WZNCRBPqXn7Lf7WZ9aJcfv4DfY=
X-Received: by 2002:a25:c187:0:b0:dd1:37ff:696 with SMTP id
 r129-20020a25c187000000b00dd137ff0696mr923138ybf.59.1711165580858; Fri, 22
 Mar 2024 20:46:20 -0700 (PDT)
MIME-Version: 1.0
References: <20240322102421.3780992-1-zhaoyifan@sjtu.edu.cn> <20240322102421.3780992-3-zhaoyifan@sjtu.edu.cn>
In-Reply-To: <20240322102421.3780992-3-zhaoyifan@sjtu.edu.cn>
From: Huang Jianan <jnhuang95@gmail.com>
Date: Sat, 23 Mar 2024 11:46:07 +0800
Message-ID: <CAJfKizooP=XdYfNawzJRBmJYS2j5v=pvkGbj5EXcD-wihEGKtw@mail.gmail.com>
...
=A5=E5=91=A8=E4=BA=94 18:25=E5=86=99=E9=81=93=EF=BC=9A
>
...
>
> @@ -1025,6 +1026,90 @@ int z_erofs_compress_segment(struct z_erofs_compre=
ss_sctx *ctx,
>         return 0;
>  }
>
...
>  {
> @@ -1099,6 +1184,7 @@ void z_erofs_mt_workfn(struct erofs_work *work, voi=
d *tlsp)
...
>         int ret =3D 0;
>
> @@ -1124,10 +1210,10 @@ void z_erofs_mt_workfn(struct erofs_work *work, v=
oid *tlsp)
>
>  out:
...
> @@ -1161,27 +1247,60 @@ int z_erofs_merge_segment(struct z_erofs_compress=
_ictx *ictx,
>  }
>
...
>                 last =3D &cur->next;
>
> @@ -1205,21 +1324,29 @@ int z_erofs_mt_compress(struct z_erofs_compress_i=
ctx *ictx,
...
>                         ret =3D cur->errcode;
>                 } else {
> @@ -1230,13 +1357,30 @@ int z_erofs_mt_compress(struct z_erofs_compress_i=
ctx *ictx,
>                         if (ret2)
>                                 ret =3D ret2;
>
...
> @@ -1260,11 +1402,17 @@ int erofs_write_compressed_file(struct erofs_inod=
...
>         ctx.fd =3D fd;
> @@ -1331,11 +1478,24 @@ int erofs_write_compressed_file(struct erofs_inod=
e *inode, int fd, u64 fpos)
>                 if (ret)
>                         goto err_free_idata;
>  #ifdef EROFS_MT_ENABLED
...
> @@ -1377,69 +1533,10 @@ int erofs_write_compressed_file(struct erofs_inod=
e *inode, int fd, u64 fpos)
...
> @@ -1100,6 +1105,10 @@ static void erofs_fixup_meta_blkaddr(struct erofs_=
inode *rootdir)
...
>  {
> @@ -1143,6 +1152,21 @@ static int erofs_mkfs_handle_file(struct erofs_ino=
de *inode)
>         return 0;
>  }
>
...
>  {
> @@ -1152,6 +1176,14 @@ static int erofs_mkfs_handle_dir(struct erofs_inod=
e *dir,
...
> @@ -1159,7 +1191,6 @@ static int erofs_mkfs_handle_dir(struct erofs_inode=
 *dir,
>                 return -errno;
>         }
>
...
> @@ -1195,13 +1226,15 @@ static int erofs_mkfs_handle_dir(struct erofs_ino=
de *dir,
>         if (ret)
>                 return ret;
>
...
> @@ -1300,11 +1333,13 @@ static int erofs_mkfs_build_tree(struct erofs_ino=
de *dir,
>
...
> @@ -1325,7 +1360,8 @@ struct erofs_inode *erofs_mkfs_build_tree_from_path=
(const char *path)
...
>                 if (err) {
> @@ -1333,15 +1369,215 @@ struct erofs_inode *erofs_mkfs_build_tree_from_p=
ath(const char *path)
>                         break;
>                 }
>
