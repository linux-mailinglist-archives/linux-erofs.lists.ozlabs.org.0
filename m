Return-Path: <linux-erofs+bounces-2658-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-erofs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id WINZEWQzsWm0rwIAu9opvQ
	(envelope-from <linux-erofs+bounces-2658-lists+linux-erofs=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-erofs@lfdr.de>; Wed, 11 Mar 2026 10:18:28 +0100
X-Original-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:21b9:f100::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F3A9260295
	for <lists+linux-erofs@lfdr.de>; Wed, 11 Mar 2026 10:18:27 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4fW4t869Kzz3cMl;
	Wed, 11 Mar 2026 20:18:24 +1100 (AEDT)
X-Original-To: linux-erofs@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; arc=fail smtp.remote-ip=198.175.65.12
ARC-Seal: i=2; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1773220704;
	cv=fail; b=
ARC-Message-Signature: i=2; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1773220704; c=relaxed/relaxed;
	bh=0XsUbJr6kXjuRtF79qpmNM/wiiW/pKARuseo0u1QYd8=;
	h=From:To:CC:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=
ARC-Authentication-Results: i=2; lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=intel.com; dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.a=rsa-sha256 header.s=Intel header.b=cunJSnsZ; dkim-atps=neutral; spf=pass (client-ip=198.175.65.12; helo=mgamail.intel.com; envelope-from=aleksandr.loktionov@intel.com; receiver=lists.ozlabs.org) smtp.mailfrom=intel.com
Authentication-Results: lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.a=rsa-sha256 header.s=Intel header.b=cunJSnsZ;
	dkim-atps=neutral
...
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4fW4t74mSYz3cMG
	for <linux-erofs@lists.ozlabs.org>; Wed, 11 Mar 2026 20:18:23 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=cunJSnsZ/KezWTnwZ6zBeWli56uEtChfZ2xd/hqjeIK2Bp8fKwmO1ZF+
   ...
   Q==;
X-CSE-ConnectionGUID: +fW0qQNbR9SqnwxSNC6IeQ==
X-CSE-MsgGUID: nnDi7rBJR7edz8Cd2rf7Eg==
X-IronPort-AV: E=McAfee;i="6800,10657,11725"; a="85760281"
X-IronPort-AV: E=Sophos;i="6.23,113,1770624000"; 
   d="scan'208";a="85760281"
...
X-Spamd-Result: default: False [2.40 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-2658-lists,linux-erofs=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	TO_DN_SOME(0.00)[];
