...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 226F574AFD
	for <lists+linux-erofs@lfdr.de>; Thu, 25 Jul 2019 12:00:28 +0200 (CEST)
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by lists.ozlabs.org (Postfix) with ESMTP id 45vSQ03tTjzDqGm
	for <lists+linux-erofs@lfdr.de>; Thu, 25 Jul 2019 20:00:24 +1000 (AEST)
...
Received: from huawei.com (szxga04-in.huawei.com [45.249.212.190])
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 45vSMK0vHmzDqQ1
 for <linux-erofs@lists.ozlabs.org>; Thu, 25 Jul 2019 19:58:05 +1000 (AEST)
Received: from DGGEMS410-HUB.china.huawei.com (unknown [172.30.72.59])
 by Forcepoint Email with ESMTP id 3C70661222E1006BAC1C;
...
Subject: [PATCH v4 22/24] erofs: introduce the decompression frontend
Date: Thu, 25 Jul 2019 17:56:56 +0800
Message-ID: <20190725095658.155779-23-gaoxiang25@huawei.com>
...
---
 ...
 fs/erofs/super.c    |    9 +
 fs/erofs/zdata.c    | 1257 +++++++++++++++++++++++++++++++++++++++++++
 fs/erofs/zdata.h    |  192 +++++++
 fs/erofs/zmap.c     |    4 +-
 7 files changed, 1475 insertions(+), 4 deletions(-)
...
index d450ab130d5e..e34800b20bc2 100644
...
+
 	...
 	u32 blocks;
@@ -331,6 +334,9 @@ static inline bool is_inode_flat_inline(struct inode *inode)
...
@@ -491,7 +497,7 @@ int erofs_namei(struct inode *dir, struct qstr *name,
 /* dir.c */
...
@@ -517,17 +523,21 @@ int erofs_register_workgroup(struct super_block *sb,
...
index 45552d984108..bc481b7adfc1 100644
--- a/fs/erofs/super.c
+++ b/fs/erofs/super.c
...
+#endif
 ...
 #endif
@@ -420,6 +423,9 @@ static int __init erofs_module_init(void)
...
+		goto zip_err;
 	...
 	if (err)
 		goto fs_err;
@@ -428,6 +434,8 @@ static int __init erofs_module_init(void)
 	return 0;
...
@@ -438,6 +446,7 @@ static int __init erofs_module_init(void)
...
index 000000000000..cd187f04b883
--- /dev/null
+++ b/fs/erofs/zdata.c
@@ -0,0 +1,1257 @@
...
new file mode 100644
index 000000000000..b748c9c17625
--- /dev/null
+++ b/fs/erofs/zdata.h
@@ -0,0 +1,192 @@
+/* SPDX-License-Identifier: GPL-2.0-only */
...
+ *
+ * A: Field accessed / updated in atomic for parallelized code.
+ */
...
index 8cd55c33f50b..d887ea6d4fd5 100644
--- a/fs/erofs/zmap.c
+++ b/fs/erofs/zmap.c
