...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C1567520B1
	for <lists+linux-erofs@lfdr.de>; Thu, 13 Jul 2023 14:00:44 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4R1tV20HZjz3c49
	for <lists+linux-erofs@lfdr.de>; Thu, 13 Jul 2023 22:00:42 +1000 (AEST)
...
Received: from out30-98.freemail.mail.aliyun.com (out30-98.freemail.mail.aliyun.com [115.124.30.98])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4R1tTq5sZ9z3c3M
	for <linux-erofs@lists.ozlabs.org>; Thu, 13 Jul 2023 22:00:30 +1000 (AEST)
X-Alimail-AntiSpam: AC=PASS;BC=-1|-1;BR=01201311R101e4;CH=green;DM=||false|;DS=||;FP=0|-1|-1|-1|0|-1|-1|-1;HT=ay29a033018046050;MF=jefflexu@linux.alibaba.com;NM=1;PH=DS;RN=5;SR=0;TI=SMTPD_---0VnHh9zr_1689249617;
Received: from localhost(mailfrom:jefflexu@linux.alibaba.com fp:SMTPD_---0VnHh9zr_1689249617)
          by smtp.aliyun-inc.com;
          Thu, 13 Jul 2023 20:00:18 +0800
...
To: hsiangkao@linux.alibaba.com,
	...
	xiang@kernel.org
Subject: [PATCH v2 2/2] erofs-utils: introduce tarerofs
Date: Thu, 13 Jul 2023 20:00:15 +0800
Message-Id: <20230713120015.93308-3-jefflexu@linux.alibaba.com>
...
---
 ...
 lib/xattr.c               |  46 ++-
 mkfs/main.c               | 134 +++++---
 12 files changed, 1185 insertions(+), 106 deletions(-)
 create mode 100644 include/erofs/tar.h
 create mode 100644 lib/tar.c

diff --git a/configure.ac b/configure.ac
index f2f3e9d..c08aadf 100644
--- a/configure.ac
+++ b/configure.ac
...
+			ret = 0;
 		...
 		if (ret)
 			return ret;
@@ -1285,3 +1305,83 @@ struct erofs_inode *erofs_mkfs_build_special_from_fd(int fd, const char *name)
