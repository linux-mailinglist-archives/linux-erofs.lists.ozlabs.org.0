Return-Path: <linux-erofs+bounces-1795-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
X-Original-To: lists+linux-erofs@lfdr.de
Delivered-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 214A5D08A54
	for <lists+linux-erofs@lfdr.de>; Fri, 09 Jan 2026 11:42:11 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4dndcd5xpqz2yFm;
...
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1767955313;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1767955313; c=relaxed/relaxed;
	bh=7pikTZugNF/V3vO0YMHJ1oiGpBgzlFUtX8+2mSyQzQg=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=
ARC-Authentication-Results: i=1; lists.ozlabs.org; dmarc=pass (p=quarantine dis=none) header.from=huawei.com; dkim=pass (1024-bit key; unprotected) header.d=huawei.com header.i=@huawei.com header.a=rsa-sha256 header.s=dkim header.b=VWxbISDP; dkim-atps=neutral; spf=pass (client-ip=113.46.200.216; helo=canpmsgout01.his.huawei.com; envelope-from=lihongbo22@huawei.com; receiver=lists.ozlabs.org) smtp.mailfrom=huawei.com
Authentication-Results: lists.ozlabs.org; dmarc=pass (p=quarantine dis=none) header.from=huawei.com
Authentication-Results: lists.ozlabs.org;
	dkim=pass (1024-bit key; unprotected) header.d=huawei.com header.i=@huawei.com header.a=rsa-sha256 header.s=dkim header.b=VWxbISDP;
	dkim-atps=neutral
...
Received: from canpmsgout01.his.huawei.com (canpmsgout01.his.huawei.com [113.46.200.216])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4dndcW59FPz2yFq
	for <linux-erofs@lists.ozlabs.org>; Fri, 09 Jan 2026 21:41:47 +1100 (AEDT)
dkim-signature: v=1; a=rsa-sha256; d=huawei.com; s=dkim;
	c=relaxed/relaxed; q=dns/txt;
	h=From;
	bh=7pikTZugNF/V3vO0YMHJ1oiGpBgzlFUtX8+2mSyQzQg=;
	b=VWxbISDPf8CDhwfb+Xu/45ttTsMF63xVx8HnP7nlBn1ie/zQNN6kQRH5BjnoOV4B5oFPx0Shn
	MBjWdymKSNl+ZHslcYvCurI/e3o4fCGpfYjXgZperOxwK1LYaINDFeIRgnQTeTAdkFwO+ALhavg
	uJjel5GcTdlfYbWnaG3vRhk=
Received: from mail.maildlp.com (unknown [172.19.162.223])
	by canpmsgout01.his.huawei.com (SkyGuard) with ESMTPS id 4dndX52HsXz1T4Fd;
	Fri,  9 Jan 2026 18:37:57 +0800 (CST)
Received: from kwepemr500015.china.huawei.com (unknown [7.202.195.162])
	by mail.maildlp.com (Postfix) with ESMTPS id 3529040569;
...
Subject: [PATCH v14 07/10] erofs: introduce the page cache share feature
Date: Fri, 9 Jan 2026 10:28:53 +0000
Message-ID: <20260109102856.598531-8-lihongbo22@huawei.com>
...
index ae61f20cb861..f356764989a6 100644
--- a/fs/erofs/xattr.c
+++ b/fs/erofs/xattr.c
@@ -577,3 +577,35 @@ struct posix_acl *erofs_get_acl(struct inode *inode, int type, bool rcu)
 	return acl;
 }
 #endif
+
