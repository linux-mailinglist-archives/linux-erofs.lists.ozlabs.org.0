Return-Path: <linux-erofs+bounces-3374-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-erofs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id gMhqKRen+GnQxQIAu9opvQ
	(envelope-from <linux-erofs+bounces-3374-lists+linux-erofs=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-erofs@lfdr.de>; Mon, 04 May 2026 16:03:03 +0200
X-Original-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:21b9:f100::1])
	by mail.lfdr.de (Postfix) with ESMTPS id CBAA44BE69C
	for <lists+linux-erofs@lfdr.de>; Mon, 04 May 2026 16:03:02 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4g8Ndc4Z8wz2yZ3;
	Tue, 05 May 2026 00:03:00 +1000 (AEST)
X-Original-To: linux-erofs@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; arc=none smtp.remote-ip=172.234.252.31
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1777903380;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1777903380; c=relaxed/relaxed;
	bh=qed7wDOsYy+hMF+YVINbLo5HOlC2CmVNxRhFqeEWndw=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=
...
Authentication-Results: lists.ozlabs.org;
	dkim=pass (1024-bit key; unprotected) header.d=linuxfoundation.org header.i=@linuxfoundation.org header.a=rsa-sha256 header.s=korg header.b=dRAetAll;
	dkim-atps=neutral
...
Received: from sea.source.kernel.org (sea.source.kernel.org [172.234.252.31])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4g8Ndb5cvzz2xS2
	for <linux-erofs@lists.ozlabs.org>; Tue, 05 May 2026 00:02:59 +1000 (AEST)
Received: from smtp.kernel.org (transwarp.subspace.kernel.org [100.75.92.58])
	by sea.source.kernel.org (Postfix) with ESMTP id B46FD43F68;
...
X-Spamd-Result: default: False [-1.70 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-3374-lists,linux-erofs=lfdr.de];
	...
	TO_DN_SOME(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[linuxfoundation.org:email,linuxfoundation.org:dkim,linuxfoundation.org:mid,hallyn.com:email,ozlabs.org:email,lists.ozlabs.org:helo,lists.ozlabs.org:rdns]
