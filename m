Return-Path: <linux-erofs+bounces-1231-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
X-Original-To: lists+linux-erofs@lfdr.de
Delivered-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id 514B7BE8FE8
	for <lists+linux-erofs@lfdr.de>; Fri, 17 Oct 2025 15:48:37 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4cp5kp6nnWz3cYR;
	Sat, 18 Oct 2025 00:48:34 +1100 (AEDT)
X-Original-To: linux-erofs@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; arc=none smtp.remote-ip=172.105.4.254
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1760708914;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1760708914; c=relaxed/relaxed;
	bh=9rW2Q0Blw7Adku9sXTiD9ouZyVSq86OMut3vIa3kXvw=;
	h=Subject:To:Cc:From:Date:In-Reply-To:Message-ID:MIME-Version:
	 Content-Type; b=
ARC-Authentication-Results: i=1; lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=linuxfoundation.org; dkim=fail (1024-bit key; unprotected) header.d=linuxfoundation.org header.i=@linuxfoundation.org header.a=rsa-sha256 header.s=korg header.b=geDc2iCZ reason="signature verification failed"; dkim-atps=neutral; spf=pass (client-ip=172.105.4.254; helo=tor.source.kernel.org; envelope-from=gregkh@linuxfoundation.org; receiver=lists.ozlabs.org) smtp.mailfrom=linuxfoundation.org
Authentication-Results: lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=linuxfoundation.org
Authentication-Results: lists.ozlabs.org;
	dkim=fail reason="signature verification failed" (1024-bit key; unprotected) header.d=linuxfoundation.org header.i=@linuxfoundation.org header.a=rsa-sha256 header.s=korg header.b=geDc2iCZ;
	dkim-atps=neutral
...
Received: from tor.source.kernel.org (tor.source.kernel.org [172.105.4.254])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4cp5kp0Pz8z3bpS
	for <linux-erofs@lists.ozlabs.org>; Sat, 18 Oct 2025 00:48:33 +1100 (AEDT)
...
Subject: Patch "btrfs: remove duplicated in_range() macro" has been added to the 5.10-stable tree
To: David.Laight@ACULAB.COM, Jason@zx2c4.com,
	...
	johan@lists.ozlabs.org, nes.thumshirn@wdc.com, josef@toxicpanda.com,
	...
	sakari.ailus@linux.intel.com, sashal@kerne, l.org@lists.ozlabs.org,
