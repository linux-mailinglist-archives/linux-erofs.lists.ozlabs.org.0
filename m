Return-Path: <linux-erofs+bounces-2663-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-erofs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 6DEhFYE0sWl9sQIAu9opvQ
	(envelope-from <linux-erofs+bounces-2663-lists+linux-erofs=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-erofs@lfdr.de>; Wed, 11 Mar 2026 10:23:13 +0100
X-Original-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 8CFAF260465
	for <lists+linux-erofs@lfdr.de>; Wed, 11 Mar 2026 10:23:12 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4fW4zf0Hqmz3cNN;
	Wed, 11 Mar 2026 20:23:10 +1100 (AEDT)
X-Original-To: linux-erofs@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; arc=pass smtp.remote-ip=198.175.65.9 arc.chain=microsoft.com
ARC-Seal: i=2; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1773220990;
	cv=pass; b=
ARC-Message-Signature: i=2; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1773220990; c=relaxed/relaxed;
	bh=NB2nBRc43fDX8zlDL4NBYU+3M2DIhtkp5vKO6YL+b6M=;
	h=From:To:CC:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=
ARC-Authentication-Results: i=2; lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=intel.com; dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.a=rsa-sha256 header.s=Intel header.b=UduVW3ts; dkim-atps=neutral; spf=pass (client-ip=198.175.65.9; helo=mgamail.intel.com; envelope-from=aleksandr.loktionov@intel.com; receiver=lists.ozlabs.org) smtp.mailfrom=intel.com
Authentication-Results: lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.a=rsa-sha256 header.s=Intel header.b=UduVW3ts;
	dkim-atps=neutral
...
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4fW4zc6Qbyz3cND
	for <linux-erofs@lists.ozlabs.org>; Wed, 11 Mar 2026 20:23:08 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=UduVW3tsHSyvwKSkREmdbxdrutVoweuJFDtbgy8IFSwRdI6HyrjSrC+r
   ...
   n4Qz8xfrCcRMhGugzrDgQlbCWQtLSQFwkC8DocFnoyk1JG1oCnH14Bwxg
   A==;
X-CSE-ConnectionGUID: LrVS4K48SUG9uTKUEZEO9Q==
X-CSE-MsgGUID: 85ZTXsntT7yMAy/JKoBi3Q==
X-IronPort-AV: E=McAfee;i="6800,10657,11725"; a="96899297"
X-IronPort-AV: E=Sophos;i="6.23,113,1770624000"; 
   d="scan'208";a="96899297"
...
X-Spamd-Result: default: False [0.40 / 15.00];
	...
	TO_DN_SOME(0.00)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-2663-lists,linux-erofs=lfdr.de];
