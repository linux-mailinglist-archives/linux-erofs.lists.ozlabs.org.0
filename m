...
Received: from lists.ozlabs.org (lists.ozlabs.org [203.11.71.2])
	by mail.lfdr.de (Postfix) with ESMTPS id 3EB127F803
	for <lists+linux-erofs@lfdr.de>; Fri,  2 Aug 2019 15:12:30 +0200 (CEST)
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by lists.ozlabs.org (Postfix) with ESMTP id 460SHv5PjSzDrDY
	for <lists+linux-erofs@lfdr.de>; Fri,  2 Aug 2019 23:12:27 +1000 (AEST)
...
Received: from huawei.com (szxga04-in.huawei.com [45.249.212.190])
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 460Rvc19wQzDq9k
 for <linux-erofs@lists.ozlabs.org>; Fri,  2 Aug 2019 22:54:51 +1000 (AEST)
Received: from DGGEMS403-HUB.china.huawei.com (unknown [172.30.72.58])
 by Forcepoint Email with ESMTP id D82028FA4E19EA8E0C8B;
...
Subject: [PATCH v6 22/24] erofs: introduce the decompression frontend
Date: Fri, 2 Aug 2019 20:53:45 +0800
Message-ID: <20190802125347.166018-23-gaoxiang25@huawei.com>
...
index 1a322304560f..a492744435d4 100644
...
+
 	...
 	u32 blocks;
@@ -328,6 +331,9 @@ static inline bool is_inode_flat_inline(struct inode *inode)
...
@@ -488,7 +494,7 @@ int erofs_namei(struct inode *dir, struct qstr *name,
 /* dir.c */
...
@@ -512,16 +518,20 @@ struct erofs_workgroup *erofs_find_workgroup(struct super_block *sb,
