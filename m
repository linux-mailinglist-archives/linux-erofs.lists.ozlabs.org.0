Return-Path: <linux-erofs+bounces-3549-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-erofs@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id M1+PFcHYJmr1lgIAu9opvQ
	(envelope-from <linux-erofs+bounces-3549-lists+linux-erofs=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-erofs@lfdr.de>; Mon, 08 Jun 2026 16:59:13 +0200
X-Original-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 241FA657BA6
	for <lists+linux-erofs@lfdr.de>; Mon, 08 Jun 2026 16:59:12 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=redhat.com header.s=mimecast20190719 header.b="MzkxWSp/";
	dkim=pass header.d=redhat.com header.s=mimecast20190719 header.b="MzkxWSp/";
	spf=pass (mail.lfdr.de: domain of "linux-erofs+bounces-3549-lists+linux-erofs=lfdr.de@lists.ozlabs.org" designates 112.213.38.117 as permitted sender) smtp.mailfrom="linux-erofs+bounces-3549-lists+linux-erofs=lfdr.de@lists.ozlabs.org";
	dmarc=pass (policy=quarantine) header.from=redhat.com;
	arc=pass ("lists.ozlabs.org:s=201707:i=1")
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4gYw9x5P8Gz3btt;
	Tue, 09 Jun 2026 00:57:09 +1000 (AEST)
X-Original-To: linux-erofs@lists.ozlabs.org
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1780930629;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1780930629; c=relaxed/relaxed;
	bh=jEMuM2VPHw4Gs2EZmnfmTGnAa/DZiZx/YfeNf4uIZVs=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:content-type; b=
ARC-Authentication-Results: i=1; lists.ozlabs.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=MzkxWSp/; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=MzkxWSp/; dkim-atps=neutral; spf=pass (client-ip=170.10.133.124; helo=us-smtp-delivery-124.mimecast.com; envelope-from=dhowells@redhat.com; receiver=lists.ozlabs.org) smtp.mailfrom=redhat.com
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange x25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lists.ozlabs.org (Postfix) with ESMTPS id 4gYw9t2YXwz2yRM
	for <linux-erofs@lists.ozlabs.org>; Tue, 09 Jun 2026 00:57:06 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	bh=jEMuM2VPHw4Gs2EZmnfmTGnAa/DZiZx/YfeNf4uIZVs=;
	b=MzkxWSp/gd3oPn1XpIa6OCF/TzDTwdCkD76GL4GMsnMbt6j1FR9lxz0UW75AC4NkFLI871
	oU6RD6GSUh7mYQZFUHhA+XS3sMjQmTbotBpqeBwEKKe7gp9pAyMz7NAkmhTC67UGBR0g8m
	opIvAN8gGfNDp5b1EvZIxStH0ydWqoo=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1780930623;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
...
Received: from mx-prod-mc-06.mail-002.prod.us-west-2.aws.redhat.com
 ...
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-692-tL7mphkuOz-D2JtIQcKc9w-1; Mon,
 08 Jun 2026 10:56:49 -0400
X-MC-Unique: tL7mphkuOz-D2JtIQcKc9w-1
X-Mimecast-MFC-AGG-ID: tL7mphkuOz-D2JtIQcKc9w_1780930606
Received: from mx-prod-int-10.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-10.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.95])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-06.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 9535D18005A1;
	Mon,  8 Jun 2026 14:56:46 +0000 (UTC)
Received: from warthog.procyon.org.com (unknown [10.44.32.43])
	by mx-prod-int-10.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id 7707A175F;
...
Subject: [PATCH v3 14/22] netfs: Switch to using bvecq rather than folio_queue and rolling_buffer
Date: Mon,  8 Jun 2026 15:54:22 +0100
Message-ID: <20260608145432.681865-15-dhowells@redhat.com>
...
X-Mimecast-MFC-PROC-ID: rlmOYyqX61ymy1mZRn435bGnbd8nAN_9Xu7lZlRgE_A_1780930606
...
X-Spamd-Result: default: False [-1.20 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-3549-lists,linux-erofs=lfdr.de];
...
+	unsigned int off = 0, slot = 0;
 	...
 	size_t part;
@@ -500,32 +508,41 @@ static int netfs_read_gaps(struct file *file, struct folio *folio)
...
+
 	...
 	netfs_read_to_pagecache(rreq);
@@ -542,13 +559,14 @@ static int netfs_read_gaps(struct file *file, struct folio *folio)
...
+		put_page(sink);
 ...
 alloc_error:
 	folio_unlock(folio);
@@ -599,7 +617,7 @@ int netfs_read_folio(struct file *file, struct folio *folio)
...
@@ -821,7 +839,7 @@ int netfs_prefetch_for_write(struct file *file, struct folio *folio,
...
-		ssize_t slice;
 		...
 		if (!subreq) {
@@ -79,16 +56,24 @@ static void netfs_dispatch_unbuffered_reads(struct netfs_io_request *rreq)
 			}
 		}
...
@@ -103,6 +88,8 @@ static void netfs_dispatch_unbuffered_reads(struct netfs_io_request *rreq)
 		set_bit(NETFS_RREQ_ALL_QUEUED, &rreq->flags);
...
+	bvecq_pos_unset(&rreq->dispatch_cursor);
 ...
 /*
@@ -181,25 +168,17 @@ ssize_t netfs_unbuffered_read_iter_locked(struct kiocb *iocb, struct iov_iter *i
...
@@ -138,6 +140,7 @@ ssize_t netfs_extract_iter(struct iov_iter *orig, size_t max_len, size_t max_pag
 }
...
@@ -131,16 +126,29 @@ static void netfs_read_unlock_folios(struct netfs_io_request *rreq,
 		unsigned int order;
 		size_t fsize;
...
@@ -152,33 +160,19 @@ static void netfs_read_unlock_folios(struct netfs_io_request *rreq,
...
+	rreq->collect_cursor.slot = slot;
 ...
 /*
@@ -355,12 +349,17 @@ static void netfs_rreq_assess_dio(struct netfs_io_request *rreq)
...
@@ -451,7 +450,15 @@ bool netfs_read_collection(struct netfs_io_request *rreq)
...
@@ -130,20 +130,27 @@ static void netfs_writeback_unlock_folios(struct netfs_io_request *wreq,
 		return;
 	}
...
@@ -166,26 +173,13 @@ static void netfs_writeback_unlock_folios(struct netfs_io_request *wreq,
...
+	wreq->collect_cursor.slot = slot;
 ...
 /*
@@ -230,7 +224,8 @@ static void netfs_collect_write_results(struct netfs_io_request *wreq)
...
@@ -256,15 +243,15 @@ static void netfs_do_issue_write(struct netfs_io_stream *stream,
 }
...
@@ -320,7 +366,6 @@ size_t netfs_advance_write(struct netfs_io_request *wreq,
...
@@ -344,7 +389,8 @@ static int netfs_write_folio(struct netfs_io_request *wreq,
 	struct netfs_io_stream *stream;
...
@@ -352,8 +398,13 @@ static int netfs_write_folio(struct netfs_io_request *wreq,
...
@@ -453,8 +504,32 @@ static int netfs_write_folio(struct netfs_io_request *wreq,
...
@@ -463,9 +538,11 @@ static int netfs_write_folio(struct netfs_io_request *wreq,
...
@@ -500,15 +577,11 @@ static int netfs_write_folio(struct netfs_io_request *wreq,
 			break;
...
@@ -519,9 +592,9 @@ static int netfs_write_folio(struct netfs_io_request *wreq,
 			debug = true;
 	}
...
+	netfs_put_failed_request(wreq);
 ...
 out:
@@ -645,6 +728,15 @@ struct netfs_io_request *netfs_begin_writethrough(struct kiocb *iocb, size_t len
 		return wreq;
 	}
...
+
 	...
 	return wreq;
@@ -662,8 +754,8 @@ int netfs_advance_writethrough(struct netfs_io_request *wreq, struct writeback_c
 {
 	int ret;
...
@@ -719,6 +811,9 @@ ssize_t netfs_end_writethrough(struct netfs_io_request *wreq, struct writeback_c
...
@@ -734,10 +829,11 @@ ssize_t netfs_end_writethrough(struct netfs_io_request *wreq, struct writeback_c
  * @iter: Data to write.
  *
...
@@ -763,10 +859,18 @@ int netfs_writeback_single(struct address_space *mapping,
 		ret = PTR_ERR(wreq);
 		goto couldnt_start;
 	}
-
...
+
 	...
 	netfs_stat(&netfs_n_wh_writepages);
@@ -786,11 +890,11 @@ int netfs_writeback_single(struct address_space *mapping,
 		subreq = stream->construct;
 		subreq->len = wreq->len;
...
@@ -806,6 +910,8 @@ int netfs_writeback_single(struct address_space *mapping,
 	_leave(" = %d", ret);
 	return ret;
