...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id 62AF041AA7D
	for <lists+linux-erofs@lfdr.de>; Tue, 28 Sep 2021 10:16:43 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4HJXQx1n3Hz2yPd
	for <lists+linux-erofs@lfdr.de>; Tue, 28 Sep 2021 18:16:41 +1000 (AEST)
...
Received: from out30-54.freemail.mail.aliyun.com
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 4HJXQq2msxz2xtS
 for <linux-erofs@lists.ozlabs.org>; Tue, 28 Sep 2021 18:16:30 +1000 (AEST)
X-Alimail-AntiSpam: AC=PASS; BC=-1|-1; BR=01201311R781e4; CH=green; DM=||false|;
 ...
 NM=1; PH=DS; RN=10; SR=0; TI=SMTPD_---0Upuy5xd_1632816969; 
Received: from
 e18g09479.et15sqa.tbsite.net(mailfrom:hsiangkao@linux.alibaba.com
 fp:SMTPD_---0Upuy5xd_1632816969) by smtp.aliyun-inc.com(127.0.0.1);
 Tue, 28 Sep 2021 16:16:21 +0800
From: Gao Xiang <hsiangkao@linux.alibaba.com>
To: linux-erofs@lists.ozlabs.org, Chao Yu <chao@kernel.org>,
 Liu Bo <bo.liu@linux.alibaba.com>
Subject: [RFC PATCH] erofs: add multiple device support
Date: Tue, 28 Sep 2021 16:16:08 +0800
Message-Id: <20210928081608.9255-1-hsiangkao@linux.alibaba.com>
...
---
 ...
 fs/erofs/zdata.c                    |  20 +++--
 6 files changed, 252 insertions(+), 33 deletions(-)
...
index 9db829715652..688a7e5421c0 100644
--- a/fs/erofs/data.c
+++ b/fs/erofs/data.c
...
+	map->m_deviceid = 0;
 	if (map->m_la >= inode->i_size) {
 		...
 		map->m_flags = 0;
@@ -135,14 +136,7 @@ static int erofs_map_blocks(struct inode *inode,
 		map->m_flags = 0;
 		break;
 	default:
...
-			goto out_unlock;
-		}
+		map->m_deviceid = idx->device_id & EROFS_SB(sb)->device_id_mask;
 		map->m_pa = blknr_to_addr(le32_to_cpu(idx->blkaddr));
 		map->m_flags = EROFS_MAP_MAPPED;
 		break;
@@ -155,11 +149,55 @@ static int erofs_map_blocks(struct inode *inode,
 	return err;
 }
...
+	struct erofs_map_dev mdev;
 	...
 	map.m_la = offset;
 	map.m_llen = length;
@@ -168,8 +206,16 @@ static int erofs_iomap_begin(struct inode *inode, loff_t offset, loff_t length,
 	if (ret < 0)
 		return ret;
...
+	iomap->dax_dev = mdev.m_daxdev;
 	...
 	iomap->flags = 0;
@@ -188,15 +234,15 @@ static int erofs_iomap_begin(struct inode *inode, loff_t offset, loff_t length,
