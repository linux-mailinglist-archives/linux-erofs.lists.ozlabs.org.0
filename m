Return-Path: <linux-erofs+bounces-2682-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-erofs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id gDRDAwXmsmktQwAAu9opvQ
	(envelope-from <linux-erofs+bounces-2682-lists+linux-erofs=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-erofs@lfdr.de>; Thu, 12 Mar 2026 17:12:53 +0100
X-Original-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:21b9:f100::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 057672754D3
	for <lists+linux-erofs@lfdr.de>; Thu, 12 Mar 2026 17:12:51 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4fWt1s0thxz3cGS;
	Fri, 13 Mar 2026 03:12:49 +1100 (AEDT)
X-Original-To: linux-erofs@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; arc=fail smtp.remote-ip=198.175.65.12
ARC-Seal: i=2; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1773331969;
	cv=fail; b=
ARC-Message-Signature: i=2; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1773331969; c=relaxed/relaxed;
	bh=S2r3mEx4jaS69b6pg4TeplPYQyNYaMq5f3Q1pXlTbJ4=;
	h=Message-ID:Date:Subject:To:CC:References:From:In-Reply-To:
	 Content-Type:MIME-Version; b=
ARC-Authentication-Results: i=2; lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=intel.com; dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.a=rsa-sha256 header.s=Intel header.b=AXQuzy3P; dkim-atps=neutral; spf=pass (client-ip=198.175.65.12; helo=mgamail.intel.com; envelope-from=przemyslaw.kitszel@intel.com; receiver=lists.ozlabs.org) smtp.mailfrom=intel.com
Authentication-Results: lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.a=rsa-sha256 header.s=Intel header.b=AXQuzy3P;
	dkim-atps=neutral
Authentication-Results: lists.ozlabs.org; spf=pass (sender SPF authorized) smtp.mailfrom=intel.com (client-ip=198.175.65.12; helo=mgamail.intel.com; envelope-from=przemyslaw.kitszel@intel.com; receiver=lists.ozlabs.org)
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by lists.ozlabs.org (Postfix) with ESMTPS id 4fWt1p12m8z3cGM
	for <linux-erofs@lists.ozlabs.org>; Fri, 13 Mar 2026 03:12:44 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1773331967; x=1804867967;
  h=message-id:date:subject:to:cc:references:from:
   in-reply-to:content-transfer-encoding:mime-version;
  bh=5bFRno/x5CuND9g6xv0lanCw5CYbDU9w0cEWHBHlDpc=;
  b=AXQuzy3PrApEH44IGZOVG2a94mzRBdtnkLffv9ZAWQAvtlK6ZS2+J6IS
   /m9FLCPLYzXydJVZxczSN1IClldIoX5osHRkgd1y624oo+zLSqC9rJeJr
   UCVWK1LpKz1rY4KPjnwgZGIuOKkdxMNgZkqlA93sU3NHY2uKR6TzT5unz
   V2++swmCP1Nn8Bl8lTqzkrFsShPWyEwi26ihOIj8vYW/8g67Ss/w+6WsO
   v0x/SOMC6tmf8kQypB5iUO/JrIfZCL+PhadiabXqTV2cy1uFpCyfR5fJQ
   XagJ8DhuM2UwU7G4QptC/iV3dO8AS91ME/OC2xLw299oXsF6mlJJ7bKL3
   Q==;
X-CSE-ConnectionGUID: EoLHeSVHS+6DtS9vZDCQKQ==
X-CSE-MsgGUID: kkREnjieSPqfuKmZVQeDsw==
X-IronPort-AV: E=McAfee;i="6800,10657,11727"; a="85910046"
X-IronPort-AV: E=Sophos;i="6.23,116,1770624000"; 
   d="scan'208";a="85910046"
...
X-Spamd-Result: default: False [1.30 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-2682-lists,linux-erofs=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
 ...
 ecomputing.com,m:quan@os.amperecomputing.com,m:hkallweit1@gmail.com,m:linux@armlinux.org.uk,s:lists@lfdr.de];
	...
	FROM_NEQ_ENVFROM(0.00)[przemyslaw.kitszel@intel.com,linux-erofs@lists.ozlabs.org];
