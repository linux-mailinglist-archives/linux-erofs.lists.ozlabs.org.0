...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id B8FDF885931
	for <lists+linux-erofs@lfdr.de>; Thu, 21 Mar 2024 13:35:45 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4V0lL746Jhz3dTs
	for <lists+linux-erofs@lfdr.de>; Thu, 21 Mar 2024 23:35:43 +1100 (AEDT)
...
Received: from smtp232.sjtu.edu.cn (smtp232.sjtu.edu.cn [202.120.2.232])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4V0lL50813z3cGK
	for <linux-erofs@lists.ozlabs.org>; Thu, 21 Mar 2024 23:35:41 +1100 (AEDT)
Received: from proxy188.sjtu.edu.cn (smtp188.sjtu.edu.cn [202.120.2.188])
	by smtp232.sjtu.edu.cn (Postfix) with ESMTPS id E91671008DCAA;
	Thu, 21 Mar 2024 20:35:01 +0800 (CST)
Received: from [127.0.0.1] (unknown [10.181.28.55])
	by proxy188.sjtu.edu.cn (Postfix) with ESMTPSA id 1898037C955;
	Thu, 21 Mar 2024 20:35:00 +0800 (CST)
Message-ID: <23876465-6af3-4d48-8313-fb709017ca32@sjtu.edu.cn>
Date: Thu, 21 Mar 2024 20:34:59 +0800
MIME-Version: 1.0
...
In-Reply-To: <e17b503f-fec6-44dd-aad2-79cde777b51e@linux.alibaba.com>
...
>>> @@ -90,6 +90,14 @@ static inline void list_splice_tail(struct 
>>> list_head *list,
>>>           __list_splice(list, head->prev, head);
>>>   }
>>> +static inline void list_replace(struct list_head *old, struct 
>>> list_head *new)
>>> +{
>>> +    new->next = old->next;
>>> +    new->next->prev = new;
...
>>> @@ -1022,6 +1024,90 @@ int z_erofs_compress_segment(struct 
...
>>> +        erofs_droid_blocklist_write(inode, blkaddr, 
>>> compressed_blocks);
>>> +    return 0;
>>> +}
>>> +
...
>>>       if (!_dir) {
>>> @@ -1195,13 +1262,15 @@ static int erofs_mkfs_handle_dir(struct 
>>> erofs_inode *dir,
>>>       if (ret)
>>>           return ret;
...
>>> @@ -1286,7 +1355,7 @@ static void erofs_mkfs_dumpdir(struct 
>>> erofs_inode *dumpdir)
>>>   }
