Return-Path: <linux-erofs+bounces-2348-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-erofs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id mB+tGBTKm2kJ7AMAu9opvQ
	(envelope-from <linux-erofs+bounces-2348-lists+linux-erofs=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-erofs@lfdr.de>; Mon, 23 Feb 2026 04:31:32 +0100
X-Original-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:21b9:f100::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 6BBFC1718E2
	for <lists+linux-erofs@lfdr.de>; Mon, 23 Feb 2026 04:31:31 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4fK5x75zDsz30hq;
	Mon, 23 Feb 2026 14:31:23 +1100 (AEDT)
X-Original-To: linux-erofs@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; arc=pass smtp.remote-ip="2a01:111:f403:c111::9" arc.chain=microsoft.com
ARC-Seal: i=2; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1771817483;
	cv=pass; b=
ARC-Message-Signature: i=2; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1771817483; c=relaxed/relaxed;
	bh=BsArd5uquRUyqTx7lIbuF9jvLkAvbJbODCSdF0bRXUE=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 Content-Type:MIME-Version; b=
...
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=Nvidia.com header.i=@Nvidia.com header.a=rsa-sha256 header.s=selector2 header.b=WMDN9Oxf;
	dkim-atps=neutral
...
Received: from DM5PR21CU001.outbound.protection.outlook.com (mail-centralusazlp170110009.outbound.protection.outlook.com [IPv6:2a01:111:f403:c111::9])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4fK5x70whdz2xlv
	for <linux-erofs@lists.ozlabs.org>; Mon, 23 Feb 2026 14:31:22 +1100 (AEDT)
...
X-Microsoft-Antispam-Message-Info:
	=?us-ascii?Q?62Qpt6n9o48iMFWu3/5p0/I0uBXVXq1tojUzEll/ry6DYCR0dNJMQlNvGUp2?=
...
X-MS-Exchange-AntiSpam-MessageData-0:
	=?us-ascii?Q?10db90MjHGbI/MCJGWBPUpXodXhKF3VPMbjQolUrghnP/8dsNyJ1hiAb4I75?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 23 Feb 2026 03:30:58.8653
 (UTC)
...
X-Spamd-Result: default: False [-0.70 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	TAGGED_FROM(0.00)[bounces-2348-lists,linux-erofs=lfdr.de];
	FORWARDED(0.00)[linux-erofs@lists.ozlabs.org];
	FORGED_SENDER(0.00)[ziy@nvidia.com,linux-erofs@lists.ozlabs.org];
	FORGED_SENDER_MAILLIST(0.00)[];
	RCVD_TLS_LAST(0.00)[];
	FORGED_RECIPIENTS(0.00)[m:linux-mm@kvack.org,m:david@kernel.org,m:akpm@linux-foundation.org,m:linux-erofs@lists.ozlabs.org,m:linux-block@vger.kernel.org,m:dri-devel@lists.freedesktop.org,m:linux-kernel@vger.kernel.org,m:ziy@nvidia.com,m:kernelxing@tencent.com,m:katrinzhou@tencent.com,m:mhiramat@kernel.org,s:lists@lfdr.de];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[Nvidia.com:dkim,nvidia.com:mid,nvidia.com:email,tencent.com:email]
X-Rspamd-Queue-Id: 6BBFC1718E2
