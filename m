...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id 420397646FD
	for <lists+linux-erofs@lfdr.de>; Thu, 27 Jul 2023 08:39:09 +0200 (CEST)
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.a=rsa-sha256 header.s=20221208 header.b=cE3RJwN5;
	dkim-atps=neutral
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4RBLhT5L0Yz3c18
	for <lists+linux-erofs@lfdr.de>; Thu, 27 Jul 2023 16:39:05 +1000 (AEST)
...
Received: from mail-pf1-x42b.google.com (mail-pf1-x42b.google.com [IPv6:2607:f8b0:4864:20::42b])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4RBLhM3Wfcz30P3
	for <linux-erofs@lists.ozlabs.org>; Thu, 27 Jul 2023 16:38:58 +1000 (AEST)
Received: by mail-pf1-x42b.google.com with SMTP id d2e1a72fcca58-686bc261111so498802b3a.3
        for <linux-erofs@lists.ozlabs.org>; Wed, 26 Jul 2023 23:38:58 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20221208; t=1690439936; x=1691044736;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:subject:cc:to:from:date:from:to:cc:subject:date
         :message-id:reply-to;
        bh=irB7g55+Nn3S8qYyD5/mvrc2vHqu+c9cTiPbne6l9Ow=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1690439936; x=1691044736;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:subject:cc:to:from:date:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=irB7g55+Nn3S8qYyD5/mvrc2vHqu+c9cTiPbne6l9Ow=;
        b=
X-Gm-Message-State: ABy/qLbjFOaE8TJ6n0c+MGEAISYkQ41/Ra4XdULHTtrge/vjK8elKF0v
	a5D2WNvw0kUZJHQmczAGmnHDHTHIAHQ=
X-Google-Smtp-Source: APBJJlHSgzkxS3hVx0hAZMFI1urLwdqGxuq6xTBJf88wzWbIAwfLOItad3QVH4Jgwe1bBF4Z6yQBqQ==
X-Received: by 2002:a05:6a00:14c4:b0:668:74e9:8efb with SMTP id w4-20020a056a0014c400b0066874e98efbmr4571360pfu.8.1690439936091;
        Wed, 26 Jul 2023 23:38:56 -0700 (PDT)
Received: from localhost ([156.236.96.165])
        by smtp.gmail.com with ESMTPSA id y19-20020a63fa13000000b00563c1aa277asm635380pgh.6.2023.07.26.23.38.54
        (version=TLS1_2 cipher=ECDHE-ECDSA-CHACHA20-POLY1305 bits=256/256);
        Wed, 26 Jul 2023 23:38:55 -0700 (PDT)
Date: Thu, 27 Jul 2023 14:48:10 +0800
From: Yue Hu <zbestahu@gmail.com>
To: Li Yiyan <lyy0627@sjtu.edu.cn>
Subject: Re: [PATCH v3] erofs-utils: add support for fuse 2/3 lowlevel API
Message-ID: <20230727144810.00000b33.zbestahu@gmail.com>
In-Reply-To: <20230725121838.2197156-1-lyy0627@sjtu.edu.cn>
References: <20230725121838.2197156-1-lyy0627@sjtu.edu.cn>
...
On Tue, 25 Jul 2023 20:18:38 +0800
...
Now only lowlevel is used, so drop `ll` in naming?
...
Don't need the hint readdir and `\n` since erofs_dbg() can do this.
Some other similar uses need to be changed as well.
...
The debug message looks helpless, let's print protocol version instead like before?
...
Don't need to malloc/free for !S_ISREG case.
...
Why need to allocate memory even if the size passed in is 0?
