Return-Path: <linux-erofs+bounces-3618-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-erofs@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id VR+iN2QhMWrXcAUAu9opvQ
	(envelope-from <linux-erofs+bounces-3618-lists+linux-erofs=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-erofs@lfdr.de>; Tue, 16 Jun 2026 12:11:48 +0200
X-Original-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id CECC868E03C
	for <lists+linux-erofs@lfdr.de>; Tue, 16 Jun 2026 12:11:47 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=redhat.com header.s=mimecast20190719 header.b=Y+wVjfXU;
	dkim=pass header.d=redhat.com header.s=mimecast20190719 header.b=Y+wVjfXU;
	spf=pass (mail.lfdr.de: domain of "linux-erofs+bounces-3618-lists+linux-erofs=lfdr.de@lists.ozlabs.org" designates 112.213.38.117 as permitted sender) smtp.mailfrom="linux-erofs+bounces-3618-lists+linux-erofs=lfdr.de@lists.ozlabs.org";
	dmarc=pass (policy=quarantine) header.from=redhat.com;
	arc=pass ("lists.ozlabs.org:s=201707:i=1")
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4gfjSx4VHnz3brR;
	Tue, 16 Jun 2026 20:11:45 +1000 (AEST)
X-Original-To: linux-erofs@lists.ozlabs.org
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1781604705;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1781604705; c=relaxed/relaxed;
	bh=d8JC6+xSdc+Z886dqP+MZoDE2U4r3/5unmuCsM840Go=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:content-type; b=
ARC-Authentication-Results: i=1; lists.ozlabs.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=Y+wVjfXU; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=Y+wVjfXU; dkim-atps=neutral; spf=pass (client-ip=170.10.133.124; helo=us-smtp-delivery-124.mimecast.com; envelope-from=dhowells@redhat.com; receiver=lists.ozlabs.org) smtp.mailfrom=redhat.com
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange x25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lists.ozlabs.org (Postfix) with ESMTPS id 4gfjSt70l7z3brH
	for <linux-erofs@lists.ozlabs.org>; Tue, 16 Jun 2026 20:11:42 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1781604700;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=d8JC6+xSdc+Z886dqP+MZoDE2U4r3/5unmuCsM840Go=;
	b=Y+wVjfXUEgXUNsQgaZ23e//9G0Us0adJehdOr8rfNVLz1SGrnEOvI4Vrx2mTPG1sRB4jPK
	r20R7nP2kI7F/XpCe9faMb6sz+axtsaNENvVG7xGCXT4u+EZhOQi3IMPAfxDMg/G8+mMTk
	Axoam6BveSq2YRvDgHwvkYejZTC4d5k=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1781604700;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
...
Received: from mx-prod-mc-01.mail-002.prod.us-west-2.aws.redhat.com
 ...
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-588-5-HuWPLjNW66fghaIwjs6g-1; Tue,
 16 Jun 2026 06:11:34 -0400
X-MC-Unique: 5-HuWPLjNW66fghaIwjs6g-1
X-Mimecast-MFC-AGG-ID: 5-HuWPLjNW66fghaIwjs6g_1781604688
Received: from mx-prod-int-10.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-10.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.95])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-01.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 68AAA195DE09;
	Tue, 16 Jun 2026 10:11:26 +0000 (UTC)
Received: from warthog.procyon.org.com (unknown [10.44.50.44])
	by mx-prod-int-10.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id B3F56414;
	Tue, 16 Jun 2026 10:11:18 +0000 (UTC)
...
Subject: [PATCH v4 21/30] netfs: Switch to using bvecq rather than folio_queue and rolling_buffer
Date: Tue, 16 Jun 2026 11:08:10 +0100
Message-ID: <20260616100821.2062304-22-dhowells@redhat.com>
...
X-Mimecast-MFC-PROC-ID: xXiSo71Q37kNH4x2Gyj5KGW34apQYaBuu8dulb3IJVo_1781604688
...
X-Spamd-Result: default: False [-1.20 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-3618-lists,linux-erofs=lfdr.de];
	RCPT_COUNT_TWELVE(0.00)[24];
	MIME_TRACE(0.00)[0:+];
	FORWARDED(0.00)[linux-erofs@lists.ozlabs.org];
	FORGED_SENDER_MAILLIST(0.00)[];
	FORGED_SENDER(0.00)[dhowells@redhat.com,linux-erofs@lists.ozlabs.org];
	FORGED_RECIPIENTS(0.00)[m:christian@brauner.io,m:willy@infradead.org,m:hch@infradead.org,m:dhowells@redhat.com,m:pc@manguebit.org,m:axboe@kernel.dk,m:leon@kernel.org,m:sfrench@samba.org,m:chenxiaosong@chenxiaosong.com,m:marc.dionne@auristor.com,m:ericvh@kernel.org,m:asmadeus@codewreck.org,m:idryomov@gmail.com,m:netfs@lists.linux.dev,m:linux-afs@lists.infradead.org,m:linux-cifs@vger.kernel.org,m:linux-nfs@vger.kernel.org,m:ceph-devel@vger.kernel.org,m:v9fs@lists.linux.dev,m:linux-erofs@lists.ozlabs.org,m:linux-fsdevel@vger.kernel.org,m:linux-kernel@vger.kernel.org,m:sprasad@microsoft.com,m:tom@talpey.com,s:lists@lfdr.de];
	FROM_HAS_DN(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[samba.org:email,linux.dev:email,manguebit.org:email,infradead.org:email,lists.ozlabs.org:helo,lists.ozlabs.org:rdns,lists.ozlabs.org:from_smtp,talpey.com:email]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: CECC868E03C
...
index 146a2cf64af0..b29f18a8c223 100644
...
+		subreq->transferred = subreq->len;
 		...
 		subreq->transferred = subreq->len;
@@ -229,6 +229,11 @@ static void netfs_read_to_pagecache(struct netfs_io_request *rreq)
...
+
 	do {
 		...
 		struct netfs_io_subrequest *subreq;
@@ -376,6 +381,9 @@ static void netfs_read_to_pagecache(struct netfs_io_request *rreq)
...
@@ -471,11 +479,11 @@ static int netfs_read_gaps(struct file *file, struct folio *folio)
...
+	unsigned int off = 0, slot = 0;
 	...
 	size_t part;
@@ -500,32 +508,47 @@ static int netfs_read_gaps(struct file *file, struct folio *folio)
...
+
 	...
 	netfs_read_to_pagecache(rreq);
@@ -542,13 +565,14 @@ static int netfs_read_gaps(struct file *file, struct folio *folio)
...
+		put_page(sink);
 ...
 alloc_error:
 	folio_unlock(folio);
@@ -599,7 +623,7 @@ int netfs_read_folio(struct file *file, struct folio *folio)
...
@@ -756,7 +780,7 @@ int netfs_write_begin(struct netfs_inode *ctx,
...
@@ -821,7 +845,7 @@ int netfs_prefetch_for_write(struct file *file, struct folio *folio,
...
index 6a8fb0d55e04..1c1f622bbbe8 100644
...
-		ssize_t slice;
 		...
 		if (!subreq) {
@@ -79,16 +57,24 @@ static void netfs_dispatch_unbuffered_reads(struct netfs_io_request *rreq)
 			}
 		}
...
@@ -103,6 +89,8 @@ static void netfs_dispatch_unbuffered_reads(struct netfs_io_request *rreq)
 		set_bit(NETFS_RREQ_ALL_QUEUED, &rreq->flags);
...
+	bvecq_pos_unset(&rreq->dispatch_cursor);
 ...
 /*
@@ -181,25 +169,17 @@ ssize_t netfs_unbuffered_read_iter_locked(struct kiocb *iocb, struct iov_iter *i
...
index f5cf80d567f3..a19d614fd8d4 100644
...
@@ -69,9 +68,8 @@ static inline void netfs_proc_del_rreq(struct netfs_io_request *rreq) {}
 /*
  * misc.c
  */
...
index 6f944eb4e281..616afe53fedf 100644
--- a/fs/netfs/iterator.c
+++ b/fs/netfs/iterator.c
@@ -150,6 +150,7 @@ ssize_t netfs_extract_iter(struct iov_iter *orig, size_t max_len, size_t max_pag
 }
...
@@ -443,3 +444,4 @@ size_t netfs_limit_iter(const struct iov_iter *iter, size_t start_offset,
 	BUG();
 }
...
@@ -134,16 +133,10 @@ static void netfs_deinit_request(struct netfs_io_request *rreq)
...
@@ -236,6 +229,8 @@ static void netfs_free_subrequest(struct netfs_io_subrequest *subreq)
...
index edf7cea7e2f9..802d1c40cce5 100644
...
+	bvecq->bv[slot].bv_page = NULL;
 ...
 /*
@@ -100,24 +104,15 @@ static void netfs_unlock_read_folio(struct netfs_io_request *rreq,
...
@@ -131,16 +126,30 @@ static void netfs_read_unlock_folios(struct netfs_io_request *rreq,
 		unsigned int order;
 		size_t fsize;
...
@@ -152,33 +161,19 @@ static void netfs_read_unlock_folios(struct netfs_io_request *rreq,
...
+	rreq->collect_cursor.slot = slot;
 ...
 /*
@@ -355,12 +350,17 @@ static void netfs_rreq_assess_dio(struct netfs_io_request *rreq)
...
@@ -451,7 +451,15 @@ bool netfs_read_collection(struct netfs_io_request *rreq)
...
index a1489aa29f78..6f6a7278510d 100644
...
+	bvecq_pos_step(&creq->dispatch_cursor);
 	...
 	if (flen < fsize)
@@ -110,6 +133,10 @@ static struct netfs_io_request *netfs_pgpriv2_begin_copy_to_cache(
...
@@ -138,6 +165,14 @@ void netfs_pgpriv2_copy_to_cache(struct netfs_io_request *rreq, struct folio *fo
 	if (IS_ERR(creq))
 		return;
...
@@ -170,22 +205,27 @@ void netfs_pgpriv2_end_copy_to_cache(struct netfs_io_request *rreq)
  */
...
@@ -208,25 +248,17 @@ bool netfs_pgpriv2_unlock_copied_folios(struct netfs_io_request *creq)
...
@@ -100,7 +106,8 @@ static void netfs_retry_read_subrequests(struct netfs_io_request *rreq)
...
+			    subreq->transferred > 0 ||
 				...
 				break;
@@ -113,11 +120,14 @@ static void netfs_retry_read_subrequests(struct netfs_io_request *rreq)
...
+		 */
 		...
 		list_for_each_entry_from(subreq, &stream->subrequests, rreq_link) {
 			if (!len) {
@@ -125,16 +135,22 @@ static void netfs_retry_read_subrequests(struct netfs_io_request *rreq)
 				break;
 			}
...
@@ -142,13 +158,12 @@ static void netfs_retry_read_subrequests(struct netfs_io_request *rreq)
 				goto abandon;
 			}
...
+
 			...
 			start += part;
 			if (!len) {
@@ -212,9 +227,7 @@ static void netfs_retry_read_subrequests(struct netfs_io_request *rreq)
 			trace_netfs_sreq(subreq, netfs_sreq_trace_retry);
...
@@ -223,11 +236,12 @@ static void netfs_retry_read_subrequests(struct netfs_io_request *rreq)
 				goto abandon;
 			}
...
+			subreq->len = part;
 			...
 			len -= part;
 			start += part;
@@ -241,6 +255,8 @@ static void netfs_retry_read_subrequests(struct netfs_io_request *rreq)
...
@@ -257,6 +273,7 @@ static void netfs_retry_read_subrequests(struct netfs_io_request *rreq)
...
@@ -177,6 +182,10 @@ ssize_t netfs_read_single(struct inode *inode, struct file *file, struct iov_ite
 	if (IS_ERR(rreq))
 		return PTR_ERR(rreq);
...
+
 	...
 	if (ret == -ENOMEM || ret == -EINTR || ret == -ERESTARTSYS)
 		goto cleanup_free;
@@ -184,7 +193,6 @@ ssize_t netfs_read_single(struct inode *inode, struct file *file, struct iov_ite
...
index 23713e3209ce..f8dbe30a806c 100644
...
index 0a1c91938e97..f6eb69567232 100644
...
@@ -256,15 +243,16 @@ static void netfs_do_issue_write(struct netfs_io_stream *stream,
 }
...
+	iov_iter_advance(&subreq->io_iter, subreq->transferred);
 	...
 	subreq->retry_count++;
 	subreq->error = 0;
@@ -282,8 +270,67 @@ void netfs_issue_write(struct netfs_io_request *wreq,
 	if (!subreq)
 		return;
...
@@ -320,7 +367,6 @@ size_t netfs_advance_write(struct netfs_io_request *wreq,
...
@@ -344,7 +390,8 @@ static int netfs_write_folio(struct netfs_io_request *wreq,
 	struct netfs_io_stream *stream;
...
@@ -352,8 +399,13 @@ static int netfs_write_folio(struct netfs_io_request *wreq,
...
@@ -453,8 +505,32 @@ static int netfs_write_folio(struct netfs_io_request *wreq,
...
@@ -463,9 +539,11 @@ static int netfs_write_folio(struct netfs_io_request *wreq,
...
@@ -500,15 +578,11 @@ static int netfs_write_folio(struct netfs_io_request *wreq,
 			break;
...
@@ -519,9 +593,9 @@ static int netfs_write_folio(struct netfs_io_request *wreq,
 			debug = true;
 	}
...
@@ -583,6 +657,11 @@ int netfs_writepages(struct address_space *mapping,
 		goto couldnt_start;
 	}
...
@@ -605,12 +684,17 @@ int netfs_writepages(struct address_space *mapping,
...
+	netfs_put_failed_request(wreq);
 ...
 out:
@@ -637,6 +721,15 @@ struct netfs_io_request *netfs_begin_writethrough(struct kiocb *iocb, size_t len
 		return wreq;
 	}
...
+
 	...
 	return wreq;
@@ -654,8 +747,8 @@ int netfs_advance_writethrough(struct netfs_io_request *wreq, struct writeback_c
 {
 	int ret;
...
@@ -707,6 +800,8 @@ ssize_t netfs_end_writethrough(struct netfs_io_request *wreq, struct writeback_c
 	}
...
+	bvecq_pos_unset(&wreq->dispatch_cursor);
 	...
 	if (wreq->iocb)
 		ret = -EIOCBQUEUED;
@@ -723,10 +818,11 @@ ssize_t netfs_end_writethrough(struct netfs_io_request *wreq, struct writeback_c
  * @iter: Data to write.
  *
...
@@ -744,10 +840,18 @@ int netfs_writeback_single(struct address_space *mapping,
 		ret = PTR_ERR(wreq);
 		goto couldnt_start;
 	}
-
...
+
 	...
 	netfs_stat(&netfs_n_wh_writepages);
@@ -767,11 +871,11 @@ int netfs_writeback_single(struct address_space *mapping,
 		subreq = stream->construct;
 		subreq->len = wreq->len;
...
@@ -786,6 +890,8 @@ int netfs_writeback_single(struct address_space *mapping,
 	_leave(" = %d", ret);
 	return ret;
...
index 32e1058bf252..9eef278a284d 100644
...
@@ -70,11 +68,12 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
...
+			    subreq->transferred > 0 ||
 			    ...
 			    !test_bit(NETFS_SREQ_NEED_RETRY, &subreq->flags))
 				break;
@@ -85,11 +84,13 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
 		/* Determine the set of buffers we're going to use.  Each
 		 * subreq gets a subset of a single overall contiguous buffer.
 		 */
-		netfs_reset_iter(from);
...
+		 */
 		...
 		list_for_each_entry_from(subreq, &stream->subrequests, rreq_link) {
 			if (!len)
@@ -99,16 +100,23 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
 			subreq->len	= len;
 			__clear_bit(NETFS_SREQ_NEED_RETRY, &subreq->flags);
 			trace_netfs_sreq(subreq, netfs_sreq_trace_retry);
+			subreq->transferred = 0;
...
+
 			...
 			start += part;
 			if (len && subreq == to &&
@@ -116,7 +124,7 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
 				boundary = true;
...
@@ -177,8 +185,13 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
...
+
 			...
 			start += part;
 			if (!len && boundary) {
@@ -186,13 +199,16 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
 				boundary = false;
 			}
...
index 7de2b34b000e..d2a059d93807 100644
...
@@ -139,7 +140,6 @@ struct netfs_io_stream {
...
-	unsigned int		submit_extendable_to; /* Amount I/O can be rounded up to */
 	...
 	/* Collection tracking */
@@ -182,6 +182,8 @@ struct netfs_io_subrequest {
...
@@ -244,13 +246,14 @@ struct netfs_io_request {
...
@@ -263,7 +266,6 @@ struct netfs_io_request {
...
@@ -272,7 +274,6 @@ struct netfs_io_request {
...
@@ -480,12 +481,6 @@ void netfs_end_io_write(struct inode *inode);
...
@@ -269,7 +271,7 @@ enum netfs_sreq_ref_trace { netfs_sreq_ref_traces } __mode(byte);
