...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id 10F9B848CE4
	for <lists+linux-erofs@lfdr.de>; Sun,  4 Feb 2024 11:35:02 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4TSQr35xCkz3bsd
	for <lists+linux-erofs@lfdr.de>; Sun,  4 Feb 2024 21:34:59 +1100 (AEDT)
...
Received: from smtp232.sjtu.edu.cn (smtp232.sjtu.edu.cn [202.120.2.232])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4TSQr16KlWz2ydW
	for <linux-erofs@lists.ozlabs.org>; Sun,  4 Feb 2024 21:34:57 +1100 (AEDT)
Received: from proxy188.sjtu.edu.cn (smtp188.sjtu.edu.cn [202.120.2.188])
	by smtp232.sjtu.edu.cn (Postfix) with ESMTPS id AA4BC1008CBC2;
	Sun,  4 Feb 2024 18:34:44 +0800 (CST)
Received: from zhaoyf.ipads-lab.se.sjtu.edu.cn (unknown [202.120.40.82])
	by proxy188.sjtu.edu.cn (Postfix) with ESMTPSA id 373FB381F4B;
	Sun,  4 Feb 2024 18:34:41 +0800 (CST)
From: Yifan Zhao <zhaoyifan@sjtu.edu.cn>
To: linux-erofs@lists.ozlabs.org
Subject: [PATCH 7/7] erofs-utils: mkfs: introduce inter-file multi-threaded compression
Date: Sun,  4 Feb 2024 18:34:38 +0800
Message-ID: <20240204103438.141820-1-zhaoyifan@sjtu.edu.cn>
...
---
 ...
 lib/inode.c              | 346 +++++++++++++++++++++------
 lib/queue.c              |  64 +++++
 8 files changed, 687 insertions(+), 263 deletions(-)
...
@@ -1119,6 +1223,7 @@ void z_erofs_mt_work(struct erofs_workqueue *wq, struct erofs_work *work)
...
+	struct erofs_compress_file *cfile = cwork->file;
 	...
 	int ret = 0;
@@ -1139,6 +1244,11 @@ void z_erofs_mt_work(struct erofs_workqueue *wq, struct erofs_work *work)
 	ctx->tmpfile = tmpfile();
 #endif
...
+
 	...
 	if (ret)
 		goto out;
@@ -1150,28 +1260,29 @@ void z_erofs_mt_work(struct erofs_workqueue *wq, struct erofs_work *work)
...
+	free(ictx);
 err_free_meta:
 	free(compressmeta);
 	inode->compressmeta = NULL;
@@ -1682,10 +1781,15 @@ int z_erofs_compress_exit(void)
 		if (ret)
 			return ret;
...
@@ -1096,53 +1108,78 @@ static void erofs_fixup_meta_blkaddr(struct erofs_inode *rootdir)
...
@@ -1455,4 +1661,4 @@ int erofs_rebuild_dump_tree(struct erofs_inode *dir)
 	erofs_write_tail_end(dir);
