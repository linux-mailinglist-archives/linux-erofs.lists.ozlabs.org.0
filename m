Return-Path: <linux-erofs+bounces-2637-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-erofs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id YJ2RJU5fsGloigIAu9opvQ
	(envelope-from <linux-erofs+bounces-2637-lists+linux-erofs=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-erofs@lfdr.de>; Tue, 10 Mar 2026 19:13:34 +0100
X-Original-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 29C9B2563B5
	for <lists+linux-erofs@lfdr.de>; Tue, 10 Mar 2026 19:13:33 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4fVhp22F2Jz3bmM;
	Wed, 11 Mar 2026 05:13:30 +1100 (AEDT)
X-Original-To: linux-erofs@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; arc=fail smtp.remote-ip=148.163.156.1
ARC-Seal: i=2; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1773166410;
	cv=fail; b=
ARC-Message-Signature: i=2; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1773166410; c=relaxed/relaxed;
	bh=nPEo3k2fwZhwgIqrsgLaFQDOcFNuCDzt1kvGP06H+Vs=;
	h=From:To:CC:Date:Message-ID:References:In-Reply-To:Content-Type:
	 MIME-Version:Subject; b=
ARC-Authentication-Results: i=2; lists.ozlabs.org; dmarc=pass (p=reject dis=none) header.from=ibm.com; dkim=pass (2048-bit key; unprotected) header.d=ibm.com header.i=@ibm.com header.a=rsa-sha256 header.s=pp1 header.b=ga2/3Nuh; dkim-atps=neutral; spf=pass (client-ip=148.163.156.1; helo=mx0a-001b2d01.pphosted.com; envelope-from=slava.dubeyko@ibm.com; receiver=lists.ozlabs.org) smtp.mailfrom=ibm.com
Authentication-Results: lists.ozlabs.org; dmarc=pass (p=reject dis=none) header.from=ibm.com
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=ibm.com header.i=@ibm.com header.a=rsa-sha256 header.s=pp1 header.b=ga2/3Nuh;
	dkim-atps=neutral
Authentication-Results: lists.ozlabs.org; spf=pass (sender SPF authorized) smtp.mailfrom=ibm.com (client-ip=148.163.156.1; helo=mx0a-001b2d01.pphosted.com; envelope-from=slava.dubeyko@ibm.com; receiver=lists.ozlabs.org)
Received: from mx0a-001b2d01.pphosted.com (mx0a-001b2d01.pphosted.com [148.163.156.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange x25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lists.ozlabs.org (Postfix) with ESMTPS id 4fVhp11NCbz3bjb
	for <linux-erofs@lists.ozlabs.org>; Wed, 11 Mar 2026 05:13:28 +1100 (AEDT)
Received: from pps.filterd (m0353729.ppops.net [127.0.0.1])
	by mx0a-001b2d01.pphosted.com (8.18.1.11/8.18.1.11) with ESMTP id 62A9qCvs1433673;
...
X-Spamd-Result: default: False [0.90 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-2637-lists,linux-erofs=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
 ...
 dead.org,m:linux-scsi@vger.kernel.org,m:target-devel@vger.kernel.org,m:linux-gpio@vger.kernel.org,m:cocci@inria.fr,m:linux-sh@vger.kernel.org,m:linux-rockchip@lists.infradead.org,m:linux-stm32@st-md-mailman.stormreply.com,m:linux-cifs@vger.kernel.org,m:linux-modules@vger.kernel.org,m:linux-sound@vger.kernel.org,m:bpf@vger.kernel.org,m:linux-arm-kernel@lists.infradead.org,m:linux-input@vger.kernel.org,m:linux-leds@vger.kernel.org,m:dri-devel@lists.freedesktop.org,m:linux-hyperv@vger.kernel.org,m:linux-mm@kvack.org,m:linux-nfs@vger.kernel.org,m:gfs2@lists.linux.dev,m:linux-wireless@vger.kernel.org,m:linux-omap@vger.kernel.org,m:idryomov@gmail.com,m:amarkuze@redhat.com,m:slava@dubeyko.com,s:lists@lfdr.de];
	...
	MIME_TRACE(0.00)[0:+];
	FORGED_SENDER(0.00)[Slava.Dubeyko@ibm.com,linux-erofs@lists.ozlabs.org];
	...
	FROM_NEQ_ENVFROM(0.00)[Slava.Dubeyko@ibm.com,linux-erofs@lists.ozlabs.org];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[avm.de:email,dubeyko.com:email,lists.ozlabs.org:rdns,lists.ozlabs.org:helo]
