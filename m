...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 9DD3876D5BA
	for <lists+linux-erofs@lfdr.de>; Wed,  2 Aug 2023 19:43:29 +0200 (CEST)
Authentication-Results: lists.ozlabs.org;
	dkim=fail reason="signature verification failed" (1024-bit key; unprotected) header.d=suse.cz header.i=@suse.cz header.a=rsa-sha256 header.s=susede2_rsa header.b=z0kmbMAb;
	dkim=fail reason="signature verification failed" header.d=suse.cz header.i=@suse.cz header.a=ed25519-sha256 header.s=susede2_ed25519 header.b=5Wv78han;
	dkim-atps=neutral
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4RGK8H3w2bz3bdG
	for <lists+linux-erofs@lfdr.de>; Thu,  3 Aug 2023 03:43:27 +1000 (AEST)
X-Original-To: linux-erofs@lists.ozlabs.org
Delivered-To: linux-erofs@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org;
	dkim=pass (1024-bit key; unprotected) header.d=suse.cz header.i=@suse.cz header.a=rsa-sha256 header.s=susede2_rsa header.b=z0kmbMAb;
	dkim=pass header.d=suse.cz header.i=@suse.cz header.a=ed25519-sha256 header.s=susede2_ed25519 header.b=5Wv78han;
	dkim-atps=neutral
...
Received: from smtp-out2.suse.de (smtp-out2.suse.de [195.135.220.29])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4RGK892vlQz2ys2
	for <linux-erofs@lists.ozlabs.org>; Thu,  3 Aug 2023 03:43:21 +1000 (AEST)
