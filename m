...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 993C79BEA03
	for <lists+linux-erofs@lfdr.de>; Wed,  6 Nov 2024 13:39:46 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4Xk4Xc3Rmfz3bl1
	for <lists+linux-erofs@lfdr.de>; Wed,  6 Nov 2024 23:39:44 +1100 (AEDT)
X-Original-To: linux-erofs@lists.ozlabs.org
Delivered-To: linux-erofs@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; arc=none smtp.remote-ip=170.10.129.124
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1730896783;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1730896783; c=relaxed/relaxed;
	bh=lJC7DAudiwasYKYxaT9mLulrflROAybSYNp+mD31UAc=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=
ARC-Authentication-Results: i=1; lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=redhat.com; dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=H9Zw9XCn; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=dNnsTmEE; dkim-atps=neutral; spf=pass (client-ip=170.10.129.124; helo=us-smtp-delivery-124.mimecast.com; envelope-from=dhowells@redhat.com; receiver=lists.ozlabs.org) smtp.mailfrom=redhat.com
Authentication-Results: lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: lists.ozlabs.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=H9Zw9XCn;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=dNnsTmEE;
	dkim-atps=neutral
...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4Xk4XY5jcLz30NN
	for <linux-erofs@lists.ozlabs.org>; Wed,  6 Nov 2024 23:39:41 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1730896778;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=lJC7DAudiwasYKYxaT9mLulrflROAybSYNp+mD31UAc=;
	b=H9Zw9XCnvs8DAx+21hid9cxgK4RJPlyfqVttJGhOKtW3wwizs/yGr9NsZSkNZf/aMmJR3T
	AlCq+xsQoOzdjbfgWoRcFxXQDK/8mJB79EUmFZ8owWgY4FrP1epLS86n4vu2uz8nOx/IV/
	a9WT+RJbGzuQseXS/dN2xFKWN9Np7gE=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1730896779;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=lJC7DAudiwasYKYxaT9mLulrflROAybSYNp+mD31UAc=;
	b=dNnsTmEEYQ02j6UpUDd8trolRPCvxQ2hBdsOyxZMLzdz0xBKgLDc/xIprxKyjxGdRCngYD
	SMTCwEJv00CCctflY3ghoSKxhHDWqcmqBwZYCSsKl9eH5sBSPshPNMs7wfTZRth7xLeFnV
	BEbGIEMqvt/BPv62MzBg7RrkCSX0xQ8=
Received: from mx-prod-mc-03.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-54-186-198-63.us-west-2.compute.amazonaws.com [54.186.198.63]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-301-SVhn5TRXPqWXjBhanQ7uuQ-1; Wed,
 06 Nov 2024 07:39:34 -0500
X-MC-Unique: SVhn5TRXPqWXjBhanQ7uuQ-1
X-Mimecast-MFC-AGG-ID: SVhn5TRXPqWXjBhanQ7uuQ
Received: from mx-prod-int-02.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-02.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.15])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-03.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 8825F1955D45;
	Wed,  6 Nov 2024 12:39:31 +0000 (UTC)
Received: from warthog.procyon.org.uk.com (unknown [10.42.28.231])
	by mx-prod-int-02.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id CB0551956088;
	Wed,  6 Nov 2024 12:39:25 +0000 (UTC)
From: David Howells <dhowells@redhat.com>
To: Christian Brauner <christian@brauner.io>,
	Steve French <smfrench@gmail.com>,
	Matthew Wilcox <willy@infradead.org>
Subject: [PATCH v3 27/33] afs: Make {Y,}FS.FetchData an asynchronous operation
Date: Wed,  6 Nov 2024 12:35:51 +0000
Message-ID: <20241106123559.724888-28-dhowells@redhat.com>
...
index 238fc8cbfe25..466d3b5ef7df 100644
--- a/fs/afs/internal.h
+++ b/fs/afs/internal.h
...
+	void (*immediate_cancel)(struct afs_call *call);
 ...
 /*
@@ -941,6 +947,7 @@ struct afs_operation {
...
+#define AFS_OPERATION_ASYNC		0x2000	/* Set if should run asynchronously */
 ...
 /*
@@ -1103,6 +1110,8 @@ extern int afs_cache_wb_key(struct afs_vnode *, struct afs_file *);
...
+void afs_fetch_data_immediate_cancel(struct afs_call *call);
 ...
 /*
  * flock.c
@@ -1154,6 +1163,7 @@ extern void afs_fs_store_acl(struct afs_operation *);
...
@@ -1325,6 +1335,7 @@ extern void afs_charge_preallocation(struct work_struct *);
...
@@ -1335,6 +1346,19 @@ extern void afs_send_simple_reply(struct afs_call *, const void *, size_t);
