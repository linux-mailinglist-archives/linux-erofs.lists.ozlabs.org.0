...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id 5851E6EA50C
	for <lists+linux-erofs@lfdr.de>; Fri, 21 Apr 2023 09:39:48 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4Q2mdF2NmMz3fV1
	for <lists+linux-erofs@lfdr.de>; Fri, 21 Apr 2023 17:39:45 +1000 (AEST)
...
Received: from out30-118.freemail.mail.aliyun.com (out30-118.freemail.mail.aliyun.com [115.124.30.118])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4Q2md63zX4z3f6R
	for <linux-erofs@lists.ozlabs.org>; Fri, 21 Apr 2023 17:39:37 +1000 (AEST)
X-Alimail-AntiSpam: AC=PASS;BC=-1|-1;BR=01201311R191e4;CH=green;DM=||false|;DS=||;FP=0|-1|-1|-1|0|-1|-1|-1;HT=ay29a033018046056;MF=hsiangkao@linux.alibaba.com;NM=1;PH=DS;RN=2;SR=0;TI=SMTPD_---0Vgc.4lq_1682062772;
Received: from e18g06460.et15sqa.tbsite.net(mailfrom:hsiangkao@linux.alibaba.com fp:SMTPD_---0Vgc.4lq_1682062772)
          by smtp.aliyun-inc.com;
          Fri, 21 Apr 2023 15:39:33 +0800
From: Gao Xiang <hsiangkao@linux.alibaba.com>
To: linux-erofs@lists.ozlabs.org
Subject: [PATCH v6 2/2] erofs-utils: introduce tarerofs
Date: Fri, 21 Apr 2023 15:39:26 +0800
Message-Id: <20230421073926.85369-2-hsiangkao@linux.alibaba.com>
X-Mailer: git-send-email 2.24.4
In-Reply-To: <20230421073926.85369-1-hsiangkao@linux.alibaba.com>
References: <20230421073926.85369-1-hsiangkao@linux.alibaba.com>
MIME-Version: 1.0
...
---
changes since v5:
 - Support `--aufs` option to convert aufs to overlayfs;
 - Fix hardlink corrupted bugs;
 ...
 lib/xattr.c               |  46 ++-
 mkfs/main.c               | 134 +++++--
 12 files changed, 1149 insertions(+), 106 deletions(-)
...
@@ -178,13 +179,17 @@ struct erofs_inode {
 	} u;
...
+
 	...
 	if (ret < 0)
 		return ret;
@@ -1061,8 +1074,13 @@ static int erofs_mkfs_build_tree(struct erofs_inode *dir, struct list_head *dirs
 			}
...
+			close(fd);
 		...
 		if (ret)
 			return ret;
@@ -1285,3 +1303,82 @@ struct erofs_inode *erofs_mkfs_build_special_from_fd(int fd, const char *name)
