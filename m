Return-Path: <linux-erofs+bounces-3167-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-erofs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 4MLIID4KzmkwkgYAu9opvQ
	(envelope-from <linux-erofs+bounces-3167-lists+linux-erofs=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-erofs@lfdr.de>; Thu, 02 Apr 2026 08:18:38 +0200
X-Original-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:21b9:f100::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 1EC55384626
	for <lists+linux-erofs@lfdr.de>; Thu, 02 Apr 2026 08:18:36 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4fmWrV2Mtmz2xS3;
	Thu, 02 Apr 2026 17:18:34 +1100 (AEDT)
X-Original-To: linux-erofs@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; arc=none smtp.remote-ip=115.124.28.44
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1775110714;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1775110714; c=relaxed/relaxed;
	bh=sVQUeA7J6NjD2kpk5Szj0qFLCA/ucr7hz3ImhBj9fqI=;
	h=Content-Type:Mime-Version:Subject:From:In-Reply-To:Date:Cc:
	 Message-Id:References:To; b=
...
Received: from out28-44.mail.aliyun.com (out28-44.mail.aliyun.com [115.124.28.44])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4fmWrQ1yFYz2xLt
	for <linux-erofs@lists.ozlabs.org>; Thu, 02 Apr 2026 17:18:27 +1100 (AEDT)
X-Alimail-AntiSpam:AC=CONTINUE;BC=0.05764782|-1;CH=green;DM=|CONTINUE|false|;DS=CONTINUE|ham_system_inform|0.650628-0.00785894-0.341513;FP=16390949853188228501|0|0|0|0|-1|-1|-1;HT=maildocker-contentspam033037031241;MF=hudson@cyzhu.com;NM=1;PH=DS;RN=2;RT=2;SR=0;TI=SMTPD_---.h3P5aH-_1775110701;
Received: from smtpclient.apple(mailfrom:hudson@cyzhu.com fp:SMTPD_---.h3P5aH-_1775110701 cluster:ay29)
          by smtp.aliyun-inc.com;
          Thu, 02 Apr 2026 14:18:22 +0800
...
Date: Thu, 2 Apr 2026 14:18:11 +0800
Cc: linux-erofs@lists.ozlabs.org
Content-Transfer-Encoding: quoted-printable
Message-Id: <A173CABD-5801-4E1E-AF07-9916B5C5A8D2@cyzhu.com>
...
X-Spamd-Result: default: False [-1.00 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-3167-lists,linux-erofs=lfdr.de];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[lists.ozlabs.org:helo,lists.ozlabs.org:rdns,yulong.com:email,oppo.com:email]
X-Rspamd-Queue-Id: 1EC55384626
...
> -files in `lib` and `include` directory are designed to be included =
into
> -3rd-party applications, while all other files, are intended to be =
used
...
> -Usage-Guide:
> -  The Apache-2.0 may only be used for dual-licensed files where the =
other
> -  license is GPL2 compatible. If you end up using this it MUST be =
used
> -  together with a GPL2 compatible license using "OR".
> -  To use the Apache License version 2.0 put the following SPDX =
tag/value
...
notices
> -      from the Source form of the Work, excluding those notices that =
do not
...
You to
> -   the Licensor shall be under the terms and conditions of this =
License,
> -   without any additional terms or conditions. Notwithstanding the =
above,
> -   nothing herein shall supersede or modify the terms of any separate
> -   license agreement you may have executed with Licensor regarding =
such
> -   Contributions.
> -
...
agreed to
> -   in writing, Licensor provides the Work (and each Contributor =
provides
...
whether
> -   in tort (including negligence), contract, or otherwise, unless =
required
...
> +# SPDX-License-Identifier: GPL-2.0+ OR MIT
>=20
> noinst_LTLIBRARIES =3D liberofs.la
> noinst_HEADERS =3D $(top_srcdir)/include/erofs_fs.h \
