...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E94E78FB62
	for <lists+linux-erofs@lfdr.de>; Fri,  1 Sep 2023 11:47:43 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4RcY9T1pp6z3c12
	for <lists+linux-erofs@lfdr.de>; Fri,  1 Sep 2023 19:47:41 +1000 (AEST)
...
Received: from out30-97.freemail.mail.aliyun.com (out30-97.freemail.mail.aliyun.com [115.124.30.97])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4RcY922rCLz3bTt
	for <linux-erofs@lists.ozlabs.org>; Fri,  1 Sep 2023 19:47:17 +1000 (AEST)
X-Alimail-AntiSpam: AC=PASS;BC=-1|-1;BR=01201311R131e4;CH=green;DM=||false|;DS=||;FP=0|-1|-1|-1|0|-1|-1|-1;HT=ay29a033018045168;MF=jefflexu@linux.alibaba.com;NM=1;PH=DS;RN=2;SR=0;TI=SMTPD_---0Vr5QuBP_1693561632;
Received: from localhost(mailfrom:jefflexu@linux.alibaba.com fp:SMTPD_---0Vr5QuBP_1693561632)
          by smtp.aliyun-inc.com;
          Fri, 01 Sep 2023 17:47:13 +0800
From: Jingbo Xu <jefflexu@linux.alibaba.com>
To: hsiangkao@linux.alibaba.com,
	linux-erofs@lists.ozlabs.org
Subject: [PATCH v5 6/8] erofs-utils: lib: add erofs_rebuild_load_tree() helper
Date: Fri,  1 Sep 2023 17:47:04 +0800
Message-Id: <20230901094706.27539-7-jefflexu@linux.alibaba.com>
...
@@ -115,3 +124,277 @@ struct erofs_dentry *erofs_rebuild_get_dentry(struct erofs_inode *pwd,
 	}
 	return d;
 }
+
