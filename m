Return-Path: <linux-erofs+bounces-3626-lists+linux-erofs=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-erofs@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id SlyoBJ8hMWoAcQUAu9opvQ
	(envelope-from <linux-erofs+bounces-3626-lists+linux-erofs=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-erofs@lfdr.de>; Tue, 16 Jun 2026 12:12:47 +0200
X-Original-To: lists+linux-erofs@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:21b9:f100::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 62A1968E0AE
	for <lists+linux-erofs@lfdr.de>; Tue, 16 Jun 2026 12:12:45 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=redhat.com header.s=mimecast20190719 header.b=GwawE3LJ;
	dkim=pass header.d=redhat.com header.s=mimecast20190719 header.b=GwawE3LJ;
	spf=pass (mail.lfdr.de: domain of "linux-erofs+bounces-3626-lists+linux-erofs=lfdr.de@lists.ozlabs.org" designates 2404:9400:21b9:f100::1 as permitted sender) smtp.mailfrom="linux-erofs+bounces-3626-lists+linux-erofs=lfdr.de@lists.ozlabs.org";
	dmarc=pass (policy=quarantine) header.from=redhat.com;
	arc=pass ("lists.ozlabs.org:s=201707:i=1")
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4gfjV31QCPz3byk;
	Tue, 16 Jun 2026 20:12:43 +1000 (AEST)
X-Original-To: linux-erofs@lists.ozlabs.org
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1781604763;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1781604763; c=relaxed/relaxed;
	bh=TQDZYYkvikxSbwvGe89OQLTL58T8KDzONe7BL3ymIPE=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:content-type; b=
ARC-Authentication-Results: i=1; lists.ozlabs.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=GwawE3LJ; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256 header.s=mimecast20190719 header.b=GwawE3LJ; dkim-atps=neutral; spf=pass (client-ip=170.10.133.124; helo=us-smtp-delivery-124.mimecast.com; envelope-from=dhowells@redhat.com; receiver=lists.ozlabs.org) smtp.mailfrom=redhat.com
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange x25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lists.ozlabs.org (Postfix) with ESMTPS id 4gfjTz6n7Cz3brH
	for <linux-erofs@lists.ozlabs.org>; Tue, 16 Jun 2026 20:12:39 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1781604757;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=TQDZYYkvikxSbwvGe89OQLTL58T8KDzONe7BL3ymIPE=;
	b=GwawE3LJUiXEkK9mZYI6HA7VWhTU/BkLI3KMxMcO920n6Oz1Y1tMhe/WYe0Llbmn+/6v/b
	MHXfCnsDD2wQhuacZg+YGREyPIXienAKSmKawNfRTiUr5TlxtMVs17NwQXhKUzRXnxs1Fl
	lFwrvhqMRWs0fssAm+B47j+YxiGI9ZA=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1781604757;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
...
Received: from mx-prod-mc-06.mail-002.prod.us-west-2.aws.redhat.com
 ...
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-650-eAg5TK5KPx6Ctpe6DHf85w-1; Tue,
 16 Jun 2026 06:12:31 -0400
X-MC-Unique: eAg5TK5KPx6Ctpe6DHf85w-1
X-Mimecast-MFC-AGG-ID: eAg5TK5KPx6Ctpe6DHf85w_1781604749
Received: from mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.4])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-06.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 5C268180025B;
	Tue, 16 Jun 2026 10:12:29 +0000 (UTC)
Received: from warthog.procyon.org.com (unknown [10.44.50.44])
	by mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id AB4273008B37;
	Tue, 16 Jun 2026 10:12:22 +0000 (UTC)
...
Subject: [PATCH v4 29/30] netfs: Combine prepare and issue ops and grab the buffers on request
Date: Tue, 16 Jun 2026 11:08:18 +0100
Message-ID: <20260616100821.2062304-30-dhowells@redhat.com>
...
X-Mimecast-MFC-PROC-ID: zDv8qiC_8USO4YcaxCC7Xifo0CgfXhEP3So1XBwnKf4_1781604749
...
X-Spamd-Result: default: False [-1.20 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-3626-lists,linux-erofs=lfdr.de];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[linux.dev:email,manguebit.org:email,lists.ozlabs.org:helo,lists.ozlabs.org:rdns,lists.ozlabs.org:from_smtp,infradead.org:email]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: 62A1968E0AE
...
---
 ...
 net/9p/client.c              |   8 +-
 39 files changed, 1857 insertions(+), 1241 deletions(-)
...
index 0a86f672cc09..080a0fc5cc83 100644
--- a/fs/ceph/addr.c
+++ b/fs/ceph/addr.c
...
index b29f18a8c223..c9bf9daf4666 100644
...
index 0309dd3c37d2..eedfcaca113c 100644
...
@@ -192,25 +201,21 @@ static int netfs_unbuffered_write(struct netfs_io_request *wreq)
...
+	bvecq_pos_unset(&stream->dispatch_cursor);
 	...
 	_leave(" = %d", ret);
 	return ret;
@@ -254,6 +259,7 @@ ssize_t netfs_unbuffered_write_iter_locked(struct kiocb *iocb, struct iov_iter *
 	if (IS_ERR(wreq))
 		return PTR_ERR(wreq);
...
@@ -264,9 +270,7 @@ ssize_t netfs_unbuffered_write_iter_locked(struct kiocb *iocb, struct iov_iter *
...
@@ -281,8 +285,6 @@ ssize_t netfs_unbuffered_write_iter_locked(struct kiocb *iocb, struct iov_iter *
...
index 3be7d4b4cd07..d464e1784b8a 100644
--- a/fs/netfs/iterator.c
+++ b/fs/netfs/iterator.c
@@ -108,14 +108,14 @@ ssize_t netfs_extract_iter(struct iov_iter *orig, size_t max_len, size_t max_pag
 			}
...
index f8dbe30a806c..bcd16bef8ce8 100644
...
-	smp_rmb(); /* Read ALL_QUEUED before lists. */
 	...
 	for (s = 0; s < NR_IO_STREAMS; s++) {
@@ -535,6 +557,8 @@ void netfs_write_subrequest_terminated(void *_op, ssize_t transferred_or_error)
...
index f6eb69567232..e2e35d619119 100644
...
@@ -316,92 +275,296 @@ void netfs_issue_write(struct netfs_io_request *wreq,
 		while (bq->next)
 			bq = bq->next;
...
@@ -432,23 +595,36 @@ static int netfs_write_folio(struct netfs_io_request *wreq,
 	if (finfo) {
...
@@ -468,168 +644,82 @@ static int netfs_write_folio(struct netfs_io_request *wreq,
 	 *     write-back group.
 	 */
...
+	goto out;
 ...
 /*
@@ -640,6 +730,7 @@ int netfs_writepages(struct address_space *mapping,
 {
...
@@ -659,33 +750,47 @@ int netfs_writepages(struct address_space *mapping,
...
@@ -707,32 +812,60 @@ EXPORT_SYMBOL(netfs_writepages);
 /*
...
+	return ERR_PTR(-ENOMEM);
 ...
 /*
@@ -741,10 +874,11 @@ struct netfs_io_request *netfs_begin_writethrough(struct kiocb *iocb, size_t len
...
@@ -752,18 +886,18 @@ int netfs_advance_writethrough(struct netfs_io_request *wreq, struct writeback_c
...
@@ -775,9 +909,20 @@ int netfs_advance_writethrough(struct netfs_io_request *wreq, struct writeback_c
 		return 0;
 	}
...
@@ -785,37 +930,81 @@ int netfs_advance_writethrough(struct netfs_io_request *wreq, struct writeback_c
 /*
...
@@ -826,12 +1015,15 @@ ssize_t netfs_end_writethrough(struct netfs_io_request *wreq, struct writeback_c
  */
...
@@ -840,23 +1032,24 @@ int netfs_writeback_single(struct address_space *mapping,
 		ret = PTR_ERR(wreq);
 		goto couldnt_start;
 	}
-	wreq->len = iov_iter_count(iter);
...
+	if (test_bit(NETFS_RREQ_UPLOAD_TO_SERVER, &wreq->flags))
 	...
 	for (int s = 0; s < NR_IO_STREAMS; s++) {
@@ -866,20 +1059,27 @@ int netfs_writeback_single(struct address_space *mapping,
 		if (!stream->avail)
 			continue;
...
index 9eef278a284d..e7955cc707e0 100644
...
@@ -93,38 +108,26 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
 		 */
 		subreq = from;
 		list_for_each_entry_from(subreq, &stream->subrequests, rreq_link) {
-			if (!len)
...
@@ -155,6 +158,7 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
 			subreq = netfs_alloc_subrequest(wreq);
...
@@ -163,18 +167,17 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
 					     netfs_sreq_trace_new);
...
-				stream->sreq_max_len = umin(len, wreq->wsize);
 			...
 			case NETFS_WRITE_TO_CACHE:
 				netfs_stat(&netfs_n_wh_write);
@@ -183,32 +186,14 @@ static void netfs_retry_write_stream(struct netfs_io_request *wreq,
 				WARN_ON_ONCE(1);
 			}
